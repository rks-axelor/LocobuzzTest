...
import com.test.java.utilities.OpenDetailsLinkedinTicketWorkflowProcess;
...
public class OpenDetailsLinkedinTicketFunctionality {
	...
	public void login(String user, String channel) throws Exception {
		...
		try {
			...
			OpenDetailsLinkedinTicketWorkflowProcess.openDetailsTicketsInformation(driver,channel);
			OpenDetailsLinkedinTicketWorkflowProcess.openDetailsButton(driver, channel);
