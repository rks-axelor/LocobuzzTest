...
import com.test.java.utilities.LocoPersonalDetailsSetAccountWorkflow;
...
public class LocoPersonalDetailsSetAccountFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void PersonalDetailsSettingsAccFun(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocoPersonalDetailsSetAccountWorkflow.goingAccountSession(driver);
			LocoPersonalDetailsSetAccountWorkflow.PersonalDetailsSettingsUIVerification(driver);
