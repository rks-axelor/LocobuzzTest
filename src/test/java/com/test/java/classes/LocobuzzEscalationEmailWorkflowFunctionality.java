...
import com.test.java.utilities.LocobuzzEscalationEmailsWorkflow;
...
public class LocobuzzEscalationEmailWorkflowFunctionality {
	...
	public void EscalationEmails(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzEscalationEmailsWorkflow.goingAccountSession(driver);
			LocobuzzEscalationEmailsWorkflow.escalationEmailProcess(driver);
