...
import com.test.java.utilities.LocobuzzAutomatedCannedResponseTwitterworkflow;
...
public class LocobuzzAutomatedCannedResponseTwitterfunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			LocobuzzAutomatedCannedResponseTwitterworkflow.makeActionableProcess(driver, channel);
			LocobuzzAutomatedCannedResponseTwitterworkflow.ticketTabVerification(driver, channel);
			LocobuzzAutomatedCannedResponseTwitterworkflow.automatedcannedresponseprocess(driver, channel);
