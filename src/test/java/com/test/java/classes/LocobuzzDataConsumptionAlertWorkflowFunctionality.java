...
import com.test.java.utilities.LocobuzzDataConsumptionAlertWorkflow;
...
public class LocobuzzDataConsumptionAlertWorkflowFunctionality {
	...
	public void DataConsumptionAlert(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzDataConsumptionAlertWorkflow.dataConsumptionAlertProcess(driver);
