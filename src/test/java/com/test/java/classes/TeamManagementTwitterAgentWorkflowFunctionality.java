...
import com.test.java.utilities.TeamManagementTwitterAgentWorkflow;
...
public class TeamManagementTwitterAgentWorkflowFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			TeamManagementTwitterAgentWorkflow.assignProcess(driver, channel);
			//TeamManagementTwitterAgentWorkflow.agentTicketProcess(driver,channel,user);
