...
import com.test.java.utilities.ExcelReportAgentDetailsProductivityReportWorkflow;
...
public class ExcelReportAgentDetailsProductivityReportFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportAgentDetailsProductivityReportWorkflow.excelReportAgentDetailsProductivityReportTemplateWorkflow(driver);
