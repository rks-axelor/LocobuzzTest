...
import com.test.java.utilities.NewMentionTwitterCreateTicketTypeProcess;


import io.github.bonigarcia.wdm.WebDriverManager;

public class NewMentionTwitterCreateTicketFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionTwitterCreateTicketTypeProcess.makeActionableProcess(driver, channel);
			NewMentionTwitterCreateTicketTypeProcess.ticketTabVerification(driver,channel);
			NewMentionTwitterCreateTicketTypeProcess.replyPostButton(driver,channel);
