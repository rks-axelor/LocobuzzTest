...
import com.test.java.utilities.NewMentionTwitterOnholdCreateTicketProcess;
...
public class NewMentionTwitterOnholdCreateTicketFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionTwitterOnholdCreateTicketProcess.makeActionableProcess(driver, channel);
			NewMentionTwitterOnholdCreateTicketProcess.ticketTabVerification(driver,channel);
			NewMentionTwitterOnholdCreateTicketProcess.replyPostButton(driver,channel);
