...
import com.test.java.utilities.LocobuzzManageAgentSkillsUIComponents;
...
public class LocobuzzManageAgentSkillsUIComponentFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void ManageAgentSkills(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzManageAgentSkillsUIComponents.goingAccountSession(driver);
			LocobuzzManageAgentSkillsUIComponents.verifyingManageAgentSkillsComponents(driver);
