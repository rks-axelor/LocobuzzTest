...
import com.test.java.utilities.ExcelReportAgentAchievementDetailReportWorkflow;
...
public class ExcelReportAgentAchievementDetailReportWorkflowFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportAgentAchievementDetailReportWorkflow.excelReportAgentAchievementDetailReportTemplateWorkflow(driver);
