...
import com.test.java.utilities.NewMentionInstagramAcknowledgeTypeProcess;
...
public class NewMentionInstagramAcknowledgeFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionInstagramAcknowledgeTypeProcess.makeActionableProcess(driver, channel);
			NewMentionInstagramAcknowledgeTypeProcess.ticketTabVerification(driver,channel);
			NewMentionInstagramAcknowledgeTypeProcess.replyPostButton(driver,channel);
