...
import com.test.java.utilities.NewMentionInstagramOnholdCreateTicketProcess;
...
public class NewMentionInstagramOnholdCreateTicketFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionInstagramOnholdCreateTicketProcess.makeActionableProcess(driver, channel);
			NewMentionInstagramOnholdCreateTicketProcess.ticketTabVerification(driver,channel);
			NewMentionInstagramOnholdCreateTicketProcess.replyPostButton(driver,channel);
