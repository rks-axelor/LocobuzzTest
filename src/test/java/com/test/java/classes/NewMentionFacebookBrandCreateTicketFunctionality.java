...
import com.test.java.utilities.NewMentionFacebookBrandCreateTicketProcess;
...
public class NewMentionFacebookBrandCreateTicketFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionFacebookBrandCreateTicketProcess.makeActionableProcess(driver, channel);
			NewMentionFacebookBrandCreateTicketProcess.ticketTabVerification(driver,channel);
			NewMentionFacebookBrandCreateTicketProcess.replyPostButton(driver,channel);
