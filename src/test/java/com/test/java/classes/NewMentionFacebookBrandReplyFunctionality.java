...
import com.test.java.utilities.NewMentionFacebookBrandReplyProcess;
...
public class NewMentionFacebookBrandReplyFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionFacebookBrandReplyProcess.makeActionableProcess(driver, channel);
			NewMentionFacebookBrandReplyProcess.ticketTabVerification(driver,channel);
			NewMentionFacebookBrandReplyProcess.replyPostButton(driver,channel);
