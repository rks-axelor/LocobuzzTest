...
import com.test.java.utilities.LocobuzzKeywordConfigRealTimeTwitterWorkflow;
...
public class LocobuzzKeywordConfigRealTimeTwitterWorkflowFunctionality {
	...
	public void KeywordConfiguration(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzKeywordConfigRealTimeTwitterWorkflow.goingAccountSession(driver);
			LocobuzzKeywordConfigRealTimeTwitterWorkflow.keywordConfigurationTwitterProcess(driver);
