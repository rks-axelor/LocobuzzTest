...
import com.test.java.utilities.LocobuzzKeywordConfigRealTimeInstagramWorkflow;
...
public class LocobuzzKeywordConfigRealTimeInstagramWorkflowFunctionality {
	...
	public void KeywordConfiguration(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzKeywordConfigRealTimeInstagramWorkflow.goingAccountSession(driver);
			LocobuzzKeywordConfigRealTimeInstagramWorkflow.keywordConfigurationInstagramProcess(driver);
