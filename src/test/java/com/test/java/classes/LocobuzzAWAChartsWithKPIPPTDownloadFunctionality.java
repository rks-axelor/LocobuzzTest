...
import com.test.java.utilities.LocobuzzAWAChartsWithKPIPPTDownloadWorkflow;
...
public class LocobuzzAWAChartsWithKPIPPTDownloadFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAChartsWithKPIPPTDownloadWorkflow.LoginFunctionality(driver,user);
			LocobuzzAWAChartsWithKPIPPTDownloadWorkflow.pptDownloadNativeForChartsWithKPI(driver);
			LocobuzzAWAChartsWithKPIPPTDownloadWorkflow.logout(driver);
