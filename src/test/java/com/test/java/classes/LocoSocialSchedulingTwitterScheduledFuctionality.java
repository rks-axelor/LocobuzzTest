...
import com.test.java.utilities.LocoSocialSchedulingTwitterScheduledWorkflow;
...
public class LocoSocialSchedulingTwitterScheduledFuctionality {
	...
	public void SchedulingProcess(String user) throws Exception	 {
		...
		try {
			...
			LocoSocialSchedulingTwitterScheduledWorkflow.goingSocialSchedulingSection(driver);
			LocoSocialSchedulingTwitterScheduledWorkflow.SchedulingFunctionality(driver);
