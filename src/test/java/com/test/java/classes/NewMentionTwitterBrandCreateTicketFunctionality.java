...
import com.test.java.utilities.NewMentionTwitterBrandCreateTicketProcess;
...
public class NewMentionTwitterBrandCreateTicketFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionTwitterBrandCreateTicketProcess.makeActionableProcess(driver, channel);
			NewMentionTwitterBrandCreateTicketProcess.ticketTabVerification(driver,channel);
			NewMentionTwitterBrandCreateTicketProcess.replyPostButton(driver,channel);
