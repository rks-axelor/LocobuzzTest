...
import com.test.java.utilities.ExcelReportCSDPendingTicketAnalysisWorkflow;
...
public class ExcelReportCSDPendingTicketAnalysisFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportCSDPendingTicketAnalysisWorkflow.excelReportCSDPendingTicketAnalysisReportTemplateWorkflow(driver);
