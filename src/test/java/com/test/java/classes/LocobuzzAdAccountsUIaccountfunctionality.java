...
import com.test.java.utilities.LocobuzzAdAccountsUIaccountVerification;
...
public class LocobuzzAdAccountsUIaccountfunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void ChannelCofiguration(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocobuzzAdAccountsUIaccountVerification.goingAccountSession(driver);
			LocobuzzAdAccountsUIaccountVerification.verifyingChannelConfigAdaccountsUIComponents(driver);
