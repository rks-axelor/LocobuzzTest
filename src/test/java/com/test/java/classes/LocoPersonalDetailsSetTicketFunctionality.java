...
import com.test.java.utilities.LocoPersonalDetailsSetTicketWorkflow;
...
public class LocoPersonalDetailsSetTicketFunctionality {
	...
	public void PersonalDetailsSettingsTicketFunction(String user,String channel) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocoPersonalDetailsSetTicketWorkflow.gotoTicketSection( driver, channel);
			LocoPersonalDetailsSetTicketWorkflow.ticketTabVerification( driver, channel);
			LocoPersonalDetailsSetTicketWorkflow.openDetailsButton( driver, channel); 
