...
import com.test.java.utilities.LocoSchedulingFailedTwitterWorkflow;
...
public class LocoSchedulingFailedTwitterFunctionality {
	...
	public void SchedulingProcess(String user) throws Exception	 {
		...
		try {
			...
			LocoSchedulingFailedTwitterWorkflow.goingSocialSchedulingSection(driver);
			LocoSchedulingFailedTwitterWorkflow.SchedulingFunctionality(driver);
