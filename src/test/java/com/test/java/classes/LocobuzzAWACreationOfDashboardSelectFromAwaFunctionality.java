...
import com.test.java.utilities.LocobuzzAWACreationOfDashboardSelectFromAwa;
...
public class LocobuzzAWACreationOfDashboardSelectFromAwaFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWACreationOfDashboardSelectFromAwa.LoginFunctionality(driver,user);
			LocobuzzAWACreationOfDashboardSelectFromAwa.createDashboard(driver);
			LocobuzzAWACreationOfDashboardSelectFromAwa.logout(driver);
