...
import com.test.java.utilities.LocoAutoCannedFacebookCSDWorkflow;
...
public class LocoAutoCannedResponseFacebookCSDFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			LocoAutoCannedFacebookCSDWorkflow.makeActionableProcess(driver, channel);
			LocoAutoCannedFacebookCSDWorkflow.ticketTabVerification(driver, channel);
			LocoAutoCannedFacebookCSDWorkflow.automatedcannedresponseprocess(driver, channel);
