...
import com.test.java.utilities.ExcelReportMentionMentionsTemplateWorkflow;
...
public class ExcelReportMentionMentionsTemplateFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportMentionMentionsTemplateWorkflow.excelReportMentionMentionsTemplateWorkflow(driver);
