...
import com.test.java.utilities.ECommerceTicketWorkflowProcess;
...
public class ECommerceTicketWorkflowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			ECommerceTicketWorkflowProcess.makeActionableProcess(driver, channel);
			ECommerceTicketWorkflowProcess.ticketTabVerification(driver, channel);
			ECommerceTicketWorkflowProcess.openDetailsButton(driver, channel);
