...
import com.test.java.utilities.LocobuzzKeywordConfigRealTimeYoutubeAdvanceWorkflow;
...
public class LocobuzzKeywordConfigRealTimeYoutubeAdvanceWorkflowFunctionality {
	...
	public void KeywordConfiguration(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzKeywordConfigRealTimeYoutubeAdvanceWorkflow.goingAccountSession(driver);
			LocobuzzKeywordConfigRealTimeYoutubeAdvanceWorkflow.keywordConfigurationYoutubeProcess(driver);
