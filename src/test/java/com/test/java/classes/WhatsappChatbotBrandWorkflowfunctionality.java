...
import com.test.java.utilities.WhatsAppChatbotCSDWorkflow;
import com.test.java.utilities.WhatsappChatbotBrandWorkflowProcess;
...
public class WhatsappChatbotBrandWorkflowfunctionality {
  ...
  @Parameters({ "user", "channel" })
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			WhatsappChatbotBrandWorkflowProcess.assignProcess(driver, channel);
			//WhatsappChatbotBrandWorkflowProcess.agentChatbotTicketProcess(driver, channel);
