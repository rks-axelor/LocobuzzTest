...
import com.test.java.utilities.LocobuzzManageBrandWorkflow;
...
public class LocobuzzManageBrandWorkflowFunctionality {
	...
	public void ManageBrand(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzManageBrandWorkflow.manageBrandProcess(driver);
