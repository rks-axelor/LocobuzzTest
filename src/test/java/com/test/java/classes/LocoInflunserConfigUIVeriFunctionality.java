...
import com.test.java.utilities.LocoInflunserConfigUIVerificationWorkflow;
...
public class LocoInflunserConfigUIVeriFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void InflunenserConfiguration(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocoInflunserConfigUIVerificationWorkflow.goingAccountSession(driver);
			LocoInflunserConfigUIVerificationWorkflow.verifyingInfluenserConfigurationComponents(driver);
