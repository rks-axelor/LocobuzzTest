...
import com.test.java.utilities.TwitterTicketBrandWorkflowProcess;
...
public class TwitterTicketBrandWorkflowFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			TwitterTicketBrandWorkflowProcess.makeActionableProcess(driver, channel);
			TwitterTicketBrandWorkflowProcess.ticketTabVerification(driver,channel);
			TwitterTicketBrandWorkflowProcess.replyPostButton(driver,channel);
