...
import com.test.java.utilities.EmailTicketWorkflowProcess;
...
public class EmailTicketWorkflowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			EmailTicketWorkflowProcess.makeActionableProcess(driver, channel);
			EmailTicketWorkflowProcess.ticketTabVerification(driver, channel);
			EmailTicketWorkflowProcess.replyPostButton(driver, channel);
