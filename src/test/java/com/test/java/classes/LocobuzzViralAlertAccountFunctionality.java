...
import com.test.java.utilities.LocobuzzViralAlertAccountWorkflowProcess;
...
public class LocobuzzViralAlertAccountFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void LocobViralAlertworkflow(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzViralAlertAccountWorkflowProcess.goingAccountSession(driver);
			LocobuzzViralAlertAccountWorkflowProcess.LocobuzzViralAlertUIVerification(driver);
