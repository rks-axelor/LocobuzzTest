...
import com.test.java.utilities.ExcelReportTicketTATWorkflow;
...
public class ExcelReportTicketTATFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportTicketTATWorkflow.excelReportTicketTATTemplateWorkflow(driver);
