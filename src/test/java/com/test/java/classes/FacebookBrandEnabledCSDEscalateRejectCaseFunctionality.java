...
import com.test.java.utilities.FacebookBrandEnabledCSDEscalateRejectCase;
...
public class FacebookBrandEnabledCSDEscalateRejectCaseFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			FacebookBrandEnabledCSDEscalateRejectCase.makeActionableProcess(driver, channel);
			FacebookBrandEnabledCSDEscalateRejectCase.ticketTabVerification(driver,channel);
			FacebookBrandEnabledCSDEscalateRejectCase.replyPostButton(driver,channel);
