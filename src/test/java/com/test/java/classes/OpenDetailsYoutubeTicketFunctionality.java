...
import com.test.java.utilities.OpenDetailsYoutubeTicketWorkflowProcess;
...
public class OpenDetailsYoutubeTicketFunctionality {
	...
	public void login(String user, String channel) throws Exception {
		...
		try {
			...
			OpenDetailsYoutubeTicketWorkflowProcess.openDetailsTicketsInformation(driver,channel);
			OpenDetailsYoutubeTicketWorkflowProcess.openDetailsButton(driver, channel);
