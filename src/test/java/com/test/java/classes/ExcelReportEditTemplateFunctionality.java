...
import com.test.java.utilities.ExcelReportEditTemplateWorkflow;
...
public class ExcelReportEditTemplateFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportEditTemplateWorkflow.excelReportEditTemplateWorkflow(driver);
