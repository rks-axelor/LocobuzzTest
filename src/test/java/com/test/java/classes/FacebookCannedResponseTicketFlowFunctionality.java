...
public class FacebookCannedResponseTicketFlowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			FacebookCannedResponseTicketFlow.makeActionableProcess(driver, channel);
			FacebookCannedResponseTicketFlow.ticketTabVerification(driver, channel);
			FacebookCannedResponseTicketFlow.replyPostButton(driver, channel);
