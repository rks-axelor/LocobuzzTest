...
import com.test.java.utilities.AllMentionECommerceWorkflowProcess;
...
public class AllMentionECommerceTicketFunctionality {
	...
	public String testName, className, dateTime, status;
	  ...
	  public void allMentionsECommerceTicketsFunctionality(String user, String channel) throws Exception {

			try {
				
				CommonFunctions.login(driver, user);
				AllMentionECommerceWorkflowProcess.allMentionsWorkFlow(driver, channel);
