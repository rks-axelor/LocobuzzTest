...
public class LocobuzzMakerCheckerUIComponentsFunctionality {
	...
	public void MakerChecker(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzMakerCheckerUIComponents.goingAccountSession(driver);
			LocobuzzMakerCheckerUIComponents.verifyingMakerCheckerComponents(driver);
