...
import com.test.java.utilities.LocoInfluencerConfigAccountWorkflow;
...
public class LocoInfluencerConfigAccountFunctionality {
	...
	public void InflunenserConfiguration(String user) throws Exception	 {
		...
		try {
			...
			LocoInfluencerConfigAccountWorkflow.goingAccountSession(driver);
			LocoInfluencerConfigAccountWorkflow.verifyingInfluenserConfigurationFunction(driver);
