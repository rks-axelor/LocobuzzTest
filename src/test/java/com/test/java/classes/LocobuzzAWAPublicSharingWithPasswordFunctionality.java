...
import com.test.java.utilities.LocobuzzAWAPublicSharingWithPasswordFlow;
...
public class LocobuzzAWAPublicSharingWithPasswordFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAPublicSharingWithPasswordFlow.LoginFunctionality(driver,user);
			LocobuzzAWAPublicSharingWithPasswordFlow.publicLinkSharing(driver);
			LocobuzzAWAPublicSharingWithPasswordFlow.logout(driver);
