...
import com.test.java.utilities.LocobuzzKeywordConfigRealTimeComplaintWebsiteWorkflow;

import io.github.bonigarcia.wdm.WebDriverManager;

public class LocobuzzKeywordConfigRealTimeComplaintWebsiteWorkflowFunctionality {
	...
	public void KeywordConfiguration(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzKeywordConfigRealTimeComplaintWebsiteWorkflow.goingAccountSession(driver);
			LocobuzzKeywordConfigRealTimeComplaintWebsiteWorkflow.keywordConfigurationComplaintWebsiteProcess(driver);
