...
import com.test.java.utilities.ExcelReportMentionPublicPostFLRCompetitionWorkflow;
...
public class ExcelReportMentionPublicPostFLRCompetitionFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportMentionPublicPostFLRCompetitionWorkflow.excelReportMentionPublicPostFLRCompetitionTemplateWorkflow(driver);
