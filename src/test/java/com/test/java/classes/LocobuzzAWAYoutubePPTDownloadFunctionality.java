...
import com.test.java.utilities.LocobuzzAWAYoutubePPTDownloadWorkflow;
...
public class LocobuzzAWAYoutubePPTDownloadFunctionality {
	...
	public void AWA(String user) throws Exception {
		...
		try {
			...
			LocobuzzAWAYoutubePPTDownloadWorkflow.pptDownloadNativeForYoutube(driver);
