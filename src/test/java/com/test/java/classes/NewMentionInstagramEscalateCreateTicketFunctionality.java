...
import com.test.java.utilities.NewMentionInstagramEscalateCreateTicketProcess;
...
public class NewMentionInstagramEscalateCreateTicketFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionInstagramEscalateCreateTicketProcess.makeActionableProcess(driver, channel);
			NewMentionInstagramEscalateCreateTicketProcess.ticketTabVerification(driver,channel);
			NewMentionInstagramEscalateCreateTicketProcess.moreButton(driver,channel);
