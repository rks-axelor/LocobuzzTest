...
public class InstagramBrandEnabledCSDEscalateFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			InstagramBrandEnabledCSDEscalate.makeActionableProcess(driver, channel);
			InstagramBrandEnabledCSDEscalate.ticketTabVerification(driver,channel);
			InstagramBrandEnabledCSDEscalate.replyPostButton(driver,channel);
