...
import com.test.java.utilities.LocCreateManualTicketAccountWorkflow;
...
public class LocoCreateManualTicketAccountFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void CreateManualticketAccount(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocCreateManualTicketAccountWorkflow.goingAccountSession(driver);
			LocCreateManualTicketAccountWorkflow.CreateManualticketAccountFunctionality(driver);
