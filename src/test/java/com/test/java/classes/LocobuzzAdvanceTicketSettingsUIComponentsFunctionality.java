...
import com.test.java.utilities.LocobuzzAdvanceTicketSettingsUIComponents;
...
public class LocobuzzAdvanceTicketSettingsUIComponentsFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void AdvanceTicketSettings(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzAdvanceTicketSettingsUIComponents.goingAccountSession(driver);
			LocobuzzAdvanceTicketSettingsUIComponents.verifyingAdvanceTicketSettingComponents(driver);
