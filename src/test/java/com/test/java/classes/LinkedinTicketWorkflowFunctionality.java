...
import com.test.java.utilities.LinkedinTicketWorkflowProcess;
...
public class LinkedinTicketWorkflowFunctionality {
	...
	public void allMentionsinstagramTicketsFunctionality(String user, String channel) throws Exception {

		try {

			CommonFunctions.login(driver, user);

			LinkedinTicketWorkflowProcess.makeActionableProcess(driver, channel);
			LinkedinTicketWorkflowProcess.ticketTabVerification(driver, channel);
			LinkedinTicketWorkflowProcess.replyPostButton(driver, channel);
