...
import com.test.java.utilities.NewMentionFacebookProcessReplyType;
...
public class NewMentionFacebookReplyFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionFacebookProcessReplyType.makeActionableProcess(driver, channel);
			NewMentionFacebookProcessReplyType.ticketTabVerification(driver,channel);
			NewMentionFacebookProcessReplyType.replyPostButton(driver,channel);
