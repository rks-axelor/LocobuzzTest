...
import com.test.java.utilities.LocobuzzAWAFiltersAuthorCityTypeFlow;
...
public class LocobuzzAWAFiltersAuthorCityTypeFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAFiltersAuthorCityTypeFlow.LoginFunctionality(driver,user);
			LocobuzzAWAFiltersAuthorCityTypeFlow.Filters(driver);
			LocobuzzAWAFiltersAuthorCityTypeFlow.logout(driver);
