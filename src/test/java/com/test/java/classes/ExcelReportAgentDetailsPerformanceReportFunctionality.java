...
import com.test.java.utilities.ExcelReportAgentDetailsPerformanceReportWorkflow;
...
public class ExcelReportAgentDetailsPerformanceReportFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportAgentDetailsPerformanceReportWorkflow.excelReportAgentDetailsPerformanceReportTemplateWorkflow(driver);
