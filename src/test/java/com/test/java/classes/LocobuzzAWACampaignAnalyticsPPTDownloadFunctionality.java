...
import com.test.java.utilities.LocobuzzAWACampaignAnalyticsPPTDownloadWorkflow;
...
public class LocobuzzAWACampaignAnalyticsPPTDownloadFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWACampaignAnalyticsPPTDownloadWorkflow.pptDownloadNativeForCampaignAnalytics(driver);
