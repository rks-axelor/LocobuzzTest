...
import com.test.java.utilities.LocobuzzManageBrandUIComponents;
...
public class LocobuzzManageBrandUIComponentsFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void ManageBrand(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			
			LocobuzzManageBrandUIComponents.verifyingManageBrandComponents(driver);
