...
import com.test.java.utilities.ExcelReportMentionTicketWorkflowReportV2Workflow;
...
public class ExcelReportMentionTicketWorkflowReportV2Functionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportMentionTicketWorkflowReportV2Workflow.excelReportMentionTicketWorkflowReportV2TemplateWorkflow(driver);
