...
import com.test.java.utilities.OpenDetailsGMBReviewTicketWorkflowProcess;
...
public class OpenDetailsGMBReviewTicketFunctionality {
	...
	public void login(String user, String channel) throws Exception {
		...
		try {
			...
			OpenDetailsGMBReviewTicketWorkflowProcess.openDetailsTicketsInformation(driver,channel);
			OpenDetailsGMBReviewTicketWorkflowProcess.openDetailsButton(driver, channel);
