...
import com.test.java.utilities.LocobuzzPriorityConfigurationUIComponents;
...
public class LocobuzzPriorityConfigurationUIComponentsFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void PriorityConfiguration(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzPriorityConfigurationUIComponents.goingAccountSession(driver);
			LocobuzzPriorityConfigurationUIComponents.verifyingPriorityConfigurationComponents(driver);
