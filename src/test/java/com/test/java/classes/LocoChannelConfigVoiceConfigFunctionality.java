...
import com.test.java.utilities.LocoChannelConfigVoiceConfigWorkflow;
...
public class LocoChannelConfigVoiceConfigFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void ChannelCofigurationvoice(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocoChannelConfigVoiceConfigWorkflow.goingAccountSession(driver);
			LocoChannelConfigVoiceConfigWorkflow.ChannelConfigurationVoiceWorkFlow(driver);
