...
import com.test.java.utilities.LocobuzzAWAContentBenchmarkingPPTDownloadWorkflow;
...
public class LocobuzzAWAContentBenchmarkingPPTDownloadFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAContentBenchmarkingPPTDownloadWorkflow.pptDownloadNativeForContentBenchmarking(driver);
