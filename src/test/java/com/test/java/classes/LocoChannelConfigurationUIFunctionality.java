...
import com.test.java.utilities.LocoChannelConfigurationUIVerification;
...
public class LocoChannelConfigurationUIFunctionality {
	...
	public void ChannelCofiguration(String user) throws Exception	 {
		...
		try {
			...
			LocoChannelConfigurationUIVerification.goingAccountSession(driver);
			LocoChannelConfigurationUIVerification.verifyingChannelConfigurationUIComponents(driver);
