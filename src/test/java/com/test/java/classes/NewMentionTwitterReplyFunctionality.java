...
import com.test.java.utilities.NewMentionTwitterReplyTypeProcess;
...
public class NewMentionTwitterReplyFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionTwitterReplyTypeProcess.makeActionableProcess(driver, channel);
			NewMentionTwitterReplyTypeProcess.ticketTabVerification(driver,channel);
			NewMentionTwitterReplyTypeProcess.replyPostButton(driver,channel);
