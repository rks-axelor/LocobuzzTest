...
import com.test.java.utilities.ExcelReportGMBLocationDataReportWorkflow;
...
public class ExcelReportGMBLocationDataReportFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportGMBLocationDataReportWorkflow.excelReportGMBLocationDataReportTemplateWorkflow(driver);
