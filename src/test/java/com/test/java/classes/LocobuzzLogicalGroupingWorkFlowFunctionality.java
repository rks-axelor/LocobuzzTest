...
public class LocobuzzLogicalGroupingWorkFlowFunctionality {
	...
	public void LogicalGroupingWorkFlow(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzLogicalGroupingWorkflowprocess.goingAccountSession(driver);
			LocobuzzLogicalGroupingWorkflowprocess.LogicalGroupingWorkprocess(driver);
