...
import com.test.java.utilities.LocobuzzAWAShareWithTeamMembersWorkflow;
...
public class LocobuzzAWAShareWithTeamMembersFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAShareWithTeamMembersWorkflow.LoginFunctionality(driver,user);
			LocobuzzAWAShareWithTeamMembersWorkflow.shareWithTeam(driver);
			LocobuzzAWAShareWithTeamMembersWorkflow.logout(driver);
