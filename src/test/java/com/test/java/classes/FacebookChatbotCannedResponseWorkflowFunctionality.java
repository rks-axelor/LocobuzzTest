...
import com.test.java.utilities.FacebookChatbotCannedResponseWorkflowProcess;
...
public class FacebookChatbotCannedResponseWorkflowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			FacebookChatbotCannedResponseWorkflowProcess.assignProcess(driver, channel);
			FacebookChatbotCannedResponseWorkflowProcess.agentChatbotTicketProcess(driver, channel);
