...
import com.test.java.utilities.LocobuzzAgentTicketsTabUIComponents;
...
public class LocobuzzAgentTicketTabUIComponentsFunctionality {
	...
	public void login(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAgentTicketsTabUIComponents.verifyingTicketTabUIComponents(driver);
