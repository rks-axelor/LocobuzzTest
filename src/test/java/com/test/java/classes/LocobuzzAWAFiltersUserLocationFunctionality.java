...
import com.test.java.utilities.LocobuzzAWAFiltersUserLocation;
...
public class LocobuzzAWAFiltersUserLocationFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAFiltersUserLocation.LoginFunctionality(driver,user);
			LocobuzzAWAFiltersUserLocation.Filters(driver);
			LocobuzzAWAFiltersUserLocation.logout(driver);
