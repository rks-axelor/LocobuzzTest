...
import com.test.java.utilities.LocoChannelConfigurationGPSWorkflow;
...
public class LocoChannelConfigurationGPSFunctionality {
	...
	public void ChannelCofigurationInsta(String user) throws Exception	 {
		...
		try {
			...
			LocoChannelConfigurationGPSWorkflow.goingAccountSession(driver);
			LocoChannelConfigurationGPSWorkflow.ChannelConfigurationGPSWorkFlow(driver);
