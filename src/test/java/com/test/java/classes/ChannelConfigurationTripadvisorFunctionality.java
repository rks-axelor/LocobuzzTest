...
public class ChannelConfigurationTripadvisorFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void ChannelCofigurationTripadvisor(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocoChannelConfigTripAdvisorWorkFlow.goingAccountSession(driver);
			LocoChannelConfigTripAdvisorWorkFlow.ChannelConfigurationTripadvisorWorkFlow(driver);
