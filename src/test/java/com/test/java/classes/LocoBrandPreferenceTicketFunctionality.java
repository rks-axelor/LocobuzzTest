...
import com.test.java.utilities.LocoBrandPreferenceTicketWorkprocess;
...
public class LocoBrandPreferenceTicketFunctionality {
	...
	public void login(String user) throws Exception {
		...
		try {
			...
			LocoBrandPreferenceTicketWorkprocess.goingAccountSession(driver);
			LocoBrandPreferenceTicketWorkprocess.BrandPreferenceFunctionality(driver);
