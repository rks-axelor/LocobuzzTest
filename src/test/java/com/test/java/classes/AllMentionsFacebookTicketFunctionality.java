...
import com.test.java.utilities.AllMentionFacebookWorkflowProcess;
import com.test.java.utilities.CommonFunctions;

import io.github.bonigarcia.wdm.WebDriverManager;

public class AllMentionsFacebookTicketFunctionality {
  ...
  public void allMentionsfacebookTicketsFunctionality(String user, String channel) throws Exception {

		try {
			
			CommonFunctions.login(driver, user);
			AllMentionFacebookWorkflowProcess.allMentionsWorkFlow(driver, channel);
