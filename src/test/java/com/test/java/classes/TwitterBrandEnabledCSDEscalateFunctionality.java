...
import com.test.java.utilities.TwitterBrandEnabledCSDEscalate;
...
public class TwitterBrandEnabledCSDEscalateFunctionality {
	...
	public void allMentionsTicketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			TwitterBrandEnabledCSDEscalate.makeActionableProcess(driver, channel);
			TwitterBrandEnabledCSDEscalate.ticketTabVerification(driver,channel);
			TwitterBrandEnabledCSDEscalate.replyPostButton(driver,channel);
