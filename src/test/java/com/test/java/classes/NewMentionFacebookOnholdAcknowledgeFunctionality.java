...
import com.test.java.utilities.NewMentionFacebookOnholdAcknowledgeProcess;
...
public class NewMentionFacebookOnholdAcknowledgeFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionFacebookOnholdAcknowledgeProcess.makeActionableProcess(driver, channel);
			NewMentionFacebookOnholdAcknowledgeProcess.ticketTabVerification(driver,channel);
			NewMentionFacebookOnholdAcknowledgeProcess.replyPostButton(driver,channel);
