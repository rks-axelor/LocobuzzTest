...
import com.test.java.utilities.TwitterCannedResponseTicketWorkFlow;
...
public class TwitterCannedResponseTicketWorkFlowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			TwitterCannedResponseTicketWorkFlow.makeActionableProcess(driver, channel);
			TwitterCannedResponseTicketWorkFlow.ticketTabVerification(driver, channel);
			TwitterCannedResponseTicketWorkFlow.replyPostButton(driver, channel);
