...
import com.test.java.utilities.InstagramChatbotCustomerWorkflowProcess;
...
public class InstagramChatbotCustomerWorkflowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			InstagramChatbotCustomerWorkflowProcess.assignProcess(driver, channel);
			InstagramChatbotCustomerWorkflowProcess.agentChatbotTicketProcess(driver, channel);
