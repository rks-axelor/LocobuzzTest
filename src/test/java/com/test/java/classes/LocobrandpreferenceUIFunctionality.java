...
import com.test.java.utilities.LocoBrandPreferenceUIVerificationProcess;
...
public class LocobrandpreferenceUIFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void BrandPreferenceUIVerification(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocoBrandPreferenceUIVerificationProcess.goingAccountSession(driver);
			LocoBrandPreferenceUIVerificationProcess.BrandPreferenceUIVerificationProcess(driver);
