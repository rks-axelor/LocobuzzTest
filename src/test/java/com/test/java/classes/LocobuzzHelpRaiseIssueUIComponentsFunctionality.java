...
import com.test.java.utilities.LocobuzzHelpRaiseIssueUIComponents;
...
public class LocobuzzHelpRaiseIssueUIComponentsFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void HelpRaiseIssue(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzHelpRaiseIssueUIComponents.verifyingRaiseIssueComponents(driver);
