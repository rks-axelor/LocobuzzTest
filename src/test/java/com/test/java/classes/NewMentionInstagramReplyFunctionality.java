...
import com.test.java.utilities.NewMentionInstagramReplyTypeProcess;
...
public class NewMentionInstagramReplyFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionInstagramReplyTypeProcess.makeActionableProcess(driver, channel);
			NewMentionInstagramReplyTypeProcess.ticketTabVerification(driver,channel);
			NewMentionInstagramReplyTypeProcess.replyPostButton(driver,channel);
