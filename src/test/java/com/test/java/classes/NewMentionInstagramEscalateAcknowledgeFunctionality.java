...
import com.test.java.utilities.NewMentionInstagramEscalateAcknowledgeProcess;
...
public class NewMentionInstagramEscalateAcknowledgeFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionInstagramEscalateAcknowledgeProcess.makeActionableProcess(driver, channel);
			NewMentionInstagramEscalateAcknowledgeProcess.ticketTabVerification(driver,channel);
			NewMentionInstagramEscalateAcknowledgeProcess.moreButton(driver,channel);
