...
import com.test.java.utilities.TwitterBrandEnabledCSDReject;
...
public class TwitterBrandEnabledCSDRejectFunctionality {
	...
	public void allMentionsTicketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			TwitterBrandEnabledCSDReject.makeActionableProcess(driver, channel);
			TwitterBrandEnabledCSDReject.ticketTabVerification(driver,channel);
			TwitterBrandEnabledCSDReject.replyPostButton(driver,channel);
