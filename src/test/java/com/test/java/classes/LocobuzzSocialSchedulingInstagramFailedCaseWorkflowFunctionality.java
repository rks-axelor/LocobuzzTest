...
import com.test.java.utilities.LocobuzzSocialSchedulingInstagramFailedCaseWorkflow;
...
public class LocobuzzSocialSchedulingInstagramFailedCaseWorkflowFunctionality {
	...
	public void SocialScheduling(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzSocialSchedulingInstagramFailedCaseWorkflow.socialSchedulingInstagramFailedCaseWorkflow(driver);
