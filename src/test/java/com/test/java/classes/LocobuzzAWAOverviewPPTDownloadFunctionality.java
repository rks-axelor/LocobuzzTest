...
import com.test.java.utilities.LocobuzzAWAOverviewPPTDownloadWorkflow;
...
public class LocobuzzAWAOverviewPPTDownloadFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAOverviewPPTDownloadWorkflow.pptDownloadNativeForOverview(driver);
