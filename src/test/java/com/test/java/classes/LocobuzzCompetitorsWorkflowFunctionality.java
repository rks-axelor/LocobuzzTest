...
public class LocobuzzCompetitorsWorkflowFunctionality {
	...
	public void LogicalGroupingWorkFlow(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzCompetitorsWorkflowProcess.goingAccountSession(driver);
			LocobuzzCompetitorsWorkflowProcess.CompetitorsWorkprocess(driver);
