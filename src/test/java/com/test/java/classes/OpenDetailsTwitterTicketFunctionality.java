...
import com.test.java.utilities.OpenDetailsTwitterTicketWorkFlowProcess;

import io.github.bonigarcia.wdm.WebDriverManager;

public class OpenDetailsTwitterTicketFunctionality {
	...
	public void login(String user, String channel) throws Exception {
		...
		try {
			...
			OpenDetailsTwitterTicketWorkFlowProcess.openDetailsTicketsInformation(driver,channel);
			OpenDetailsTwitterTicketWorkFlowProcess.openDetailsButton(driver, channel);
