...
import com.test.java.utilities.LocoSLABreachAccount2WorkFlow;
...
public class LocoSLABreachAccount2Functionality {
	...
	@Test
	@Parameters({ "user" })
	public void SLAUIVerification(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocoSLABreachAccount2WorkFlow.goingAccountSession(driver);
			LocoSLABreachAccount2WorkFlow.SLABreachAccountWorkflow(driver);
