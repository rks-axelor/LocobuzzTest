...
import com.test.java.utilities.LocoBrandPreferenceAccountWorkprocess;
...
public class LocoBrandPreferenceAccountFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void BrandPreference(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocoBrandPreferenceAccountWorkprocess.goingAccountSession(driver);
			LocoBrandPreferenceAccountWorkprocess.BrandPreferenceFunctionality(driver);
