...
import com.test.java.utilities.LocobuzzAWAFiltersMarkedInfluencer;
...
public class LocobuzzAWAFiltersMarkedInfluencerFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAFiltersMarkedInfluencer.LoginFunctionality(driver,user);
			LocobuzzAWAFiltersMarkedInfluencer.Filters(driver);
			LocobuzzAWAFiltersMarkedInfluencer.logout(driver);
