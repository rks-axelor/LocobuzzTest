...
import com.test.java.utilities.LocobuzzPublishPersonalizationWorkflow;
...
public class LocobuzzPublishPersonalizationWorkflowFunctionality {
	...
	public void PublishPersonalization(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzPublishPersonalizationWorkflow.goingAccountSession(driver);
			LocobuzzPublishPersonalizationWorkflow.publishPersonalizationWorkflow(driver);
