...
import com.test.java.utilities.LocobuzzPublishApproverUIComponents;
...
public class LocobuzzPublishApproverUIComponentsFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void TeamManagement(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocobuzzPublishApproverUIComponents.goingAccountSession(driver);
			LocobuzzPublishApproverUIComponents.verifyingPublishApproverUIComponents(driver);
