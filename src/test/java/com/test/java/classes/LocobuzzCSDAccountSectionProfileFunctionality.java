...
import com.test.java.utilities.LocobuzzCSDAccountSectionProfile;
...
public class LocobuzzCSDAccountSectionProfileFunctionality {
	...
	public void Profile(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzCSDAccountSectionProfile.goingAccountSession(driver);
			LocobuzzCSDAccountSectionProfile.verifyingAccountComponents(driver);
			LocobuzzCSDAccountSectionProfile.verfyingProfileComponents(driver);
