...
import com.test.java.utilities.NewMentionFacebookOnholdCreateTicketProcess;
...
public class NewMentionFacebookOnholdCreateTicketFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionFacebookOnholdCreateTicketProcess.makeActionableProcess(driver, channel);
			NewMentionFacebookOnholdCreateTicketProcess.ticketTabVerification(driver,channel);
			NewMentionFacebookOnholdCreateTicketProcess.replyPostButton(driver,channel);
