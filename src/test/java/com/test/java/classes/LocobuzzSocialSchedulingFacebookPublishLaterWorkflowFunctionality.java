...
import com.test.java.utilities.LocobuzzSocialSchedulingFacebookPublishLaterWorkflow;
...
public class LocobuzzSocialSchedulingFacebookPublishLaterWorkflowFunctionality {
	...
	public void SocialScheduling(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzSocialSchedulingFacebookPublishLaterWorkflow.socialSchedulingFacebookPublishLaterWorkflow(driver);
