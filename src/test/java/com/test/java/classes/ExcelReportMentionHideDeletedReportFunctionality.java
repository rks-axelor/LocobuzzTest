...
import com.test.java.utilities.ExcelReportMentionHideDeletedReportWorkflow;
...
public class ExcelReportMentionHideDeletedReportFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportMentionHideDeletedReportWorkflow.excelReportMentionHideDeletedReportTemplateWorkflow(driver);
