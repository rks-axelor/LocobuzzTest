...
import com.test.java.utilities.LocobuzzCannedResponseUIComponents;
...
public class LocobuzzCannedResponseUIComponentsFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void CannedResponse(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzCannedResponseUIComponents.goingAccountSession(driver);
			LocobuzzCannedResponseUIComponents.verifyingCannedResponseComponents(driver);
