...
import com.test.java.utilities.ExcelReportEmailForwardSummaryTicketWorkflow;
...
public class ExcelReportEmailForwardSummaryTicketFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportEmailForwardSummaryTicketWorkflow.excelReportEmailForwardSummaryTicketWorkflow(driver);
