...
import com.test.java.utilities.NewMentionFacebookBrandAcknowledgeProcess;
...
public class NewMentionFacebookBrandAcknowledgeFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionFacebookBrandAcknowledgeProcess.makeActionableProcess(driver, channel);
			NewMentionFacebookBrandAcknowledgeProcess.ticketTabVerification(driver,channel);
			NewMentionFacebookBrandAcknowledgeProcess.replyPostButton(driver,channel);
