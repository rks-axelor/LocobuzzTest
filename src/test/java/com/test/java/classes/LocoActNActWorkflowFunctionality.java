...
import com.test.java.utilities.LocobuzzActNActWorkflowProcess;
...
public class LocoActNActWorkflowFunctionality {
	...
	public void LogicalGrouping(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzActNActWorkflowProcess.goingAccountSession(driver);
			LocobuzzActNActWorkflowProcess.Actinablenonactionablefunctionality(driver);
