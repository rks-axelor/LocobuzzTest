...
import com.test.java.utilities.FacebookBrandEnabledCSDReject;
...
public class FacebookBrandEnabledCSDRejectFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			FacebookBrandEnabledCSDReject.makeActionableProcess(driver, channel);
			FacebookBrandEnabledCSDReject.ticketTabVerification(driver,channel);
			FacebookBrandEnabledCSDReject.replyPostButton(driver,channel);
