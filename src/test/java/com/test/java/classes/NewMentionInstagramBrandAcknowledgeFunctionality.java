...
import com.test.java.utilities.NewMentionInstagramBrandAcknowledgeProcess;
...
public class NewMentionInstagramBrandAcknowledgeFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionInstagramBrandAcknowledgeProcess.makeActionableProcess(driver, channel);
			NewMentionInstagramBrandAcknowledgeProcess.ticketTabVerification(driver,channel);
			NewMentionInstagramBrandAcknowledgeProcess.replyPostButton(driver,channel);
