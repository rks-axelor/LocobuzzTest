...
import com.test.java.utilities.LocobuzzSocialSchedulingInstagramDraftWorkflow;
...
public class LocobuzzSocialSchedulingInstagramDraftWorkflowFunctionality {
	...
	public void SocialScheduling(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzSocialSchedulingInstagramDraftWorkflow.socialSchedulingInstagramWorkflow(driver);
