...
import com.test.java.utilities.InstagramChatbotCannedResponseWorkflowProces;
...
public class InstagramChatbotCannedResponseWorkflowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			InstagramChatbotCannedResponseWorkflowProces.assignProcess(driver, channel);
			InstagramChatbotCannedResponseWorkflowProces.agentChatbotTicketProcess(driver, channel);
