...
import com.test.java.utilities.FacebookOldTicketWorkflowProcess;
...
public class FacebookOldTicketWorkflowFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			FacebookOldTicketWorkflowProcess.makeProcess(driver, channel);
			FacebookOldTicketWorkflowProcess.ticketTabVerification(driver,channel);
			FacebookOldTicketWorkflowProcess.replyPostButton(driver,channel);
