...
import com.test.java.utilities.LocobuzzSocialSchedulingGMBApprovalWorkflow;
...
public class LocobuzzSocialSchedulingGMBApprovalWorkflowFunctionality {
	...
	public void SocialScheduling(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzSocialSchedulingGMBApprovalWorkflow.socialSchedulingGMBApprovalWorkflow(driver);
