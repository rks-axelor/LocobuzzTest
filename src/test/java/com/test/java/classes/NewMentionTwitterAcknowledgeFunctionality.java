...
import com.test.java.utilities.NewMentionTwitterAcknowledgeTypeProcess;


import io.github.bonigarcia.wdm.WebDriverManager;

public class NewMentionTwitterAcknowledgeFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionTwitterAcknowledgeTypeProcess.makeActionableProcess(driver, channel);
			NewMentionTwitterAcknowledgeTypeProcess.ticketTabVerification(driver,channel);
			NewMentionTwitterAcknowledgeTypeProcess.replyPostButton(driver,channel);
