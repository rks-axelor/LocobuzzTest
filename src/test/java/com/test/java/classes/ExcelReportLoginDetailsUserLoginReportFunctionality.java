...
import com.test.java.utilities.ExcelReportLoginDetailsUserLoginReportWorkflow;
...
public class ExcelReportLoginDetailsUserLoginReportFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportLoginDetailsUserLoginReportWorkflow.excelReportLoginDetailsUserLoginReportTemplateWorkflow(driver);
