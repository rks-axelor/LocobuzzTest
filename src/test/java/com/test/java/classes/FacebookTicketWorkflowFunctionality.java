...
import com.test.java.utilities.FacebookTicketWorkflowProcess;
...
public class FacebookTicketWorkflowFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			FacebookTicketWorkflowProcess.makeActionableProcess(driver, channel);
			FacebookTicketWorkflowProcess.ticketTabVerification(driver,channel);
			FacebookTicketWorkflowProcess.replyPostButton(driver,channel);
