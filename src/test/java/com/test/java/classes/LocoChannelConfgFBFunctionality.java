...
import com.test.java.utilities.LocoChannelConfgFBWorkflow;
...
public class LocoChannelConfgFBFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void ChannelCofigurationFacebook(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocoChannelConfgFBWorkflow.goingAccountSession(driver);
			LocoChannelConfgFBWorkflow.ChannelConfigurationFacebookWorkFlow(driver);
