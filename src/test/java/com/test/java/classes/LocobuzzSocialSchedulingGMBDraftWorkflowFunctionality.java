...
import com.test.java.utilities.LocobuzzSocialSchedulingGMBDraftWorkflow;
...
public class LocobuzzSocialSchedulingGMBDraftWorkflowFunctionality {
	...
	public void SocialScheduling(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzSocialSchedulingGMBDraftWorkflow.socialSchedulingGMBWorkflow(driver);
