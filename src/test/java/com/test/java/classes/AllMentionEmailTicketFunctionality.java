...
import com.test.java.utilities.AllMentionEmailWorkflowProcess;
...
public class AllMentionEmailTicketFunctionality {
	...
	public String testName, className, dateTime, status;
	  ...
	  public void allMentionsEmailTicketsFunctionality(String user, String channel) throws Exception {
			...
			try {
				...
				AllMentionEmailWorkflowProcess.allMentionsWorkFlow(driver, channel);
