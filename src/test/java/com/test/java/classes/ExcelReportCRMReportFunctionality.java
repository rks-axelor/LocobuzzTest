...
import com.test.java.utilities.ExcelReportCRMReportWorkflow;
...
public class ExcelReportCRMReportFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportCRMReportWorkflow.excelReportCRMReportTemplateWorkflow(driver);
