...
import com.test.java.utilities.LocoChannelConfigurationInstaWorkflow;
...
public class LocoChannelConfigurationInstaFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void ChannelCofigurationInsta(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocoChannelConfigurationInstaWorkflow.goingAccountSession(driver);
			LocoChannelConfigurationInstaWorkflow.ChannelConfigurationInstaWorkFlow(driver);
