...
import com.test.java.utilities.NewMentionInstagramBrandReplyProcess;
...
public class NewMentionInstagramBrandReplyFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionInstagramBrandReplyProcess.makeActionableProcess(driver, channel);
			NewMentionInstagramBrandReplyProcess.ticketTabVerification(driver,channel);
			NewMentionInstagramBrandReplyProcess.replyPostButton(driver,channel);
