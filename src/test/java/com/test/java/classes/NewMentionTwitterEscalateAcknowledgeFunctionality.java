...
import com.test.java.utilities.NewMentionTwitterEscalateAcknowledgeProcess;
...
public class NewMentionTwitterEscalateAcknowledgeFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionTwitterEscalateAcknowledgeProcess.makeActionableProcess(driver, channel);
			NewMentionTwitterEscalateAcknowledgeProcess.ticketTabVerification(driver,channel);
			NewMentionTwitterEscalateAcknowledgeProcess.moreButton(driver,channel);
