...
import com.test.java.utilities.InstagramTicketWorkflowProcess;
...
public class InstagramTicketWorkflowFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			InstagramTicketWorkflowProcess.makeActionableProcess(driver, channel);
			InstagramTicketWorkflowProcess.ticketTabVerification(driver,channel);
			InstagramTicketWorkflowProcess.replyPostButton(driver,channel);
