...
import com.test.java.utilities.LocobuzzKeywordConfigRealTimeTeamBHPWorkflow;
...
public class LocobuzzKeywordConfigRealTimeTeamBHPWorkflowFunctionality {
	...
	public void KeywordConfiguration(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzKeywordConfigRealTimeTeamBHPWorkflow.goingAccountSession(driver);
			LocobuzzKeywordConfigRealTimeTeamBHPWorkflow.keywordConfigurationTeamBHPProcess(driver);
