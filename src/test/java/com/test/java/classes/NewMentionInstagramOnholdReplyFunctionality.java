...
import com.test.java.utilities.NewMentionInstagramOnholdReplyProcess;
...
public class NewMentionInstagramOnholdReplyFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionInstagramOnholdReplyProcess.makeActionableProcess(driver, channel);
			NewMentionInstagramOnholdReplyProcess.ticketTabVerification(driver,channel);
			NewMentionInstagramOnholdReplyProcess.replyPostButton(driver,channel);
