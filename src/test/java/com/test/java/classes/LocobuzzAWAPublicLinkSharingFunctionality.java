...
import com.test.java.utilities.LocobuzzAWAPublicLinkSharingWorkflow;
...
public class LocobuzzAWAPublicLinkSharingFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAPublicLinkSharingWorkflow.LoginFunctionality(driver,user);
			LocobuzzAWAPublicLinkSharingWorkflow.publicLinkSharing(driver);
			LocobuzzAWAPublicLinkSharingWorkflow.logout(driver);
