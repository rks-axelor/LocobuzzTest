...
import com.test.java.utilities.InstagramChatbotCSDWorkflowProcess;
...
public class InstagramChatbotCSDWorkflowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			InstagramChatbotCSDWorkflowProcess.assignProcess(driver, channel);
			InstagramChatbotCSDWorkflowProcess.agentChatbotTicketProcess(driver, channel);
