...
import com.test.java.utilities.OpenDetailsTwitterTicketBrandWorkflowProcess;
...
public class OpenDetailsTwitterTicketBrandWorkflowFunctionality {
	...
	public void login(String user, String channel) throws Exception {
		...
		try {
			...
			OpenDetailsTwitterTicketBrandWorkflowProcess.openDetailsTicketsInformation(driver,channel);
			OpenDetailsTwitterTicketBrandWorkflowProcess.openDetailsButton(driver, channel);
