...
import com.test.java.utilities.TwitterBrandDisabledBrandOnHoldProcess;
...
public class TwitterBrandDisabledBrandOnHoldFunctionality {
	...
	public void allMentionsTicketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			TwitterBrandDisabledBrandOnHoldProcess.makeActionableProcess(driver, channel);
			TwitterBrandDisabledBrandOnHoldProcess.ticketTabVerification(driver,channel);
			TwitterBrandDisabledBrandOnHoldProcess.replyPostButton(driver,channel);
