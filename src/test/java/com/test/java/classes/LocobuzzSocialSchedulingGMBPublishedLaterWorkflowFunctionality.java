...
import com.test.java.utilities.LocobuzzSocialSchedulingGMBPublishedLaterWorkflow;
...
public class LocobuzzSocialSchedulingGMBPublishedLaterWorkflowFunctionality {
	...
	public void SocialScheduling(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzSocialSchedulingGMBPublishedLaterWorkflow.socialSchedulingGMBPublishedLaterWorkflow(driver);
