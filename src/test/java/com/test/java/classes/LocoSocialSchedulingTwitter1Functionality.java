...
import com.test.java.utilities.LocoSocialSchedulingTwitter1Workflow;
...
public class LocoSocialSchedulingTwitter1Functionality {
	...
	public void SchedulingProcess(String user) throws Exception	 {
		...
		try {
			...
			LocoSocialSchedulingTwitter1Workflow.goingSocialSchedulingSection(driver);
			LocoSocialSchedulingTwitter1Workflow.SchedulingFunctionality(driver);
