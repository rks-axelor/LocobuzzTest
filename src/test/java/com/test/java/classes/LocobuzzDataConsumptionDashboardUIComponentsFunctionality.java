...
import com.test.java.utilities.LocobuzzDataConsumptionDashboardUIComponents;
...
public class LocobuzzDataConsumptionDashboardUIComponentsFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void DataConsumptionDashboard(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			
			LocobuzzDataConsumptionDashboardUIComponents.verifyingDataConsumptionDashboardComponents(driver);
