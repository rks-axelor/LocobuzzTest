...
import com.test.java.utilities.LocobuzzCategoryMappingWorkflow;
...
public class LocobuzzCategoryMappingWorkflowFunctionality {
	...
	public void CategoryMapping(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzCategoryMappingWorkflow.goingAccountSession(driver);
			LocobuzzCategoryMappingWorkflow.categoryMappingWorkflow(driver);
