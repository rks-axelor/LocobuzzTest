...
import com.test.java.utilities.LocoSLABreachInstagramWorkflow;
...
public class LocoSLABreachInstagramFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void SLAFacebookFunction(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocoSLABreachInstagramWorkflow.goingAccountSession(driver);
			LocoSLABreachInstagramWorkflow.SLABreachInstagramWorkflow(driver);
