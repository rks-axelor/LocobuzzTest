...
import com.test.java.utilities.LocoSocilaSchedulingYT2Workflow;
...
public class LocoSocilaSchedulingYT2Functionality {
	...
	public void SchedulingProcess(String user) throws Exception	 {
		...
		try {
			...
			LocoSocilaSchedulingYT2Workflow.goingSocialSchedulingSection(driver);
			LocoSocilaSchedulingYT2Workflow.SchedulingFunctionality(driver);
