...
import com.test.java.utilities.NewMentionTwitterEscalateReplyProcess;
...
public class NewMentionTwitterEscalateReplyFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionTwitterEscalateReplyProcess.makeActionableProcess(driver, channel);
			NewMentionTwitterEscalateReplyProcess.ticketTabVerification(driver,channel);
			NewMentionTwitterEscalateReplyProcess.moreButton(driver,channel);
