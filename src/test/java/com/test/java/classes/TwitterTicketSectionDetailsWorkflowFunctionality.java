...
import com.test.java.utilities.TwitterTicketSectionDetailsWorkflow;
...
public class TwitterTicketSectionDetailsWorkflowFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			TwitterTicketSectionDetailsWorkflow.GotoTicketTab(driver, channel);
			TwitterTicketSectionDetailsWorkflow.ticketTabVerification(driver,channel);
			TwitterTicketSectionDetailsWorkflow.replyPostButton(driver,channel);
			TwitterTicketSectionDetailsWorkflow.opendetails(driver);
