...
import com.test.java.utilities.AllMentionYoutubeWorkflowProcess;
...
public class AllMentionYoutubeTicketFunctionality {
  ...
  public void allMentionsyoutubeTicketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			AllMentionYoutubeWorkflowProcess.allMentionsWorkFlow(driver, channel);
