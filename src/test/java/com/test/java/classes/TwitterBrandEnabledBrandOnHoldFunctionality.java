...
import com.test.java.utilities.TwitterBrandEnabledBrandOnHoldProcess;
...
public class TwitterBrandEnabledBrandOnHoldFunctionality {
	...
	public void allMentionsTicketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			TwitterBrandEnabledBrandOnHoldProcess.makeActionableProcess(driver, channel);
			TwitterBrandEnabledBrandOnHoldProcess.ticketTabVerification(driver,channel);
			TwitterBrandEnabledBrandOnHoldProcess.replyPostButton(driver,channel);
