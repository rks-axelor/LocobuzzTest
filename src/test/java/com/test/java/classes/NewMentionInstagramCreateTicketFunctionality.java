...
import com.test.java.utilities.NewMentionInstagramCreateTicketTypeProcess;
...
public class NewMentionInstagramCreateTicketFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionInstagramCreateTicketTypeProcess.makeActionableProcess(driver, channel);
			NewMentionInstagramCreateTicketTypeProcess.ticketTabVerification(driver,channel);
			NewMentionInstagramCreateTicketTypeProcess.replyPostButton(driver,channel);
