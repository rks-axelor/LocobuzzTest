...
import com.test.java.utilities.NewMentionInstagramEscalateReplyProcess;
...
public class NewMentionInstagramEscalateReplyFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionInstagramEscalateReplyProcess.makeActionableProcess(driver, channel);
			NewMentionInstagramEscalateReplyProcess.ticketTabVerification(driver,channel);
			NewMentionInstagramEscalateReplyProcess.moreButton(driver,channel);
