...
import com.test.java.utilities.LocochannelconfigExpediaWorkflow;
...
public class LocoChannelConfigExpediaFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void ChannelCofigurationExpedia(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocochannelconfigExpediaWorkflow.goingAccountSession(driver);
			LocochannelconfigExpediaWorkflow.ChannelConfigurationExpediaWorkFlow(driver);
