...
import com.test.java.utilities.LocobuzzAWAInstagramPPTDownloadWorkflow;
...
public class LocobuzzAWAInstagramPPTDownloadFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAInstagramPPTDownloadWorkflow.pptDownloadNativeForInstagram(driver);
