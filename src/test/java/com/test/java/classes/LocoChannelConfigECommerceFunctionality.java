...
import com.test.java.utilities.LocoChannelConfigECommerceWorkflow;
...
public class LocoChannelConfigECommerceFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void ChannelCofigurationEcommerce(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocoChannelConfigECommerceWorkflow.goingAccountSession(driver);
			LocoChannelConfigECommerceWorkflow.ChannelConfigurationECommerceWorkFlow(driver);
