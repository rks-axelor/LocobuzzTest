...
import com.test.java.utilities.LocoSocialSchedulingLinkedIN1Workflow;
...
public class LocoSocialSchedulingLinkedIN1Functionality {
	...
	public void SchedulingProcess(String user) throws Exception	 {
		...
		try {
			...
			LocoSocialSchedulingLinkedIN1Workflow.goingSocialSchedulingSection(driver);
			LocoSocialSchedulingLinkedIN1Workflow.SchedulingFunctionality(driver);
