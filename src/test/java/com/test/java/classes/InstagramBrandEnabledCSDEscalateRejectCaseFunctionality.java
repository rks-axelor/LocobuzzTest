...
import com.test.java.utilities.InstagramBrandEnabledCSDEscalateRejectCase;
...
public class InstagramBrandEnabledCSDEscalateRejectCaseFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			InstagramBrandEnabledCSDEscalateRejectCase.makeActionableProcess(driver, channel);
			InstagramBrandEnabledCSDEscalateRejectCase.ticketTabVerification(driver,channel);
			InstagramBrandEnabledCSDEscalateRejectCase.replyPostButton(driver,channel);
