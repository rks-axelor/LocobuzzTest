...
import com.test.java.utilities.LocoActNactTicketWorkflowProcess;
...
public class LocoActNactTicketSectionWorkflowFunctioinality {
	...
	@Test
	@Parameters({ "user" })
	public void ActNactFunction(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocoActNactTicketWorkflowProcess.goingAccountSession(driver);
			LocoActNactTicketWorkflowProcess.Actinablenonactionablefunctionality(driver);
