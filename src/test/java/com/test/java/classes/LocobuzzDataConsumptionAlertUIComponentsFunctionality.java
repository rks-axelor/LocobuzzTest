...
import com.test.java.utilities.LocobuzzDataConsumptionAlertUIComponents;
...
public class LocobuzzDataConsumptionAlertUIComponentsFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void DataConsumptionAlert(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			
			LocobuzzDataConsumptionAlertUIComponents.verifyingDataConsumptionAlertComponents(driver);
