...
import com.test.java.utilities.LocobuzzPriorityConfigurationWorkflow;
...
public class LocobuzzPriorityConfigurationWorkflowFunctionality {
	...
	public void PriorityConfiguration(String user,String priority) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzPriorityConfigurationWorkflow.goingAccountSession(driver);
			LocobuzzPriorityConfigurationWorkflow.priorityConfigurationProcess(driver,priority);
