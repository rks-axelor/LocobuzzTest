...
import com.test.java.utilities.LocobuzzCategoryMappingUIComponents;
...
public class LocobuzzCategoryMappingUIComponentsFunctionality {
	...
	public void CategoryMapping(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzCategoryMappingUIComponents.goingAccountSession(driver);
			LocobuzzCategoryMappingUIComponents.verifyingCategoryMappingComponents(driver);
