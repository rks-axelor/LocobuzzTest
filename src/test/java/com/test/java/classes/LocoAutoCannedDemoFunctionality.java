...
import com.test.java.utilities.LocoAutoCannedDemoWorkflowProcess;

import io.github.bonigarcia.wdm.WebDriverManager;

public class LocoAutoCannedDemoFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			LocoAutoCannedDemoWorkflowProcess.makeActionableProcess(driver, channel);
			LocoAutoCannedDemoWorkflowProcess.ticketTabVerification(driver,channel);
			LocoAutoCannedDemoWorkflowProcess.replyPostButton(driver,channel);
