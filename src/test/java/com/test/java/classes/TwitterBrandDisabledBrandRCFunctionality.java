...
import com.test.java.utilities.TwitterBrandDisabledBrandRCProcess;
...
public class TwitterBrandDisabledBrandRCFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			TwitterBrandDisabledBrandRCProcess.makeActionableProcess(driver, channel);
			TwitterBrandDisabledBrandRCProcess.ticketTabVerification(driver,channel);
			TwitterBrandDisabledBrandRCProcess.openDetailsButton(driver,channel);
