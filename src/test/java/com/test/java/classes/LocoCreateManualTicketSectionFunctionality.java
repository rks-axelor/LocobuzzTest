...
import com.test.java.utilities.LocoCreateManualTicketSectionWorkflow;
...
public class LocoCreateManualTicketSectionFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void CreateManualticketSection(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocoCreateManualTicketSectionWorkflow.goingAccountSession(driver);
			LocoCreateManualTicketSectionWorkflow.CreateManualticketTicketFunctionality(driver);
