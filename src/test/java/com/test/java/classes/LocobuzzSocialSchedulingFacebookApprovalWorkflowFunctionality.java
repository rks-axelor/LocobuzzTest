...
import com.test.java.utilities.LocobuzzSocialSchedulingFacebookApprovalWorkflow;
...
public class LocobuzzSocialSchedulingFacebookApprovalWorkflowFunctionality {
	...
	public void SocialScheduling(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzSocialSchedulingFacebookApprovalWorkflow.socialSchedulingFacebookApprobalWorkflow(driver);
