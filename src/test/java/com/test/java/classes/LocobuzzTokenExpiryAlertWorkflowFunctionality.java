...
import com.test.java.utilities.LocobuzzTokenExpiryAlertWorkflow;
...
public class LocobuzzTokenExpiryAlertWorkflowFunctionality {
	...
	public void TokenExpiryAlert(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzTokenExpiryAlertWorkflow.goingAccountSession(driver);
			LocobuzzTokenExpiryAlertWorkflow.tokenExpiryAlertProcess(driver);
