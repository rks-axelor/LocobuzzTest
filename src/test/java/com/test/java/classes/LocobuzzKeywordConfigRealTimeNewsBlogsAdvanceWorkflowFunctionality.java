...
import com.test.java.utilities.LocobuzzKeywordConfigRealTimeNewsBlogsAdvanceWorkflow;
...
public class LocobuzzKeywordConfigRealTimeNewsBlogsAdvanceWorkflowFunctionality {
	...
	public void KeywordConfiguration(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzKeywordConfigRealTimeNewsBlogsAdvanceWorkflow.goingAccountSession(driver);
			LocobuzzKeywordConfigRealTimeNewsBlogsAdvanceWorkflow.keywordConfigurationNewsBlogsProcess(driver);
