...
import com.test.java.utilities.LocoHolidayCalenderUIVerification;
import com.test.java.utilities.LocoPublishWatermarksUIVerification;
...
public class LocoHolidayCalenderUIFunctionality {
...
@Test
@Parameters({ "user" })
public void HolidayCalendar(String user) throws Exception	 {
try {
			
			CommonFunctions.login(driver, user);
			LocoHolidayCalenderUIVerification.goingAccountSession(driver);
			LocoHolidayCalenderUIVerification.VerifyingHolidayUIComponents(driver);
