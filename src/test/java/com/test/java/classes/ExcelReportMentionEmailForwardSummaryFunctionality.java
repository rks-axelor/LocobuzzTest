...
import com.test.java.utilities.ExcelReportMentionEmailForwardSummaryWorkflow;
...
public class ExcelReportMentionEmailForwardSummaryFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportMentionEmailForwardSummaryWorkflow.excelReportMentionEmailForwardSummaryTemplateWorkflow(driver);
