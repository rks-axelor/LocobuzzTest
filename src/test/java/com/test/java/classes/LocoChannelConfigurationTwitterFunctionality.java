...
import com.test.java.utilities.LocoChanneConfigurationTwitterWorkflow;
...
public class LocoChannelConfigurationTwitterFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void ChannelCofigurationTwitter(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocoChanneConfigurationTwitterWorkflow.goingAccountSession(driver);
			LocoChanneConfigurationTwitterWorkflow.ChannelConfigurationTwitterWorkFlow(driver);
