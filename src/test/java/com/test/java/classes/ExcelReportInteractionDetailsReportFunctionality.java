...
import com.test.java.utilities.ExcelReportInteractionDetailsReportWorkflow;
...
public class ExcelReportInteractionDetailsReportFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportInteractionDetailsReportWorkflow.excelReportInteractiondDetailsReportWorkflow(driver);
