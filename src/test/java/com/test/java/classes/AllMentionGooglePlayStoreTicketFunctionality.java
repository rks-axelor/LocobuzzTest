...
import com.test.java.utilities.AllMentionGooglePlayStoreWorkflowProcess;
...
public class AllMentionGooglePlayStoreTicketFunctionality {
	...
	public void allMentionsEmailTicketsFunctionality(String user, String channel) throws Exception {

		try {

			CommonFunctions.login(driver, user);
			AllMentionGooglePlayStoreWorkflowProcess.allMentionsWorkFlow(driver, channel);
