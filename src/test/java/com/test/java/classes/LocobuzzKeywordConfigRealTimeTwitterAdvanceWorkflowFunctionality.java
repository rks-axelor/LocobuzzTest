...
import com.test.java.utilities.LocobuzzKeywordConfigRealTimeTwitterAdvanceWorkflow;
...
public class LocobuzzKeywordConfigRealTimeTwitterAdvanceWorkflowFunctionality {
	...
	public void KeywordConfiguration(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzKeywordConfigRealTimeTwitterAdvanceWorkflow.goingAccountSession(driver);
			LocobuzzKeywordConfigRealTimeTwitterAdvanceWorkflow.keywordConfigurationTwitterProcess(driver);
