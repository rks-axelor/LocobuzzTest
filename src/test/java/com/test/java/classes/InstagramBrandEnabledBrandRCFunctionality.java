...
import com.test.java.utilities.InstagramBrandEnabledBrandRCProcess;
...
public class InstagramBrandEnabledBrandRCFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			InstagramBrandEnabledBrandRCProcess.makeActionableProcess(driver, channel);
			InstagramBrandEnabledBrandRCProcess.ticketTabVerification(driver,channel);
			InstagramBrandEnabledBrandRCProcess.openDetailsButton(driver,channel);
