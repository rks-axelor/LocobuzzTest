...
import com.test.java.utilities.ExcelReportTicketSummaryNewReportWorkflow;
...
public class ExcelReportTicketSummaryNewReportFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportTicketSummaryNewReportWorkflow.excelReportTicketSummaryNewReportWorkflow(driver);
