...
import com.test.java.utilities.LocobuzzQueueConfigAgentSettingsUIComponents;
...
public class LocobuzzQueueConfigAgentSettingsUIComponentsFunctionality {
	...
	public void QueueConfigurationAgentSetting(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzQueueConfigAgentSettingsUIComponents.goingAccountSession(driver);
			LocobuzzQueueConfigAgentSettingsUIComponents.verifyingQueueConfigurationAgentSettingsComponents(driver);
