...
import com.test.java.utilities.LocoSLABreachEmailWorkFlow;
...
public class LocoSLABreachEmailFunctionality {
	...
	public void SLAFacebookFunction(String user) throws Exception	 {
		...
		try {
			...
			LocoSLABreachEmailWorkFlow.goingAccountSession(driver);
			LocoSLABreachEmailWorkFlow.SLABreachEmailWorkflow(driver);
