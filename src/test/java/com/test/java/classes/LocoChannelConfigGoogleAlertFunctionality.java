...
import com.test.java.utilities.LocoChannelConfigGoogleAlertWorkFlow;
...
public class LocoChannelConfigGoogleAlertFunctionality {
	...
	public void ChannelCofigurationGoogleAlert(String user) throws Exception	 {
		...
		try {
			...
			LocoChannelConfigGoogleAlertWorkFlow.goingAccountSession(driver);
			LocoChannelConfigGoogleAlertWorkFlow.ChannelConfigurationGoogleAlertsWorkFlow(driver);
