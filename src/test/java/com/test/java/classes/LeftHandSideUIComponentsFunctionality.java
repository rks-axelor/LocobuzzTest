...
import com.test.java.utilities.LeftHandSideUIComponents;
...
public class LeftHandSideUIComponentsFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void LeftHandSideFunctionality(String user) throws Exception {

		try {
			CommonFunctions.login(driver, user);

			LeftHandSideUIComponents.verifyingLeftSideUIComponents(driver);
