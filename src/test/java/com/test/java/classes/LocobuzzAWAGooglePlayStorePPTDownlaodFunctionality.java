...
import com.test.java.utilities.LocobuzzAWAGooglePlayStorePPTDownload;
...
public class LocobuzzAWAGooglePlayStorePPTDownlaodFunctionality {
	...
	public void AWA(String user) throws Exception {
		...
		try {
			...
			LocobuzzAWAGooglePlayStorePPTDownload.pptDownloadNativeForGooglePlayStore(driver);
