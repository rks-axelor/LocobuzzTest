...
import com.test.java.utilities.ExcelReportMentionTicketWorkflowReportWorkflow;
...
public class ExcelReportMentionTicketWorkflowReportFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportMentionTicketWorkflowReportWorkflow.excelReportMentionTicketWorkflowReportTemplateWorkflow(driver);
