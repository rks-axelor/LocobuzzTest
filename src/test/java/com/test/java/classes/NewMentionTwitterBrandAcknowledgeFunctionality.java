...
import com.test.java.utilities.NewMentionTwitterBrandAcknowledgeProcess;
...
public class NewMentionTwitterBrandAcknowledgeFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionTwitterBrandAcknowledgeProcess.makeActionableProcess(driver, channel);
			NewMentionTwitterBrandAcknowledgeProcess.ticketTabVerification(driver,channel);
			NewMentionTwitterBrandAcknowledgeProcess.replyPostButton(driver,channel);
