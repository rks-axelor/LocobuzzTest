...
import com.test.java.utilities.LocobuzzEngagementFormulaUIComponents;
...
public class LocobuzzEngagementFormulaUIComponentsFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void EngagementFormula(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzEngagementFormulaUIComponents.goingAccountSession(driver);
			LocobuzzEngagementFormulaUIComponents.verifyingEngagementFormulaComponents(driver);
