...
import com.test.java.utilities.NewMentionFacebookProcessCreateTicketType;
...
public class NewMentionFacebookCreateTicketFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionFacebookProcessCreateTicketType.makeActionableProcess(driver, channel);
			NewMentionFacebookProcessCreateTicketType.ticketTabVerification(driver,channel);
			NewMentionFacebookProcessCreateTicketType.replyPostButton(driver,channel);
