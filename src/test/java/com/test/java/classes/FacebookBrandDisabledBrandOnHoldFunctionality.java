...
import com.test.java.utilities.FacebookBrandDisabledBrandOnHoldProcess;
...
public class FacebookBrandDisabledBrandOnHoldFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			FacebookBrandDisabledBrandOnHoldProcess.makeActionableProcess(driver, channel);
			FacebookBrandDisabledBrandOnHoldProcess.ticketTabVerification(driver,channel);
			FacebookBrandDisabledBrandOnHoldProcess.replyPostButton(driver,channel);
