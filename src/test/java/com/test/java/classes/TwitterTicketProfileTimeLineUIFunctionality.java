...
import com.test.java.utilities.TwitterTicketProfileTimeLineUI;
...
public class TwitterTicketProfileTimeLineUIFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			TwitterTicketProfileTimeLineUI.GotoTicketTab(driver, channel);
			TwitterTicketProfileTimeLineUI.ticketTabVerification(driver,channel);
			TwitterTicketProfileTimeLineUI.profileDetails(driver,channel);
