...
import com.test.java.utilities.TwitterBrandEnabledBrandRCProcess;
...
public class TwitterBrandEnabledBrandRCFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			TwitterBrandEnabledBrandRCProcess.makeActionableProcess(driver, channel);
			TwitterBrandEnabledBrandRCProcess.ticketTabVerification(driver,channel);
			TwitterBrandEnabledBrandRCProcess.openDetailsButton(driver,channel);
