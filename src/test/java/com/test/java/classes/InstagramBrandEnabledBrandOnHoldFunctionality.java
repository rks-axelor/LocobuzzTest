...
import com.test.java.utilities.InstagramBrandEnabledBrandOnHoldProcess;
...
public class InstagramBrandEnabledBrandOnHoldFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			InstagramBrandEnabledBrandOnHoldProcess.makeActionableProcess(driver, channel);
			InstagramBrandEnabledBrandOnHoldProcess.ticketTabVerification(driver,channel);
			InstagramBrandEnabledBrandOnHoldProcess.replyPostButton(driver,channel);
