...
import com.test.java.utilities.AllMentionInstagramWorkflowProcess;
...
public class AllMentionsInstagramTicketFunctionality {
  ...
  public void allMentionsinstagramTicketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			AllMentionInstagramWorkflowProcess.allMentionsWorkFlow(driver, channel);
