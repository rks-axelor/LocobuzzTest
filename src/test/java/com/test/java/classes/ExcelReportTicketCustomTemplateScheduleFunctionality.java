...
import com.test.java.utilities.ExcelReportTicketCustomTemplateScheduledWorkflow;
...
public class ExcelReportTicketCustomTemplateScheduleFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportTicketCustomTemplateScheduledWorkflow.excelReportTicketCustomTemplateScheduledWorkflow(driver);
