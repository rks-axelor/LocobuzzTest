...
import com.test.java.utilities.FacebookBrandEnabledBrandRCProcess;
...
public class FacebookBrandEnabledBrandRCFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			FacebookBrandEnabledBrandRCProcess.makeActionableProcess(driver, channel);
			FacebookBrandEnabledBrandRCProcess.ticketTabVerification(driver,channel);
			FacebookBrandEnabledBrandRCProcess.openDetailsButton(driver,channel);
