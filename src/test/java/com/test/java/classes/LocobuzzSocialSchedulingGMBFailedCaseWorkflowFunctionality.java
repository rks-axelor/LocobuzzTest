...
import com.test.java.utilities.LocobuzzSocialSchedulingGMBFailedCaseWorkflow;
...
public class LocobuzzSocialSchedulingGMBFailedCaseWorkflowFunctionality {
	...
	public void SocialScheduling(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzSocialSchedulingGMBFailedCaseWorkflow.socialSchedulingGMBFailedCaseWorkflow(driver);
