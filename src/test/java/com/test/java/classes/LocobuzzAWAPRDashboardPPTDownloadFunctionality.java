...
import com.test.java.utilities.LocobuzzAWAPRDashboardPPTDownloadWorkflow;
...
public class LocobuzzAWAPRDashboardPPTDownloadFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAPRDashboardPPTDownloadWorkflow.pptDownloadNativeForPRDashboard(driver);
