...
import com.test.java.utilities.TwitterOldTicketWorkflowProcess;
...
public class TwitterOldTicketWorkflowFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			TwitterOldTicketWorkflowProcess.makeProcess(driver, channel);
			TwitterOldTicketWorkflowProcess.ticketTabVerification(driver,channel);
			TwitterOldTicketWorkflowProcess.replyPostButton(driver,channel);
