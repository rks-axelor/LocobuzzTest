...
import com.test.java.utilities.LocoPersonalDetailsSettingsUIVerification;
...
public class LocoPersonalDetailsUIFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void PersonalDetailsSettingsUIVerification(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocoPersonalDetailsSettingsUIVerification.goingAccountSession(driver);
			LocoPersonalDetailsSettingsUIVerification.PersonalDetailsSettingsUIVerification(driver);
