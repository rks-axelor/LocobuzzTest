...
import com.test.java.utilities.LocochannelconfigBookingsWorkflow;
...
public class LocochannelconfigBookingsfunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void ChannelCofigurationGoogleAlert(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocochannelconfigBookingsWorkflow.goingAccountSession(driver);
			LocochannelconfigBookingsWorkflow.ChannelConfigurationBookingsWorkFlow(driver);
