...
import com.test.java.utilities.LocobuzzDataConsumptionDashboardWorkflow;
...
public class LocobuzzDataConsumptionDashboardWorkflowFunctionality {
	...
	public void DataConsumptionDashboard(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzDataConsumptionDashboardWorkflow.dataConsumptionDashboardProcess(driver);
