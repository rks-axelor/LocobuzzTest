...
import com.test.java.utilities.LocobuzzQueueConfigurationUIComponents;
...
public class LocobuzzQueueConfigurationUIComponentsFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void QueueConfiguration(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzQueueConfigurationUIComponents.goingAccountSession(driver);
			LocobuzzQueueConfigurationUIComponents.verifyingQueueConfigurationComponents(driver);
