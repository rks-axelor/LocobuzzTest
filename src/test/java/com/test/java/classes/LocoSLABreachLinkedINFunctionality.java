...
import com.test.java.utilities.LocoSLABreachLinkedINWorkflow;
...
public class LocoSLABreachLinkedINFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void SLALinkedINFunction(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocoSLABreachLinkedINWorkflow.goingAccountSession(driver);
			LocoSLABreachLinkedINWorkflow.SLABreachLinkedINWorkflow(driver);
