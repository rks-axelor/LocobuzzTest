...
import com.test.java.utilities.LocoSocialSchedulingLinkedIN2Workflow;
...
public class LocoSocialSchedulingLinkedIN2Functionality {
	...
	public void SchedulingProcess(String user) throws Exception	 {
		...
		try {
			...
			LocoSocialSchedulingLinkedIN2Workflow.goingSocialSchedulingSection(driver);
			LocoSocialSchedulingLinkedIN2Workflow.SchedulingFunctionality(driver);
