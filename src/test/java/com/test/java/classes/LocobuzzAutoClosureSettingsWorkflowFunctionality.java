...
import com.test.java.utilities.LocobuzzAutoClosureSettingsWorkflow;
...
public class LocobuzzAutoClosureSettingsWorkflowFunctionality {
	...
	public void AutoClosureSettings(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAutoClosureSettingsWorkflow.goingAccountSession(driver);
			LocobuzzAutoClosureSettingsWorkflow.autoClosureSettingsProcess(driver);
