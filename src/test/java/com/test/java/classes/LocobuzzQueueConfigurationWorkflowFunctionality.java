...
import com.test.java.utilities.LocobuzzQueueConfigurationWorkflow;
...
public class LocobuzzQueueConfigurationWorkflowFunctionality {
	...
	public void QueueConfiguration(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzQueueConfigurationWorkflow.goingAccountSession(driver);
			LocobuzzQueueConfigurationWorkflow.queueConfigurationProcess(driver);
