...
import com.test.java.utilities.LocoAutoCannedResponseInstaHoldWorkflow;
...
public class LocoAutoCannedResponseInstaholdFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			LocoAutoCannedResponseInstaHoldWorkflow.makeActionableProcess(driver, channel);
			LocoAutoCannedResponseInstaHoldWorkflow.ticketTabVerification(driver, channel);
			LocoAutoCannedResponseInstaHoldWorkflow.automatedcannedresponseprocess(driver, channel);
