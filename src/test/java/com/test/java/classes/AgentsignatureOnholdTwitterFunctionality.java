...
import com.test.java.utilities.AgentsignatureTwitteronholdticketworkprocess;
...
public class AgentsignatureOnholdTwitterFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			AgentsignatureTwitteronholdticketworkprocess.makeActionableProcess(driver, channel);
			AgentsignatureTwitteronholdticketworkprocess.ticketTabVerification(driver, channel);
			AgentsignatureTwitteronholdticketworkprocess.replyPostButton(driver, channel);
