...
import com.test.java.utilities.LocobuzzManageUserWorkflowForTeamLeader;
...
public class LocobuzzManageUserWorkflowForTeamLeaderFunctionality {
	...
	public void ManageUser(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzManageUserWorkflowForTeamLeader.manageUserWorkflow(driver);
