...
import com.test.java.utilities.OpenDetailsEmailTicketWorkflowProcess;
...
public class OpenDetailsEmailTicketFunctionality {
	...
	public void login(String user, String channel) throws Exception {
		...
		try {
			...
			OpenDetailsEmailTicketWorkflowProcess.openDetailsTicketsInformation(driver,channel);
			OpenDetailsEmailTicketWorkflowProcess.openDetailsButton(driver, channel);
