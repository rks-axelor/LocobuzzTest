...
import com.test.java.utilities.FacebookBrandEnabledCSDEscalate;
...
public class FacebookBrandEnabledCSDEscalateFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			FacebookBrandEnabledCSDEscalate.makeActionableProcess(driver, channel);
			FacebookBrandEnabledCSDEscalate.ticketTabVerification(driver,channel);
			FacebookBrandEnabledCSDEscalate.replyPostButton(driver,channel);
