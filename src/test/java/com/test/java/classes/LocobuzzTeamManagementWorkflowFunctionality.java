...
import com.test.java.utilities.LocobuzzTeamManagementWorkflow;
...
public class LocobuzzTeamManagementWorkflowFunctionality {
	...
	public void TeamManagement(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzTeamManagementWorkflow.goingAccountSession(driver);
			LocobuzzTeamManagementWorkflow.teamManagementProcess(driver);
