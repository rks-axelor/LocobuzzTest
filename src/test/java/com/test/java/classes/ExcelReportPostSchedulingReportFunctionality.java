...
import com.test.java.utilities.ExcelReportPostSchedulingReportWorkflow;
...
public class ExcelReportPostSchedulingReportFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportPostSchedulingReportWorkflow.excelReportPostSchedulingReportTemplateWorkflow(driver);
