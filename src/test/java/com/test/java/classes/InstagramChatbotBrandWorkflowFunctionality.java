...
import com.test.java.utilities.InstagramChatbotBrandWorkflowProcess;
...
public class InstagramChatbotBrandWorkflowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			InstagramChatbotBrandWorkflowProcess.assignProcess(driver, channel);
			InstagramChatbotBrandWorkflowProcess.agentChatbotTicketProcess(driver, channel);
