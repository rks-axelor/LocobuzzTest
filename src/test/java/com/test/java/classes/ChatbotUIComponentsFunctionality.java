...
import com.test.java.utilities.ChatbotUIComponents;
...
public class ChatbotUIComponentsFunctionality {
	...
	public void login(String user,String channel) throws Exception	 {
		...
		try {
			...
			ChatbotUIComponents.assignProcess(driver, channel);
			ChatbotUIComponents.agentChatbotUIComponents(driver, channel);
