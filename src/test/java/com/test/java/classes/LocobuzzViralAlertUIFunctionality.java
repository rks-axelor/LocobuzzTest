...
import com.test.java.utilities.LocobuzzViralAlertUIVerificationProcess;
...
public class LocobuzzViralAlertUIFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void LocobViralAlertUIVeri(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzViralAlertUIVerificationProcess.goingAccountSession(driver);
			LocobuzzViralAlertUIVerificationProcess.LocobuzzViralAlertUIVerification(driver);
