...
import com.test.java.utilities.OpenDetailsTwitterBrandEnabledBrandRCProcess;
...
public class OpenDetailsTwitterBrandEnabledBrandRCFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			OpenDetailsTwitterBrandEnabledBrandRCProcess.makeActionableProcess(driver, channel);
			OpenDetailsTwitterBrandEnabledBrandRCProcess.ticketTabVerification(driver,channel);
			OpenDetailsTwitterBrandEnabledBrandRCProcess.openDetailsButton(driver,channel);
