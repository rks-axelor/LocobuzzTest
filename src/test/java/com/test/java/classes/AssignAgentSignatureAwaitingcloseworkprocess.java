...
import com.test.java.utilities.AssignAgentSignatureAwaitingcloseworkprocessclass;
...
public class AssignAgentSignatureAwaitingcloseworkprocess {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			AssignAgentSignatureAwaitingcloseworkprocessclass.makeActionableProcess(driver, channel);
			
			AssignAgentSignatureAwaitingcloseworkprocessclass.agentTicketProcess(driver, channel);
