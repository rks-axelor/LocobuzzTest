...
import com.test.java.utilities.LocobuzzSocialSchedulingFacebookFailedCaseWorkflow;
...
public class LocobuzzSocialSchedulingFacebookFailedCaseWorkflowFunctionality {
	...
	public void SocialScheduling(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzSocialSchedulingFacebookFailedCaseWorkflow.socialSchedulingFacebookFailedCaseWorkflow(driver);
