...
import com.test.java.utilities.LocoSocSchedulingAwaitingTWWorkkflow;
...
public class LocoSocSchedulingAwaitingTWFunctionality {
	...
	public void SchedulingProcess(String user) throws Exception	 {
		...
		try {
			...
			LocoSocSchedulingAwaitingTWWorkkflow.goingSocialSchedulingSection(driver);
			LocoSocSchedulingAwaitingTWWorkkflow.SchedulingFunctionality(driver);
