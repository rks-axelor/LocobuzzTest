...
import com.test.java.utilities.LocobuzzSocialSchedulingFacebookWorkflow;
import com.test.java.utilities.LocobuzzSocialSchedulingUIComponents;
...
public class LocobuzzSocialSchedulingFacebookWorkflowFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void SocialScheduling(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzSocialSchedulingFacebookWorkflow.socialSchedulingFacebookWorkflow(driver);
