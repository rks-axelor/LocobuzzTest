...
import com.test.java.utilities.LocobuzzAWAFacebookPPTDownloadWorkflow;
...
public class LocobuzzAWAFacebookPPTDownloadFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAFacebookPPTDownloadWorkflow.pptDownloadNativeForFacebook(driver);
