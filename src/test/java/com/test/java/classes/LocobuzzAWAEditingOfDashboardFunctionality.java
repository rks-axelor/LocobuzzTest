...
import com.test.java.utilities.LocobuzzAWAEditingOfDashboardWorkflow;
...
public class LocobuzzAWAEditingOfDashboardFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAEditingOfDashboardWorkflow.LoginFunctionality(driver,user);
			LocobuzzAWAEditingOfDashboardWorkflow.editingOfDashboard(driver);
			LocobuzzAWAEditingOfDashboardWorkflow.logout(driver);
