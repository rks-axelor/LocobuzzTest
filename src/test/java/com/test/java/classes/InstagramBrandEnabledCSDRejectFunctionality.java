...
import com.test.java.utilities.InstagramBrandEnabledCSDReject;
...
public class InstagramBrandEnabledCSDRejectFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			InstagramBrandEnabledCSDReject.makeActionableProcess(driver, channel);
			InstagramBrandEnabledCSDReject.ticketTabVerification(driver,channel);
			InstagramBrandEnabledCSDReject.replyPostButton(driver,channel);
