...
import com.test.java.utilities.AlertSignatureWorkProcess;
import com.test.java.utilities.CommonFunctions;
import com.test.java.utilities.LocobuzzLanguageFilterWorkProcess;
...
import org.testng.ITestContext;
import org.testng.annotations.AfterTest;
public class LocobuzzAlertSignaturefunctionality {
  ...
  @Test
  @Parameters({ "user" })
  public void AlertSignature(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			AlertSignatureWorkProcess.goingAccountSession(driver);
			AlertSignatureWorkProcess.VerifyingUIComponentsProcess(driver);
