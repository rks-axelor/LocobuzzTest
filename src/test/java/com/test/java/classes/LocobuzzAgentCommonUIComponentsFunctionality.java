...
import com.test.java.utilities.LocobuzzAgentCommonUIComponents;
...
public class LocobuzzAgentCommonUIComponentsFunctionality {
	...
	public void login(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAgentCommonUIComponents.verifyingCommonUIComponents(driver);
			LocobuzzAgentCommonUIComponents.locobuzzTabs(driver);
