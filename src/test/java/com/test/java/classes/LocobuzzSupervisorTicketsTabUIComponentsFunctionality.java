...
import com.test.java.utilities.LocobuzzSupervisorTicketsTabUIComponents;
...
public class LocobuzzSupervisorTicketsTabUIComponentsFunctionality {
	...
	public void login(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzSupervisorTicketsTabUIComponents.verifyingTicketTabUIComponents(driver);
