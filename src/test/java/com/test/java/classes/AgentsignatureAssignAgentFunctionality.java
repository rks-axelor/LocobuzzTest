...
import com.test.java.utilities.AgentSignatureAssignAgentWorkflowProcess;
...
public class AgentsignatureAssignAgentFunctionality {
	public static WebDriver driver;
	public String testName, className, dateTime, status,ticketIDValue,replyType;
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			AgentSignatureAssignAgentWorkflowProcess.makeActionableProcess(driver, channel);
			
			AgentSignatureAssignAgentWorkflowProcess.agentTicketProcess(driver, channel);
			//AgentSignatureAssignAgentWorkflowProcess.Ticketapprovalprocess(driver,ticketIDValue,channel);
