...
import com.test.java.utilities.LocobuzzKeywordConfigRealTimeYoutubeWorkflow;
...
public class LocobuzzKeywordConfigRealTimeYoutubeWorkflowFunctionality {
	...
	public void KeywordConfiguration(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzKeywordConfigRealTimeYoutubeWorkflow.goingAccountSession(driver);
			LocobuzzKeywordConfigRealTimeYoutubeWorkflow.keywordConfigurationYoutubeProcess(driver);
