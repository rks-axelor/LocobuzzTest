...
import com.test.java.utilities.LocobuzzTeamManagementUIComponents;
...
public class LocobuzzTeamManagementUIComponentsFunctionality {
	...
	public void TeamManagement(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzTeamManagementUIComponents.goingAccountSession(driver);
			LocobuzzTeamManagementUIComponents.verifyingTeamManagementComponents(driver);
