...
import com.test.java.utilities.OpenDetailsTwitterCannedResponseTicketFlowProcess;
...
public class OpenDetailsTwitterCannedResponseTicketFlowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			OpenDetailsTwitterCannedResponseTicketFlowProcess.makeActionableProcess(driver, channel);
			OpenDetailsTwitterCannedResponseTicketFlowProcess.ticketTabVerification(driver, channel);
			OpenDetailsTwitterCannedResponseTicketFlowProcess.openDetailsButton(driver, channel);
