...
import com.test.java.utilities.InstagramCannedResponseTicketFlow;
...
public class InstagramCannedResponseTicketFlowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			InstagramCannedResponseTicketFlow.makeActionableProcess(driver, channel);
			InstagramCannedResponseTicketFlow.ticketTabVerification(driver, channel);
			InstagramCannedResponseTicketFlow.replyPostButton(driver, channel);
