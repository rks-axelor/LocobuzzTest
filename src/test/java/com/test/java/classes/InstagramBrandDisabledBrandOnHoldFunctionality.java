...
import com.test.java.utilities.InstagramBrandDisabledBrandOnHoldProcess;
...
public class InstagramBrandDisabledBrandOnHoldFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			InstagramBrandDisabledBrandOnHoldProcess.makeActionableProcess(driver, channel);
			InstagramBrandDisabledBrandOnHoldProcess.ticketTabVerification(driver,channel);
			InstagramBrandDisabledBrandOnHoldProcess.replyPostButton(driver,channel);
