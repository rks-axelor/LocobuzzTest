...
import com.test.java.utilities.GMBReviewsTicketWorkflowProcess;
...
public class GMBReviewsTicketWorkflowFunctionality {
	...
	public void allMentionsGMBReviewTicketsFunctionality(String user, String channel) throws Exception {

		try {

			CommonFunctions.login(driver, user);

			GMBReviewsTicketWorkflowProcess.makeActionableProcess(driver, channel);
			GMBReviewsTicketWorkflowProcess.ticketTabVerification(driver, channel);
			GMBReviewsTicketWorkflowProcess.replyPostButton(driver, channel);
