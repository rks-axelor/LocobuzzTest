...
import com.test.java.utilities.LocoChannelConfgLinkedINYoutubeWorkflow;
...
public class LocoChannelConfgLinkedINYoutubeFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void ChannelCofigurationYoutubeLinkedIN(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocoChannelConfgLinkedINYoutubeWorkflow.goingAccountSession(driver);
			LocoChannelConfgLinkedINYoutubeWorkflow.ChannelConfigLinkedINYoutubeaWorkFlow(driver);
