...
import com.test.java.utilities.LocobuzzKeywordConfigRealTimeNewBlogsWorkflow;
...
public class LocobuzzKeywordConfigRealTimeNewBlogsWorkflowFunctionality {
	...
	public void KeywordConfiguration(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzKeywordConfigRealTimeNewBlogsWorkflow.goingAccountSession(driver);
			LocobuzzKeywordConfigRealTimeNewBlogsWorkflow.keywordConfigurationNewsBlogsProcess(driver);
