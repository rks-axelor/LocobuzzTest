...
import com.test.java.utilities.LocobuzzAWAPPTDownloadForNativeWorkflow;
...
public class LocobuzzAWAPPTDownloadForNativeFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAPPTDownloadForNativeWorkflow.LoginFunctionality(driver,user);
			LocobuzzAWAPPTDownloadForNativeWorkflow.pptDownloadNative(driver);
			LocobuzzAWAPPTDownloadForNativeWorkflow.logout(driver);
