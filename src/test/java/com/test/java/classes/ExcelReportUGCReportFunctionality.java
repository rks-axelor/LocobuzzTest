...
import com.test.java.utilities.ExcelReportUGCReportWorkflow;
...
public class ExcelReportUGCReportFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportUGCReportWorkflow.excelReportUGCReportTemplateWorkflow(driver);
