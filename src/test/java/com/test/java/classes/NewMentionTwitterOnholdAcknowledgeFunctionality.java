...
import com.test.java.utilities.NewMentionTwitterOnholdAcknowledgeProcess;
...
public class NewMentionTwitterOnholdAcknowledgeFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionTwitterOnholdAcknowledgeProcess.makeActionableProcess(driver, channel);
			NewMentionTwitterOnholdAcknowledgeProcess.ticketTabVerification(driver,channel);
			NewMentionTwitterOnholdAcknowledgeProcess.replyPostButton(driver,channel);
