...
import com.test.java.utilities.WhatsAppChatbotCannedResponse;
...
public class WhatsappChatbotCannedResponsefunctionality
{
	  ...
	  @Parameters({ "user", "channel" })
		public void ticketsFunctionality(String user, String channel) throws Exception {
			...
			try {
				...
				WhatsAppChatbotCannedResponse.assignProcess(driver, channel);
				//WhatsappChatbotCannedresponse.agentChatbotTicketProcess(driver, channel);
