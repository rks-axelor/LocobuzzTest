...
import com.test.java.utilities.InstagramBrandEnabledBrandRejectProcess;
...
public class InstagramBrandEnabledBrandRejectFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			InstagramBrandEnabledBrandRejectProcess.makeActionableProcess(driver, channel);
			InstagramBrandEnabledBrandRejectProcess.ticketTabVerification(driver,channel);
			InstagramBrandEnabledBrandRejectProcess.replyPostButton(driver,channel);
