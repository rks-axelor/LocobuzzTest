...
import com.test.java.utilities.NewMentionTwitterEscalateCreateTicketProcess;
...
public class NewMentionTwitterEscalateCreateTicketFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionTwitterEscalateCreateTicketProcess.makeActionableProcess(driver, channel);
			NewMentionTwitterEscalateCreateTicketProcess.ticketTabVerification(driver,channel);
			NewMentionTwitterEscalateCreateTicketProcess.moreButton(driver,channel);
