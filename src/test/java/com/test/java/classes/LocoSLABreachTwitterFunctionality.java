...
import com.test.java.utilities.LocoSLABreachTwitterWorkflow;
...
public class LocoSLABreachTwitterFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void SLATwitterFunction(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocoSLABreachTwitterWorkflow.goingAccountSession(driver);
			LocoSLABreachTwitterWorkflow.SLABreachTwitterWorkflow(driver);
