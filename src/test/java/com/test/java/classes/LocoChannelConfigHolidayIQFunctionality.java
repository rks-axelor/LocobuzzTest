...
import com.test.java.utilities.LocoChannelConfigHolidayIQWorkflow;
...
public class LocoChannelConfigHolidayIQFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void ChannelCofigurationHolidayIQ(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocoChannelConfigHolidayIQWorkflow.goingAccountSession(driver);
			LocoChannelConfigHolidayIQWorkflow.ChannelConfigurationHolidayIQWorkFlow(driver);
