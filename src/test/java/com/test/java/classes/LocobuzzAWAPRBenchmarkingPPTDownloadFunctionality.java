...
import com.test.java.utilities.LocobuzzAWAPRBenchmarkingPPTDownloadWorkflow;
...
public class LocobuzzAWAPRBenchmarkingPPTDownloadFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAPRBenchmarkingPPTDownloadWorkflow.pptDownloadNativeForPRBenchmarking(driver);
