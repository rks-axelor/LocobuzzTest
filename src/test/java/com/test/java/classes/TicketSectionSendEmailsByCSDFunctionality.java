...
import com.test.java.utilities.TicketSectionSendEmailsByCSD;
...
public class TicketSectionSendEmailsByCSDFunctionality {
	...
	public void EmailsSendByCSD(String user,String channel) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			TicketSectionSendEmailsByCSD.makeActionableProcess(driver, channel);
			TicketSectionSendEmailsByCSD.ticketTabVerification(driver, channel);
			TicketSectionSendEmailsByCSD.replyPostButton(driver, channel);
