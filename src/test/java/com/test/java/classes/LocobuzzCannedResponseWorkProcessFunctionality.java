...
import com.test.java.utilities.LocobuzzCannedResponseWorkProcess;
...
public class LocobuzzCannedResponseWorkProcessFunctionality {
	...
	public void CannedResponse(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzCannedResponseWorkProcess.goingAccountSession(driver);
			LocobuzzCannedResponseWorkProcess.cannedResponseProcess(driver);
