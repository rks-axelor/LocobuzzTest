...
import com.test.java.utilities.LocobuzzSupervisorAllMentionsUIComponents;
...
public class LocobuzzSupervisorAllMentionsTabUIComponentsFunctionality {
	...
	public void login(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzSupervisorAllMentionsUIComponents.verifyingAllMentionsTabUIComponents(driver);
