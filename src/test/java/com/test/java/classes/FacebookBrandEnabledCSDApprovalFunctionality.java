...
import com.test.java.utilities.FacebookBrandEnabledCSDApproval;
...
public class FacebookBrandEnabledCSDApprovalFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			FacebookBrandEnabledCSDApproval.makeActionableProcess(driver, channel);
			FacebookBrandEnabledCSDApproval.ticketTabVerification(driver,channel);
			FacebookBrandEnabledCSDApproval.replyPostButton(driver,channel);
