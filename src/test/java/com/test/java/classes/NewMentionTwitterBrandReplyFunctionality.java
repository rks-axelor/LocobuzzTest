...
import com.test.java.utilities.NewMentionTwitterBrandReplyProcess;
...
public class NewMentionTwitterBrandReplyFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionTwitterBrandReplyProcess.makeActionableProcess(driver, channel);
			NewMentionTwitterBrandReplyProcess.ticketTabVerification(driver,channel);
			NewMentionTwitterBrandReplyProcess.replyPostButton(driver,channel);
