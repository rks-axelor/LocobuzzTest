...
import com.test.java.utilities.LocobuzzAWALinkedinPPTDownloadWorkflow;
...
public class LocobuzzAWALinkedinPPTDownloadFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWALinkedinPPTDownloadWorkflow.pptDownloadNativeForLinkedin(driver);
