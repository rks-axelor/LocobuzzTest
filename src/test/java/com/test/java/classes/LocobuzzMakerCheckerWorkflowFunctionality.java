...
import com.test.java.utilities.LocobuzzMakerCheckerUIComponents;
import com.test.java.utilities.LocobuzzMakerCheckerWorkflow;
...
public class LocobuzzMakerCheckerWorkflowFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void MakerChecker(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzMakerCheckerWorkflow.goingAccountSession(driver);
			LocobuzzMakerCheckerWorkflow.makerCheckerProcess(driver);
