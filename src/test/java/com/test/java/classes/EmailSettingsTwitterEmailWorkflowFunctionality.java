...
import com.test.java.utilities.EmailSettingsTwitterEmailWorkflow;
...
public class EmailSettingsTwitterEmailWorkflowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			EmailSettingsTwitterEmailWorkflow.emailProcess(driver, channel);
