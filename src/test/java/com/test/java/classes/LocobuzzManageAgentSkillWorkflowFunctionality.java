...
import com.test.java.utilities.LocobuzzManageAgentSkillsWorkflow;
...
public class LocobuzzManageAgentSkillWorkflowFunctionality {
	...
	public void ManageAgentSkills(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzManageAgentSkillsWorkflow.goingAccountSession(driver);
			LocobuzzManageAgentSkillsWorkflow.manageAgentSkillsProcess(driver);
