...
import com.test.java.utilities.NewMentionFacebookEscalateReplyProcess;
...
public class NewMentionFacebookEscalateReplyFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionFacebookEscalateReplyProcess.makeActionableProcess(driver, channel);
			NewMentionFacebookEscalateReplyProcess.ticketTabVerification(driver,channel);
			NewMentionFacebookEscalateReplyProcess.moreButton(driver,channel);
