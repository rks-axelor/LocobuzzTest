...
import com.test.java.utilities.ExcelReportMentionHistoricDataWorkflow;
...
public class ExcelReportMentionHistoricDataFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportMentionHistoricDataWorkflow.excelReportMentionHistoricDataTemplateWorkflow(driver);
