...
import com.test.java.utilities.LocobuzzKeywordConfigRealTimeFacebookWorkflow;
...
public class LocobuzzKeywordConfigRealTimeFacebookWorkflowFunctionality {
	...
	public void KeywordConfiguration(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzKeywordConfigRealTimeFacebookWorkflow.goingAccountSession(driver);
			LocobuzzKeywordConfigRealTimeFacebookWorkflow.keywordConfigurationFacebookProcess(driver);
