...
public class LocobuzzLanguageFilterUIComponentsFunctionality {
	...
	public void LanguageFilter(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzLanguageFilterUIComponents.goingAccountSession(driver);
			LocobuzzLanguageFilterUIComponents.verifyingLanguageFilterComponents(driver);
