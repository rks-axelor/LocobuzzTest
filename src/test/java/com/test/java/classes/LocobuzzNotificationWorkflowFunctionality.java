...
import com.test.java.utilities.LocobuzzNotificationWorkflow;
...
public class LocobuzzNotificationWorkflowFunctionality {
	...
	public void Notification(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzNotificationWorkflow.goingAccountSession(driver);
			LocobuzzNotificationWorkflow.notificationProcess(driver);
