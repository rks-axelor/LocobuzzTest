...
import com.test.java.utilities.GooglePlayStoreTicketWorkflowProcess;
...
public class GooglePlayStoreTicketWorkflowFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			GooglePlayStoreTicketWorkflowProcess.makeActionableProcess(driver, channel);
			GooglePlayStoreTicketWorkflowProcess.ticketTabVerification(driver,channel);
			GooglePlayStoreTicketWorkflowProcess.replyPostButton(driver,channel);
