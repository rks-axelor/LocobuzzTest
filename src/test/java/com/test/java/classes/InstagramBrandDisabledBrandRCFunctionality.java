...
import com.test.java.utilities.InstagramBrandDisabledBrandRCProcess;
...
public class InstagramBrandDisabledBrandRCFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			InstagramBrandDisabledBrandRCProcess.makeActionableProcess(driver, channel);
			InstagramBrandDisabledBrandRCProcess.ticketTabVerification(driver,channel);
			InstagramBrandDisabledBrandRCProcess.openDetailsButton(driver,channel);
