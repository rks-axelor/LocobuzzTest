...
import com.test.java.utilities.LocobuzzNPSFeedbackUIVerificationProcess;
...
public class LocobuzzNPSFeedbackUIFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void LocobuzzNPSFeedbackUIVerification(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzNPSFeedbackUIVerificationProcess.goingAccountSession(driver);
			LocobuzzNPSFeedbackUIVerificationProcess.NPSFeedbackUIVerification(driver);
