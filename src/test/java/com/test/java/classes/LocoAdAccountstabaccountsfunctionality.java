...
import com.test.java.utilities.LocoAdAccountstabaccountsVerification;
...
public class LocoAdAccountstabaccountsfunctionality {
	...
	public void ChannelCofiguration(String user) throws Exception	 {
		...
		try {
			...
			LocoAdAccountstabaccountsVerification.goingAccountSession(driver);
			LocoAdAccountstabaccountsVerification.verifyingChannelConfigAdaccountsFunction(driver);
