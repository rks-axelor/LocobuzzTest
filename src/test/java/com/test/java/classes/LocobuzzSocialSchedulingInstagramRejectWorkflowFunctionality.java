...
import com.test.java.utilities.LocobuzzSocialSchedulingInstagramRejectWorkflow;
...
public class LocobuzzSocialSchedulingInstagramRejectWorkflowFunctionality {
	...
	public void SocialScheduling(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzSocialSchedulingInstagramRejectWorkflow.socialSchedulingInstagramRejectWorkflow(driver);
