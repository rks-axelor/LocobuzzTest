...
import com.test.java.utilities.NewMentionFacebookEscalateCreateTicketProcess;
...
public class NewMentionFacebookEscalateCreateTicketFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionFacebookEscalateCreateTicketProcess.makeActionableProcess(driver, channel);
			NewMentionFacebookEscalateCreateTicketProcess.ticketTabVerification(driver,channel);
			NewMentionFacebookEscalateCreateTicketProcess.moreButton(driver,channel);
