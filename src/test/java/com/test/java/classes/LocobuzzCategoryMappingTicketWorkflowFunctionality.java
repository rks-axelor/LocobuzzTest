...
import com.test.java.utilities.LocobuzzCategoryMappingTicketWorkflow;
...
public class LocobuzzCategoryMappingTicketWorkflowFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void CategoryMapping(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzCategoryMappingTicketWorkflow.goingAccountSession(driver);
			LocobuzzCategoryMappingTicketWorkflow.categoryMappingTicketWorkflow(driver);
