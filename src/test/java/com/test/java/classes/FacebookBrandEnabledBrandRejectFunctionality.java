...
import com.test.java.utilities.FacebookBrandEnabledBrandRejectProcess;
...
public class FacebookBrandEnabledBrandRejectFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			FacebookBrandEnabledBrandRejectProcess.makeActionableProcess(driver, channel);
			FacebookBrandEnabledBrandRejectProcess.ticketTabVerification(driver,channel);
			FacebookBrandEnabledBrandRejectProcess.replyPostButton(driver,channel);
