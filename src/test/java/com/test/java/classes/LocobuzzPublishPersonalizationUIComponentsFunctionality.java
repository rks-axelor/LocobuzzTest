...
import com.test.java.utilities.LocobuzzPublishPersonalizationUIComponents;
...
public class LocobuzzPublishPersonalizationUIComponentsFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void PublishPersonalization(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzPublishPersonalizationUIComponents.goingAccountSession(driver);
			LocobuzzPublishPersonalizationUIComponents.verifyingPublishPersonalizationComponents(driver);
