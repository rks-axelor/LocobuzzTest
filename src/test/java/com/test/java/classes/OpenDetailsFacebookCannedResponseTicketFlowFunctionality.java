...
import com.test.java.utilities.OpenDetailsFacebookCannedResponseTicketFlow;
...
public class OpenDetailsFacebookCannedResponseTicketFlowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			OpenDetailsFacebookCannedResponseTicketFlow.makeActionableProcess(driver, channel);
			OpenDetailsFacebookCannedResponseTicketFlow.ticketTabVerification(driver, channel);
			OpenDetailsFacebookCannedResponseTicketFlow.openDetailsButton(driver, channel);
