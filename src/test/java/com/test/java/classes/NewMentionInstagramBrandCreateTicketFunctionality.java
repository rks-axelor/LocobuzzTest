...
import com.test.java.utilities.NewMentionInstagramBrandCreateTicketProcess;
...
public class NewMentionInstagramBrandCreateTicketFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionInstagramBrandCreateTicketProcess.makeActionableProcess(driver, channel);
			NewMentionInstagramBrandCreateTicketProcess.ticketTabVerification(driver,channel);
			NewMentionInstagramBrandCreateTicketProcess.replyPostButton(driver,channel);
