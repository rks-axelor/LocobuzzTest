...
import com.test.java.utilities.LocobuzzEscalationEmailsUIComponents;
...
public class LocobuzzEscalationEmailsUIComponentsFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void EscalationEmails(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzEscalationEmailsUIComponents.goingAccountSession(driver);
			LocobuzzEscalationEmailsUIComponents.verifyingEscalationEmailComponents(driver);
