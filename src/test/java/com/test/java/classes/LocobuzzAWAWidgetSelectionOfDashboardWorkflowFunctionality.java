...
import com.test.java.utilities.LocobuzzAWAWidgetSelectionOfDashboardWorkflow;
...
public class LocobuzzAWAWidgetSelectionOfDashboardWorkflowFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAWidgetSelectionOfDashboardWorkflow.LoginFunctionality(driver,user);
			LocobuzzAWAWidgetSelectionOfDashboardWorkflow.WidgetSelection(driver);
			LocobuzzAWAWidgetSelectionOfDashboardWorkflow.logout(driver);
