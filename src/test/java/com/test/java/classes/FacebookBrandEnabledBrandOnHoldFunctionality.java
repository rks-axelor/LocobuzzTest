...
import com.test.java.utilities.FacebookBrandEnabledBrandOnHoldProcess;
...
public class FacebookBrandEnabledBrandOnHoldFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			FacebookBrandEnabledBrandOnHoldProcess.makeActionableProcess(driver, channel);
			FacebookBrandEnabledBrandOnHoldProcess.ticketTabVerification(driver,channel);
			FacebookBrandEnabledBrandOnHoldProcess.replyPostButton(driver,channel);
