...
import com.test.java.utilities.FacebookBrandDisabledBrandRCProcess;
...
public class FacebookBrandDisabledBrandRCFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			FacebookBrandDisabledBrandRCProcess.makeActionableProcess(driver, channel);
			FacebookBrandDisabledBrandRCProcess.ticketTabVerification(driver,channel);
			FacebookBrandDisabledBrandRCProcess.openDetailsButton(driver,channel);
