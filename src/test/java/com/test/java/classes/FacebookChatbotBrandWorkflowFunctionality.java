...
import com.test.java.utilities.FacebookChatbotBrandWorkflowProcess;
...
public class FacebookChatbotBrandWorkflowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			FacebookChatbotBrandWorkflowProcess.assignProcess(driver, channel);
			FacebookChatbotBrandWorkflowProcess.agentChatbotTicketProcess(driver, channel);
