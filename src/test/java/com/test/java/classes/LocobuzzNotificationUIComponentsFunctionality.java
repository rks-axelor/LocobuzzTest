...
import com.test.java.utilities.LocobuzzNotificationUIComponents;
...
public class LocobuzzNotificationUIComponentsFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void Notification(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzNotificationUIComponents.goingAccountSession(driver);
			LocobuzzNotificationUIComponents.verifyingNotificationComponents(driver);
