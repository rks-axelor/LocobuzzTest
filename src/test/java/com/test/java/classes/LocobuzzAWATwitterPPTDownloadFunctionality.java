...
import com.test.java.utilities.LocobuzzAWATwitterPPTDownloadWorkflow;
...
public class LocobuzzAWATwitterPPTDownloadFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWATwitterPPTDownloadWorkflow.pptDownloadNativeForTwitter(driver);
