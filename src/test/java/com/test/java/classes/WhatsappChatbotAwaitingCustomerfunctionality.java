...
import com.test.java.utilities.WhatsappChatbotAwaitingCustomerProcess;
...
public class WhatsappChatbotAwaitingCustomerfunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			WhatsappChatbotAwaitingCustomerProcess.assignProcess(driver, channel);
			//WhatsappChatbotAwaitingCustomerProcess.agentChatbotTicketProcess(driver, channel);
