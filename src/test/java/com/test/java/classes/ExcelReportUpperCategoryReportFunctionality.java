...
import com.test.java.utilities.ExcelReportUpperCategoryReportWorkflow;
...
public class ExcelReportUpperCategoryReportFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportUpperCategoryReportWorkflow.excelReportUpperCategoryReportTemplateWorkflow(driver);
