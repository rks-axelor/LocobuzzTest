...
import com.test.java.utilities.LocobuzzLogocalGroupingUIComponents;
...
public class LocobuzzLogicalGroupingUIComponentFunctionality {
	...
	public void LogicalGrouping(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzLogocalGroupingUIComponents.goingAccountSession(driver);
			LocobuzzLogocalGroupingUIComponents.verifyingLogicalGroupingUIComponents(driver);
