...
import com.test.java.utilities.LocobuzzSupervisorCommonUIComponents;
...
public class LocobuzzSupervisorCommonUIComponentsFunctionality {
	...
	public void login(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzSupervisorCommonUIComponents.verifyingCommonUIComponents(driver);
			LocobuzzSupervisorCommonUIComponents.locobuzzTabs(driver);
