...
import com.test.java.utilities.LocobuzzAWACompetitionBenchmarkingPPTDownloadWorkflow;
...
public class LocobuzzAWACompetitionBenchmarkingPPTDownloadFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWACompetitionBenchmarkingPPTDownloadWorkflow.pptDownloadNativeForCompetitonBenchmarking(driver);
