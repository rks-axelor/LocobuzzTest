...
import com.test.java.utilities.TwitterTicketSendDMLinkAndGroupWorkflow;
...
public class TwitterTicketSendDMLinkAndGroupWorkflowFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			TwitterTicketSendDMLinkAndGroupWorkflow.GotoTicketTab(driver, channel);
			TwitterTicketSendDMLinkAndGroupWorkflow.ticketTabVerification(driver,channel);
			TwitterTicketSendDMLinkAndGroupWorkflow.openDetailsButton(driver,channel);
