...
import com.test.java.utilities.LocobuzzHelpRaiseIssueWorkflow;
...
public class LocobuzzHelpRaiseIssueWorkflowFunctionality {
	...
	public void HelpRaiseIssue(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzHelpRaiseIssueWorkflow.raiseIssueProcess(driver);
