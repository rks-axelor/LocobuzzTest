...
import com.test.java.utilities.LocoInfluencerRulesAccountWorkflow;
...
public class LocoInfluencerRulesAccountFunctionality {
	...
	public void InflunenserRules(String user) throws Exception	 {
		...
		try {
			...
			LocoInfluencerRulesAccountWorkflow.goingAccountSession(driver);
			LocoInfluencerRulesAccountWorkflow.verifyingInfluenserRulesFunction(driver);
