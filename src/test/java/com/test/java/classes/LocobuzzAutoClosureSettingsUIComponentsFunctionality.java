...
import com.test.java.utilities.LocobuzzAutoClosureSettingsUIComponents;
...
public class LocobuzzAutoClosureSettingsUIComponentsFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void AutoClosureSettings(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzAutoClosureSettingsUIComponents.goingAccountSession(driver);
			LocobuzzAutoClosureSettingsUIComponents.verifyingAutoClosureSettingsComponents(driver);
