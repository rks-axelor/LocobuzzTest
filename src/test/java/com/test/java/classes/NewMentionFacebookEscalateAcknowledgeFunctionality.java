...
import com.test.java.utilities.NewMentionFacebookEscalateAcknowledgeProcess;
...
public class NewMentionFacebookEscalateAcknowledgeFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionFacebookEscalateAcknowledgeProcess.makeActionableProcess(driver, channel);
			NewMentionFacebookEscalateAcknowledgeProcess.ticketTabVerification(driver,channel);
			NewMentionFacebookEscalateAcknowledgeProcess.moreButton(driver,channel);
