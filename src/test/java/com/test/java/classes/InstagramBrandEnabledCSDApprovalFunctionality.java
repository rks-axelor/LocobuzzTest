...
import com.test.java.utilities.InstagramBrandEnabledCSDApproval;
...
public class InstagramBrandEnabledCSDApprovalFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			InstagramBrandEnabledCSDApproval.makeActionableProcess(driver, channel);
			InstagramBrandEnabledCSDApproval.ticketTabVerification(driver,channel);
			InstagramBrandEnabledCSDApproval.replyPostButton(driver,channel);
