...
import com.test.java.utilities.LocobuzzManageUserUIComponents;
...
public class LocobuzzManageUserUIComponentsFunctionality {
	...
	public void ManageUser(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzManageUserUIComponents.verifyingManageUserComponents(driver);
