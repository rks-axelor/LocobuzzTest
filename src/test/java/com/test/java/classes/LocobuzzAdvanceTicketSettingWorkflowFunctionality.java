...
import com.test.java.utilities.LocobuzzAdvanceTicketSettingsWorkflow;
...
public class LocobuzzAdvanceTicketSettingWorkflowFunctionality {
	...
	public void AdvanceTicketSettings(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAdvanceTicketSettingsWorkflow.goingAccountSession(driver);
			LocobuzzAdvanceTicketSettingsWorkflow.advanceTicketSettingProcess(driver);
