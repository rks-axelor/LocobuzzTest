...
import com.test.java.utilities.OpenDetailsTwitterBrandEnabledBrandRejectProcess;
...
public class OpenDetailsTwitterBrandEnabledBrandRejectFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			OpenDetailsTwitterBrandEnabledBrandRejectProcess.makeActionableProcess(driver, channel);
			OpenDetailsTwitterBrandEnabledBrandRejectProcess.ticketTabVerification(driver,channel);
			OpenDetailsTwitterBrandEnabledBrandRejectProcess.openDetailsButton(driver,channel);
