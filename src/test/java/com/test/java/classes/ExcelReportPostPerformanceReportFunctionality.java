...
import com.test.java.utilities.ExcelReportPostPerformanceReportWorkflow;
...
public class ExcelReportPostPerformanceReportFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportPostPerformanceReportWorkflow.excelReportPostPerformanceReportTemplateWorkflow(driver);
