...
import com.test.java.utilities.LocoAutoCannedResponseAwaitingtwitterworkflow;
import io.github.bonigarcia.wdm.WebDriverManager;

public class LocoAutoCannedResponseAwaitingtwitterFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			LocoAutoCannedResponseAwaitingtwitterworkflow.makeActionableProcess(driver, channel);
			LocoAutoCannedResponseAwaitingtwitterworkflow.ticketTabVerification(driver,channel);
			LocoAutoCannedResponseAwaitingtwitterworkflow.replyPostButton(driver,channel);
