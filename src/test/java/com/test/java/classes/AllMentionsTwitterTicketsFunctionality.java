...
import com.test.java.utilities.AllMentionTwitterWorkflowProcess;
import com.test.java.utilities.CommonFunctions;

import io.github.bonigarcia.wdm.WebDriverManager;

public class AllMentionsTwitterTicketsFunctionality {
	...
	public void allMentionsTicketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			AllMentionTwitterWorkflowProcess.allMentionsWorkFlow(driver, channel);
