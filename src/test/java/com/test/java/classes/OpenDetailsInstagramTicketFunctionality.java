...
import com.test.java.utilities.OpenDetailsInstagramTicketWorkflowProcess;
...
public class OpenDetailsInstagramTicketFunctionality {
	...
	public void login(String user, String channel) throws Exception {
		...
		try {
			...
			OpenDetailsInstagramTicketWorkflowProcess.openDetailsTicketsInformation(driver,channel);
			OpenDetailsInstagramTicketWorkflowProcess.openDetailsButton(driver, channel);
