...
import com.test.java.utilities.FacebookChatbotCustomerWorkflowProcess;
...
public class FacebookChatbotCustomerWorkFlowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			FacebookChatbotCustomerWorkflowProcess.assignProcess(driver, channel);
			FacebookChatbotCustomerWorkflowProcess.agentChatbotTicketProcess(driver, channel);
