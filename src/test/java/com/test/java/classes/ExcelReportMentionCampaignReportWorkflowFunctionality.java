...
import com.test.java.utilities.ExcelReportMentionCampaignReportWorkflow;
...
public class ExcelReportMentionCampaignReportWorkflowFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportMentionCampaignReportWorkflow.excelReportMentionCampaignReportTemplateWorkflow(driver);
