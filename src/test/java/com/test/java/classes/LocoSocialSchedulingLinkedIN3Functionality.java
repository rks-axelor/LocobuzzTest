...
import com.test.java.utilities.LocoSocialSchedulingLinkedIN3Workflow;
...
public class LocoSocialSchedulingLinkedIN3Functionality {
	...
	public void SchedulingProcess(String user) throws Exception	 {
		...
		try {
			...
			LocoSocialSchedulingLinkedIN3Workflow.goingSocialSchedulingSection(driver);
			LocoSocialSchedulingLinkedIN3Workflow.SchedulingFunctionality(driver);
