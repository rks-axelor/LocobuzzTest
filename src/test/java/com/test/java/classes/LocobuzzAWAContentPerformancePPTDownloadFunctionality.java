...
import com.test.java.utilities.LocobuzzAWAContentPerformancePPTDownloadWorkflow;
...
public class LocobuzzAWAContentPerformancePPTDownloadFunctionality {
	...
	public void AWA(String user) throws Exception {
		...
		try {
			...
			LocobuzzAWAContentPerformancePPTDownloadWorkflow.pptDownloadNativeForContentPerformance(driver);
