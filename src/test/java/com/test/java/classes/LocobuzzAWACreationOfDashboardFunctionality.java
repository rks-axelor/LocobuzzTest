...
import com.test.java.utilities.LocobuzzAWACreationOfDashboard;
...
public class LocobuzzAWACreationOfDashboardFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWACreationOfDashboard.LoginFunctionality(driver,user);
			LocobuzzAWACreationOfDashboard.createDashboard(driver);
			LocobuzzAWACreationOfDashboard.logout(driver);
