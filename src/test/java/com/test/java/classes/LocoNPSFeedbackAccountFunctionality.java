...
import com.test.java.utilities.LocoNPSFeedbackAccountWorkprocess;
...
public class LocoNPSFeedbackAccountFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void LocobuzzNPSFeedbackAccounFunctionality(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocoNPSFeedbackAccountWorkprocess.goingAccountSession(driver);
			LocoNPSFeedbackAccountWorkprocess.NPSFeedbackWorkprocess(driver);
