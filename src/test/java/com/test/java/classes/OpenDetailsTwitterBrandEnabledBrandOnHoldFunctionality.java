...
import com.test.java.utilities.OpenDetailsTwitterBrandEnabledBrandOnHoldProcess;
...
public class OpenDetailsTwitterBrandEnabledBrandOnHoldFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			OpenDetailsTwitterBrandEnabledBrandOnHoldProcess.makeActionableProcess(driver, channel);
			OpenDetailsTwitterBrandEnabledBrandOnHoldProcess.ticketTabVerification(driver,channel);
			OpenDetailsTwitterBrandEnabledBrandOnHoldProcess.openDetailsButton(driver,channel);
