...
import com.test.java.utilities.LocobuzzAlertUIVerificationProcess;
...
public class LocobuzzAlertUIVerificationFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void LocobuzzAlertUIVerification(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzAlertUIVerificationProcess.goingAccountSession(driver);
			LocobuzzAlertUIVerificationProcess.LocobuzzViralAlertUIVerification(driver);
