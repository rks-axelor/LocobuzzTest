...
import com.test.java.utilities.NewMentionInstagramOnholdAcknowledgeProcess;
...
public class NewMentionInstagramOnholdAcknowledgeFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionInstagramOnholdAcknowledgeProcess.makeActionableProcess(driver, channel);
			NewMentionInstagramOnholdAcknowledgeProcess.ticketTabVerification(driver,channel);
			NewMentionInstagramOnholdAcknowledgeProcess.replyPostButton(driver,channel);
