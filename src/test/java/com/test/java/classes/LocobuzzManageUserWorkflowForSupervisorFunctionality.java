...
import com.test.java.utilities.LocobuzzManageUserWorkflowForSupervisor;
...
public class LocobuzzManageUserWorkflowForSupervisorFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void ManageUser(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			
			LocobuzzManageUserWorkflowForSupervisor.manageUserWorkflow(driver);
