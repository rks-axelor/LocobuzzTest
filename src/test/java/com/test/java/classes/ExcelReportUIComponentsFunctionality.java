...
import com.test.java.utilities.ExcelReportUIComponents;
...
public class ExcelReportUIComponentsFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportUIComponents.excelReportUIComponents(driver);
