...
import com.test.java.utilities.LocobuzzKeywordConfigurationUIComponents;
...
public class LocobuzzKeywordConfigurationUIComponentsFunctionality {
	...
	public void KeywordConfiguration(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzKeywordConfigurationUIComponents.goingAccountSession(driver);
			LocobuzzKeywordConfigurationUIComponents.verifyingKeywordConfigurationComponents(driver);
