...
import com.test.java.utilities.AllMentionLinkedinWorkflowProcess;
...
public class AllMentionsLinkedInTicketFunctionality {
	...
	public String testName, className, dateTime, status;
	  ...
	  public void allMentionsyoutubeTicketsFunctionality(String user, String channel) throws Exception {

			try {
				
				CommonFunctions.login(driver, user);
				AllMentionLinkedinWorkflowProcess.allMentionsWorkFlow(driver, channel);
