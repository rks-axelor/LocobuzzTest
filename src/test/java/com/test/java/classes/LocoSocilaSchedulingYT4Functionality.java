...
import com.test.java.utilities.LocoSocilaSchedulingYT4Workflow;
...
public class LocoSocilaSchedulingYT4Functionality {
	...
	public void SchedulingProcess(String user) throws Exception	 {
		...
		try {
			...
			LocoSocilaSchedulingYT4Workflow.goingSocialSchedulingSection(driver);
			LocoSocilaSchedulingYT4Workflow.SchedulingFunctionality(driver);
