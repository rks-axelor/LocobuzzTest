...
import com.test.java.utilities.LocoAutoCannedUIVerificationProcess;
...
public class LocoAutoCannedUIVerificationFunctionality {
	...
	public void LogicalGrouping(String user) throws Exception	 {
		...
		try {
			...
			LocoAutoCannedUIVerificationProcess.goingAccountSession(driver);
			LocoAutoCannedUIVerificationProcess.verifyingAutoCannedUIComponents(driver);
