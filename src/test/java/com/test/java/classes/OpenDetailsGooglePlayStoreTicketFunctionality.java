...
import com.test.java.utilities.OpenDetailsGooglePlayStoreTicketWorkflowProcess;
...
public class OpenDetailsGooglePlayStoreTicketFunctionality {
	...
	public void login(String user, String channel) throws Exception {
		...
		try {
			...
			OpenDetailsGooglePlayStoreTicketWorkflowProcess.openDetailsTicketsInformation(driver,channel);
			OpenDetailsGooglePlayStoreTicketWorkflowProcess.openDetailsButton(driver,channel);
