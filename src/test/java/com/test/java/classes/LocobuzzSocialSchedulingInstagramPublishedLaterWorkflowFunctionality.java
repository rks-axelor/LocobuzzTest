...
import com.test.java.utilities.LocobuzzSocialSchedulingInstagramPublishedLaterWorkflow;
...
public class LocobuzzSocialSchedulingInstagramPublishedLaterWorkflowFunctionality {
	...
	public void SocialScheduling(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzSocialSchedulingInstagramPublishedLaterWorkflow.socialSchedulingInstagramPublishedLaterWorkflow(driver);
