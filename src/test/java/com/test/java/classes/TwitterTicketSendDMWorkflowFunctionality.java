...
import com.test.java.utilities.TwitterTicketSendDMWorkflow;
...
public class TwitterTicketSendDMWorkflowFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			TwitterTicketSendDMWorkflow.GotoTicketTab(driver, channel);
			TwitterTicketSendDMWorkflow.ticketTabVerification(driver,channel);
			TwitterTicketSendDMWorkflow.openDetailsButton(driver,channel);
