...
public class LocoPublishWatermarksUIFunctionality {
...
try {
			...
			LocoPublishWatermarksUIVerification.goingAccountSession(driver);
			LocoPublishWatermarksUIVerification.verifyingPublishApproverUIComponents(driver);
