...
import com.test.java.utilities.NewMentionFacebookProcessAcknowledgeType;
...
public class NewMentionFacebookAcknowledgeFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionFacebookProcessAcknowledgeType.makeActionableProcess(driver, channel);
			NewMentionFacebookProcessAcknowledgeType.ticketTabVerification(driver,channel);
			NewMentionFacebookProcessAcknowledgeType.replyPostButton(driver,channel);
