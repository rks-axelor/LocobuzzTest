...
import com.test.java.utilities.LocobuzzAWAPPTDownloadImagesWorkflow;
...
public class LocobuzzAWAPPTDownloadImagesFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAPPTDownloadImagesWorkflow.LoginFunctionality(driver,user);
			LocobuzzAWAPPTDownloadImagesWorkflow.pptDownloadImages(driver);
			LocobuzzAWAPPTDownloadImagesWorkflow.logout(driver);
