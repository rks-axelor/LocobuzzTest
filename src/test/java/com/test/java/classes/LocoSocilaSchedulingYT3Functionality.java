...
import com.test.java.utilities.LocoSocilaSchedulingYT3Workflow;
...
public class LocoSocilaSchedulingYT3Functionality {
	...
	public void SchedulingProcess(String user) throws Exception	 {
		...
		try {
			...
			LocoSocilaSchedulingYT3Workflow.goingSocialSchedulingSection(driver);
			LocoSocilaSchedulingYT3Workflow.SchedulingFunctionality(driver);
