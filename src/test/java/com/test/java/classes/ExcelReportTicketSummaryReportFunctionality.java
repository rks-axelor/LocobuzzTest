...
import com.test.java.utilities.ExcelReportTicketSummaryReportWorkflow;
...
public class ExcelReportTicketSummaryReportFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportTicketSummaryReportWorkflow.excelReportTicketSummaryReportWorkflow(driver);
