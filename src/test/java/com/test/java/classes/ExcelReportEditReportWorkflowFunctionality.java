...
import com.test.java.utilities.ExcelReportEditReportWorkflow;
...
public class ExcelReportEditReportWorkflowFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportEditReportWorkflow.excelReportEditReportWorkflow(driver);
