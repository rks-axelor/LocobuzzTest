...
import com.test.java.utilities.LocobuzzAWAInfluencerPPTDownloadWorkflow;
...
public class LocobuzzAWAInfluencerPPTDownloadFunctionality {
	...
	public void AWA(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAWAInfluencerPPTDownloadWorkflow.pptDownloadNativeForInfluencer(driver);
