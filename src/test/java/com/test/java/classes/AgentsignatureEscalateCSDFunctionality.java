...
import com.test.java.utilities.AgentsignatureEscalateCSDworkprocess;
import com.test.java.utilities.CommonFunctions;
import com.test.java.utilities.InstagramBrandEnabledCSDEscalate;
...
public class AgentsignatureEscalateCSDFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			AgentsignatureEscalateCSDworkprocess.makeActionableProcess(driver, channel);
			AgentsignatureEscalateCSDworkprocess.ticketTabVerification(driver,channel);
			AgentsignatureEscalateCSDworkprocess.replyPostButton(driver,channel);
