...
import com.test.java.utilities.LocobuzzAgentAccountSectionProfile;
...
public class LocobuzzAgentAccountSectionProfileFunctionality {
	...
	public void Profile(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAgentAccountSectionProfile.goingAccountSession(driver);
			LocobuzzAgentAccountSectionProfile.verifyingAccountComponents(driver);
			LocobuzzAgentAccountSectionProfile.verfyingProfileComponents(driver);
