...
import com.test.java.utilities.LocobuzzAlertAccountWorkflowProcess;
...
public class LocoAlertAccountSectWorkFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void LocobuzzAlertworkflow(String user) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			LocobuzzAlertAccountWorkflowProcess.goingAccountSession(driver);
			LocobuzzAlertAccountWorkflowProcess.LocobuzzViralAlertUIVerification(driver);
