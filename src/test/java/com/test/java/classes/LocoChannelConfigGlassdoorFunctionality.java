...
import com.test.java.utilities.LocoChannelConfigGlassdoorWorkflow;
import com.test.java.utilities.LocoChannelConfigTripAdvisorWorkFlow;
...
public class LocoChannelConfigGlassdoorFunctionality {
	...
	@Test
	@Parameters({ "user" })
	public void ChannelCofigurationGlassdoor(String user) throws Exception	 {

		try {
			
			CommonFunctions.login(driver, user);
			
			LocoChannelConfigGlassdoorWorkflow.goingAccountSession(driver);
			LocoChannelConfigGlassdoorWorkflow.ChannelConfigurationGlassdoorWorkFlow(driver);
