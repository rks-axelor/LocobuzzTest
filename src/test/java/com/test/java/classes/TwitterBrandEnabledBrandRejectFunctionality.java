...
import com.test.java.utilities.TwitterBrandEnabledBrandRejectProcess;
...
public class TwitterBrandEnabledBrandRejectFunctionality {
	...
	public void allMentionsTicketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			TwitterBrandEnabledBrandRejectProcess.makeActionableProcess(driver, channel);
			TwitterBrandEnabledBrandRejectProcess.ticketTabVerification(driver,channel);
			TwitterBrandEnabledBrandRejectProcess.replyPostButton(driver,channel);
