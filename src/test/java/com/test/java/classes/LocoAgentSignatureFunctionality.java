...
import com.test.java.utilities.LocoAgentSignatureDemoWorkFlow;
...
public class LocoAgentSignatureFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			LocoAgentSignatureDemoWorkFlow.makeActionableProcess(driver, channel);
			LocoAgentSignatureDemoWorkFlow.ticketTabVerification(driver, channel);
			LocoAgentSignatureDemoWorkFlow.replyPostButton(driver, channel);
