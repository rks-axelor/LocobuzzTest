...
import com.test.java.utilities.OpenDetailsFacebookTicketWorkFlowProcess;
...
public class OpenDetailsFacebookTicketFunctionality {
	...
	public void login(String user, String channel) throws Exception {
		...
		try {
			...
			OpenDetailsFacebookTicketWorkFlowProcess.openDetailsTicketsInformation(driver,channel);
			OpenDetailsFacebookTicketWorkFlowProcess.openDetailsButton(driver,channel);
