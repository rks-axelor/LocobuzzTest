...
import com.test.java.utilities.NewMentionTwitterOnholdReplyProcess;
...
public class NewMentionTwitterOnholdReplyFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionTwitterOnholdReplyProcess.makeActionableProcess(driver, channel);
			NewMentionTwitterOnholdReplyProcess.ticketTabVerification(driver,channel);
			NewMentionTwitterOnholdReplyProcess.replyPostButton(driver,channel);
