...
import com.test.java.utilities.OpenDetailsInstagramCannedResponseTicketFlow;
...
public class OpenDetailsInstagramCannedResponseTicketFlowFunctionality {
	...
	public void ticketsFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			OpenDetailsInstagramCannedResponseTicketFlow.makeActionableProcess(driver, channel);
			OpenDetailsInstagramCannedResponseTicketFlow.ticketTabVerification(driver, channel);
			OpenDetailsInstagramCannedResponseTicketFlow.openDetailsButton(driver, channel);
