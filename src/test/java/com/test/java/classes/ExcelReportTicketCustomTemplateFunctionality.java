...
import com.test.java.utilities.ExcelReportTicketCustomTemplateWorkflow;
...
public class ExcelReportTicketCustomTemplateFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportTicketCustomTemplateWorkflow.excelReportTicketCustomeTemplateWorkflow(driver);
