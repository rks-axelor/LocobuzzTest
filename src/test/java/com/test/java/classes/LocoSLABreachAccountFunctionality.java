...
import com.test.java.utilities.LocoSLAAccountWorkflow;
...
public class LocoSLABreachAccountFunctionality {
	...
	public void SLAUIVerification(String user) throws Exception	 {
		...
		try {
			...
			LocoSLAAccountWorkflow.goingAccountSession(driver);
			LocoSLAAccountWorkflow.SLABreachUIVerification(driver);
