...
import com.test.java.utilities.LocoSocilaSchedulingYT1Workflow;
...
public class LocoSocilaSchedulingYT1Functionality {
	...
	public void SchedulingProcess(String user) throws Exception	 {
		...
		try {
			...
			LocoSocilaSchedulingYT1Workflow.goingSocialSchedulingSection(driver);
			LocoSocilaSchedulingYT1Workflow.SchedulingFunctionality(driver);
