...
import com.test.java.utilities.AllMentionGMBReviewsWorkflowProcess;
...
public class AllMentionsGMBReviewsTicketFunctionality {
	...
	public String testName, className, dateTime, status;
	  ...
	  public void allMentionsGMBTicketsFunctionality(String user, String channel) throws Exception {

			try {
				
				CommonFunctions.login(driver, user);
				AllMentionGMBReviewsWorkflowProcess.allMentionsWorkFlow(driver, channel);
