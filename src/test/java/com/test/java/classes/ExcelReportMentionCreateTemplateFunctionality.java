...
import com.test.java.utilities.ExcelReportMentionCreateTemplateWorkflow;
...
public class ExcelReportMentionCreateTemplateFunctionality {
	...
	public void ExcelReport(String user) throws Exception	 {
		...
		try {
			...
			ExcelReportMentionCreateTemplateWorkflow.excelReportMentionCreateTemplateWorkflow(driver);
