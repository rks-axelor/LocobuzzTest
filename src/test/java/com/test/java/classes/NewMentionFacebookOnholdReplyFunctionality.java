...
import com.test.java.utilities.NewMentionFacebookOnholdReplyProcess;
...
public class NewMentionFacebookOnholdReplyFunctionality {
	...
	public void ticketFunctionality(String user, String channel) throws Exception {
		...
		try {
			...
			NewMentionFacebookOnholdReplyProcess.makeActionableProcess(driver, channel);
			NewMentionFacebookOnholdReplyProcess.ticketTabVerification(driver,channel);
			NewMentionFacebookOnholdReplyProcess.replyPostButton(driver,channel);
