...
import com.test.java.utilities.LocoSLABreachFacebookWorkflow;
...
public class LocoSLABreachFacebookFunctionality {
	...
	public void SLAFacebookFunction(String user) throws Exception	 {
		...
		try {
			...
			LocoSLABreachFacebookWorkflow.goingAccountSession(driver);
			LocoSLABreachFacebookWorkflow.SLABreachFacebookWorkflow(driver);
