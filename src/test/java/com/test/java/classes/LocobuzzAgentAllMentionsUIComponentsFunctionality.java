...
import com.test.java.utilities.LocobuzzAgentAllMentionsUIComponents;
...
public class LocobuzzAgentAllMentionsUIComponentsFunctionality {
	...
	public void login(String user) throws Exception	 {
		...
		try {
			...
			LocobuzzAgentAllMentionsUIComponents.verifyingAllMentionsTabUIComponents(driver);
