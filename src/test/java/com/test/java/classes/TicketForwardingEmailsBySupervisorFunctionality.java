...
import com.test.java.utilities.TicketForwardingEmailsBySupervisor;
...
public class TicketForwardingEmailsBySupervisorFunctionality {
	...
	public void TicketForwardingEmails(String user,String channel) throws Exception	 {

		try {
			CommonFunctions.login(driver, user);
			
			TicketForwardingEmailsBySupervisor.makeActionableProcess(driver, channel);
			TicketForwardingEmailsBySupervisor.ticketTabVerification(driver, channel);
			TicketForwardingEmailsBySupervisor.emailButton(driver, channel);
