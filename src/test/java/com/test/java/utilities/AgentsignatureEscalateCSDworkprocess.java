...
public class AgentsignatureEscalateCSDworkprocess {
...
//ticket information
	public static void ticketTabVerification(WebDriver driver, String channel) throws Exception {
		try {
			...
			ticketInformation.add(0, "Agent signature escalation  WorkFlow For CSD");
...
// imagename
			WebElement ticketName = driver.findElement(By.xpath("(//span[contains(text(),'Messages')])[1]"));
...
// username
			WebElement userName = driver
					.findElement(By.xpath("//span[contains(text(),'Messages')]//following::a[1]"));
