...
public class OpenDetailsFacebookTicketWorkFlowProcess {
	...
	public static void openDetailsTicketsInformation(WebDriver driver, String channel) throws Exception {
		...
		try {
			...
			driver.findElement(By.xpath("(//span[@class='header__tabs--label activeText-blur moreText-blur' and contains(text(),'Tickets')])"));
...
//overview
			...
			WebElement assigning = driver.findElement(By.xpath("(//input[contains(@class,'mat-input-element mat-form-field-autofill-control mat-menu-trigger ng')])[2]"));
			js.executeScript("arguments[0].click()", assigning);

			WebElement assignperson = driver.findElement(By.xpath(
					"//mat-icon[contains(text(),'person')]//following::span[contains(text(),'Komal suplive')]"));
...
//Escalate
			...
			if (replyType.trim().equalsIgnoreCase("Reply & Escalate")) {
				...
				WebElement customerName = driver
						.findElement(By.xpath("//span[@class='mat-option-text' and contains(.,'komal malicsd')]"));
			...
			WebElement arrowBackButton = driver.findElement(By.xpath("//span[contains(text(),'Back To Ticket List')]"));
...
// ticketStatus
			...
			WebElement ticketStatusIcon = driver.findElement(By.xpath("(//mat-icon[contains(text(),'folder')])[5]"));
			WebElement ticketStatus = driver.findElement(By.xpath("(//span[@class='post__foot--label ticketstatus__blue colored__yellow--dark'])"));
...
// ticketclosed status
			...
			WebElement ticketStatusIcon = driver.findElement(By.xpath("(//mat-icon[contains(text(),'folder')])[5]"));
			WebElement ticketStatus = driver.findElement(By.xpath("//span[contains(@class,'post__foot--label ticketstatus__blue colored__red')]"));
