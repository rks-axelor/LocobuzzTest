...
public class LocoSocialSchedulingLinkedIN2Workflow {
...
//Compose Your Post	
	...
	if(composeheading.isDisplayed() && LinkedINlogo.isDisplayed() && decriptionarea.isDisplayed() && postcontent.isDisplayed()) 		
...
//Add Labels To Post
    ...
    Action actionw = actionsw.sendKeys(addnewlabel, "Demo Category Post").sendKeys(Keys.ENTER).build();
    actionw.perform();
    Thread.sleep(5000);
