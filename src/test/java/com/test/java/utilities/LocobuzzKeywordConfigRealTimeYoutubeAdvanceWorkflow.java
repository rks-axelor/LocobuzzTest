...
public class LocobuzzKeywordConfigRealTimeYoutubeAdvanceWorkflow {
...
//account session Button
	...
	public static void keywordConfigurationYoutubeProcess(WebDriver driver) throws Exception {
		try {
...
//group name
			...
			groupName.sendKeys("youtubeprol");
			Thread.sleep(2000);
			
//select channel
			WebElement selectChannel = driver
					.findElement(By.xpath("(//span[contains(@class,'mat-checkbox-inner-container')])[5]"));
...
//outside toggles
			WebElement outsideTogglesButton = driver
					.findElement(By.xpath("(//span[@class='mat-button-toggle-label-content' and text()='OR'])[1]"));
...
//search group name
			...
			searchGroupName.sendKeys("youtubeprol");
