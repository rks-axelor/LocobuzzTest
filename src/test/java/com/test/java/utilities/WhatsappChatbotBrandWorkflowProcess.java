...
public class WhatsappChatbotBrandWorkflowProcess {
 ...
 //escalate
									...
									WebElement customerName = driver.findElement(
											By.xpath("//span[contains(text(),'Brand Brand')]"));
    ...
    //awaiting tab
									WebElement awaitingTab = driver.findElement(By.xpath("//a[contains(text(),'Awaiting')]"));
...
//WhatsApp logo
WebElement imageIcon = driver
		.findElement(By.xpath("(//img[contains(@class,'channel__image') and@src='/assets/images/channelicons/WebsiteChatBot.svg'])[1]"));
if (imageIcon.isDisplayed()) {
	System.out.println("WhatsApp Image displayed successfully");
} else {
	System.out.println("WhatsApp Image not displayed");
