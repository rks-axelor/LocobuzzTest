...
public class TwitterTicketWorkflowProcess {
...
// brandname
			...
			WebElement brandname = driver.findElement(By.xpath("(//div[@class='post__pill bg__grey--lighter nowrap responsive__detail--infoitem'])"));
...
//ticket Status
				WebElement ticketStatusIcon = driver
						.findElement(By.xpath("(//mat-icon[contains(text(),'local_activity')])[4]"));
				WebElement ticketStatus1 = driver.findElement(By.xpath("(//span[contains(@class,'post__foot--label')])[1]"));
...
//Status Change
			...
			if (replyType.equalsIgnoreCase("Reply & Close")) {
				WebElement ticketStatusClosed = driver.findElement(
						By.xpath("(//span[contains(@class,'mat-select-value-text') and contains(.,'Close')])"));
				...
				WebElement ticketStatusOnHold = driver.findElement(
						By.xpath("(//span[contains(@class,'mat-select-value') and contains(.,'On Hold')])"));
