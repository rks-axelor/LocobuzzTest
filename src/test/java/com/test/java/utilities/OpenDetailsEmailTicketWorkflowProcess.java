...
public class OpenDetailsEmailTicketWorkflowProcess {
...
// ticketid
			...
			WebElement ticketId = driver.findElement(
					By.xpath("((//div[@id='socialBox'])[1]//following::span[@class='post__foot--label'])[2]"));
...
// priority
			...
			WebElement priority = driver.findElement(
					By.xpath("((//div[@id='socialBox'])[1]//following::span[@class='post__foot--label'])[5]"));
...
//mark as read
			/*
			 * if (value == 1) { WebElement markAsRead =
			 * driver.findElement(By.xpath("//span[contains(text(),'Mark as read')]"));
			 * js.executeScript("arguments[0].click()", markAsRead); value++; }
			 */
...
//DateTime
			...
			WebElement replyTextArea = driver.findElement(By.xpath("(//iframe[@class='cke_wysiwyg_frame cke_reset'])"));
			driver.switchTo().frame(replyTextArea);
			Thread.sleep(2000);

			WebElement framedata = driver.findElement(By.xpath("(//p[contains(text(),'wrote:')]//following::div)[2]"));
