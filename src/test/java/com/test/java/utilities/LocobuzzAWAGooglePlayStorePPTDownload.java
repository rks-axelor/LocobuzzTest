...
public class LocobuzzAWAGooglePlayStorePPTDownload {

	public static List<String> componentsInformation = new ArrayList<String>();

	public static void pptDownloadNativeForGooglePlayStore(WebDriver driver) throws Exception {
		try {

			Thread.sleep(3000);
			JavascriptExecutor js = (JavascriptExecutor) driver;

			WebElement googlePlayStore = driver
					.findElement(By.xpath("//span[@class='pl-7' and text()='Google Play Store']"));
			js.executeScript("arguments[0].click()", googlePlayStore);
			Thread.sleep(7000);
...
// select profile
			...
			WebElement selectProfile = driver.findElement(By.xpath("//span[contains(text(),'Locobuzz Application ')]"));
...
//search the element
			...
			Thread.sleep(4000);
			WebElement excludeButton=driver.findElement(By.xpath("(//span[@class='ant-checkbox'])[5]"));
...
//search the element
			...
			searchElement2.sendKeys("keywords");
			Thread.sleep(2000);
			WebElement keywords=driver.findElement(By.xpath("(//div[@class='ant-collapse-header']//div)[2]"));
			js.executeScript("arguments[0].click()", keywords);
			Thread.sleep(4000);
			WebElement searchpost=driver.findElement(By.xpath("//input[@placeholder='Search Keywords']"));
			searchpost.sendKeys("management");
			Thread.sleep(3000);
...
//ppt
			...
			pptDownloadImageForGooglePlayStore(driver);
	...
	public static void pptDownloadImageForGooglePlayStore(WebDriver driver) throws Exception {
		try {
