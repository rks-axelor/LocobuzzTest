...
public class ExcelReportCRMReportWorkflow {
	
	public static List<String> componentsInformation = new ArrayList<String>();
	
	public static void excelReportCRMReportTemplateWorkflow(WebDriver driver) throws Exception {
		try {
...
//section name
			WebElement sectionName = driver.findElement(By.xpath("//a[contains(text(),'CRM')]"));
			js.executeScript("arguments[0].click()", sectionName);
			Thread.sleep(3000);
			
			WebElement template = driver.findElement(By.xpath("//h3[contains(text(),'CRM')]"));
...
//search the brand
			...
			Thread.sleep(2000);
			WebElement selectDate=driver.findElement(By.xpath("(//button[contains(text(),'Last 7 Days')])[1]"));
			js.executeScript("arguments[0].click()", selectDate);
			Thread.sleep(2000);
			WebElement applyButton=driver.findElement(By.xpath("(//button[contains(text(),'Done')])[1]"));
...
//tickets and mentions
			...
			Action action1 = action.sendKeys(Keys.ESCAPE).build();
			action1.perform();
			...
			Thread.sleep(3000);
			WebElement selectOption=driver.findElement(By.xpath("//span[@class='mat-option-text' ]//div[contains(text(),' Positive')]"));
			js.executeScript("arguments[0].click()", selectOption);
			Thread.sleep(3000);
			Actions action2 = new Actions(driver);
			Action action3 = action2.sendKeys(Keys.ESCAPE).build();
			action3.perform();	
