...
public class LocochannelconfigExpediaWorkflow {
...
public static void ChannelConfigurationExpediaWorkFlow(WebDriver driver) throws Exception {
	try {
...
//Expedia Channel Configuration			
		WebElement Expediaconfig=driver.findElement(By.xpath("(//img[@src='assets/images/channel-logos/expedia.svg'])[1]"));
		js.executeScript("arguments[0].click()", Expediaconfig);
		Thread.sleep(5000);
//Add Expedia Account Window UI Components
		WebElement AddGAaccheading=driver.findElement(By.xpath("//h3[contains(text(),'Expedia')]"));
		WebElement AddGAAccheadingIcon=driver.findElement(By.xpath("//img[@src='assets/images/channel-logos/expedia.svg']"));
		...
		&& AddURLtxbx.isDisplayed() && AddURLGAMandatory.isDisplayed() && AddExpedianote.isDisplayed() 
		&& AddMoreField.isDisplayed() && Cancel.isDisplayed() && SaveURL.isDisplayed() && AddGAAccheadingIcon.isDisplayed())
		{
		System.out.println("Add Expedia Account Window UI Components are displayed");
		}
		else {
		System.out.println("Add Expedia Account Window UI Components are not displayed");
		}
		
	    WebElement AddURL = driver.findElement(By.xpath("//mat-label[contains(text(),'Add URL')]"));
		Actions actions5 = new Actions(driver);
		Action action5 = actions5.sendKeys(AddURL, "https://www.expedia.co.in/Margao-Hotels-Treehouse-Vega-A-Boutique-Hotel.h76189436.Hotel-Information?chkin=2022-12-10&chkout=2022-12-11&x_pwa=1&rfrr=HSR&pwa_ts=1670387919467&referrerUrl=aHR0cHM6Ly93d3cuZXhwZWRpYS5jby5pbi9Ib3RlbC1TZWFyY2g%3D&useRewards=false&rm1=a2&regionId=6049928&destination=Goa%2C+India&destType=MARKET&sort=RECOMMENDED&top_dp=3977&top_cur=INR&userIntent=&selectedRoomType=316312201&selectedRatePlan=386278579").build();
        action5.perform();
		Thread.sleep(3000);
		...
		Action action6 = actions6.sendKeys(AddURL2, "https://www.expedia.co.in/Mahabaleshwar-Hotels-Hirkani-Garden-Resort.h83929584.Hotel-Information?chkin=2022-12-20&chkout=2022-12-21&x_pwa=1&rfrr=HSR&pwa_ts=1670329924200&referrerUrl=aHR0cHM6Ly93d3cuZXhwZWRpYS5jby5pbi9Ib3RlbC1TZWFyY2g%3D&useRewards=false&rm1=a2&regionId=6126712&destination=Mahabaleshwar%2C+Maharashtra%2C+India&destType=MARKET&sort=RECOMMENDED&top_dp=2400&top_cur=INR&userIntent=&selectedRoomType=320861772&selectedRatePlan=387358410").build();
        action6.perform();
		Thread.sleep(3000);
		...
		System.out.println("Expedia Profile Added Successfully");
...
//Click on Expedia Account		
		WebElement TripAdvisorprofile = driver.findElement(By.xpath("(//a[contains(text(),'Expedia')])"));
		TripAdvisorprofile.click();
		Thread.sleep(5000);		
//Verify All Expedia Label Details
		WebElement logo = driver.findElement(By.xpath("(//img[@src='assets/images/channel-logos/expedia.svg'])[1]"));
		WebElement label = driver.findElement(By.xpath("(//span[contains(text(),'Expedia (2)')])"));
		System.out.println("All Expedia Heading Details:"+label.getText());
		Thread.sleep(3000);
		
//Verify  added Expedia  Account Configuration Details			
		...
		System.out.println("Name of Expedia profile Configuration is:"+AccountLabel1.getText());
		WebElement AccConfTime1 = driver.findElement(By.xpath("(//div[contains(@class,'channelConfiguration__booking--body p-')])[1]"));
		System.out.println("Time of Expedia profile Configuration is:"+AccConfTime1.getText());
		WebElement Link1 = driver.findElement(By.xpath("(//div[contains(@class,'channelConfiguration__booking--body p-')])[2]"));
		System.out.println("Link of Expedia  profile Configuration is:"+Link1.getText());
		...
		{
		System.out.println("Verify Expedia Account Configuration Details are  displayed");
		}
		else {
		System.out.println("Verify Expedia Account Configuration Details are not displayed");
		}
//Verify Newly added Expedia Account Configuration Details			
		...
		System.out.println("Name of Expedia profile Configuration is:"+AccountLabel.getText());
		WebElement AccConfTime = driver.findElement(By.xpath("(//div[contains(@class,'channelConfiguration__booking--body p-')])[3]"));
		System.out.println("Time of Expedia profile Configuration is:"+AccConfTime.getText());
		WebElement Link = driver.findElement(By.xpath("(//div[contains(@class,'channelConfiguration__booking--body p-')])[4]"));
		System.out.println("Link of Expedia profile Configuration is:"+Link.getText());
...
//Delete Expedia Configured Account			
...
//Verify Expedia Account Deleted or not
