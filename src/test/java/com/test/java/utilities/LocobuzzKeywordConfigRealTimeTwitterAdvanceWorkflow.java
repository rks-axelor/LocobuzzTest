...
public class LocobuzzKeywordConfigRealTimeTwitterAdvanceWorkflow {
...
//account session Button
	...
	public static void keywordConfigurationTwitterProcess(WebDriver driver) throws Exception {
		try {
...
//group name
			...
			groupName.sendKeys("AdvTKey");
			Thread.sleep(2000);
//select channel
			WebElement selectChannel = driver
					.findElement(By.xpath("(//span[contains(@class,'mat-checkbox-inner-container')])[1]"));
...
//select attribute
			...
			Thread.sleep(3000);
			WebElement selectAttribute=driver.findElement(By.xpath("//span[contains(text(),' Tweet ')]"));
...
//keywords
			...
			keywords.sendKeys("views");
			keywords.sendKeys(Keys.ENTER);
			keywords.sendKeys("comments");
			keywords.sendKeys(Keys.ENTER);
...
//select other attribute
			...
			WebElement arrow3=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-arrow-wrapper')])[5]"));
			js.executeScript("arguments[0].click()", arrow3);
			Thread.sleep(3000);
			WebElement selectAttribute1=driver.findElement(By.xpath("//span[contains(text(),' Language ')]"));
			js.executeScript("arguments[0].click()", selectAttribute1);
			Thread.sleep(3000);
			WebElement arrow4=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-arrow-wrapper')])[6]"));
...
//select language
			WebElement selectLanguage=driver.findElement(By.xpath("//input[@placeholder='Search Language']"));
			selectLanguage.sendKeys("english");
			WebElement language=driver.findElement(By.xpath("//span[contains(text(),' English ')]"));
			js.executeScript("arguments[0].click()", language);
			Thread.sleep(3000);
			
			selectLanguage.sendKeys("telugu");
			WebElement language1=driver.findElement(By.xpath("//span[contains(text(),' Telugu ')]"));
...
//search group name
			...
			searchGroupName.sendKeys("AdvTKey");
