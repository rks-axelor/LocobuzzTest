...
public class LocobuzzCSDAccountSectionProfile {
...
// change password
			...
			componentsInformation.add(30, CommonFunctions.getDataTime());

			CommonFunctions.writeUIComponentsToExcel(componentsInformation, "CSDAccountSectionInformation");
...
//contact number
			...
			contactNumber.sendKeys("9752644887");
			Thread.sleep(3000);
