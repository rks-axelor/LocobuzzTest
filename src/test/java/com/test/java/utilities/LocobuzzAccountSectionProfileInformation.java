...
//profile message
			...
			WebElement profileMessage=driver.findElement(By.xpath("(//p[@class='mb-0 mt-6 text__light--sm font-weight-400'])"));
...
//Assigned Brand Details
			...
			WebElement assignedBrands=driver.findElement(By.xpath("//span[@mattooltipclass='custom__tooltip-normal']"));
...
//contact number
			...
			contactNumber.sendKeys("9752644534");
			Thread.sleep(3000);
