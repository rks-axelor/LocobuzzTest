...
public class AllMentionYoutubeWorkflowProcess {
	...
	public static void allMentionsWorkFlow(WebDriver driver, String channel) throws Exception {
		...
		try {
			...
			ticketInformation.add(0, "AllMentions Youtube WorkFlow");
...
//imagename
			...
			if (ticketName.isDisplayed()) {
				System.out.println("Youtube name is displayed");
			} else {
				System.out.println("Youtube name is not displayed");
			}
