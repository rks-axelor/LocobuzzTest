...
public class LocoAutoCannedResponseInstaHoldWorkflow {
...
//tickets tab
			...
			inputbox.clear();
			inputbox.sendKeys("Malikomal7296");
...
//ticket information
	public static void ticketTabVerification(WebDriver driver, String channel) throws Exception {
		try {
			...
			ticketInformation.add(0, "Instagram Ticket Automated Canned Response");
...
//open post
	 ((JavascriptExecutor)driver).executeScript("window.open()");
		...
		username.sendKeys("malikomal7296");
		Thread.sleep(5000);		
	...
	WebElement viewreplies = wait1.until(ExpectedConditions
			.visibilityOfElementLocated(By.xpath("(//button[contains(@class,'_acan _acao _acas')])[2]")));
	
	js.executeScript("arguments[0].click()", viewreplies);
    Thread.sleep(5000);
    js.executeScript("arguments[0].click()", viewreplies);
    Thread.sleep(6000);
