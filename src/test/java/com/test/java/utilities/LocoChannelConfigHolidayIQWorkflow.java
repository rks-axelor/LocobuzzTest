...
public class LocoChannelConfigHolidayIQWorkflow {
...
public static void ChannelConfigurationHolidayIQWorkFlow(WebDriver driver) throws Exception {
	try {
...
//HolidayIQ Channel Configuration			
		WebElement HolidayIQconfig=driver.findElement(By.xpath("(//img[@src='assets/images/channel-logos/holidayiq.svg'])[1]"));
		js.executeScript("arguments[0].click()", HolidayIQconfig);
		Thread.sleep(5000);
//Add HolidayIQ Account Window UI Components
		WebElement AddGAaccheading=driver.findElement(By.xpath("//h3[contains(text(),'Holiday IQ')]"));
		WebElement AddGAAccheadingIcon=driver.findElement(By.xpath("//img[@src='assets/images/channel-logos/holidayiq.svg']"));
		WebElement AddHolidayIQnote=driver.findElement(By.xpath("//span[contains(text(),'To monitor your reviews on Holiday IQ, please copy paste guest reviews link.')]"));
		...
		&& AddURLtxbx.isDisplayed() && AddURLGAMandatory.isDisplayed() && AddHolidayIQnote.isDisplayed() 
		&& AddMoreField.isDisplayed() && Cancel.isDisplayed() && SaveURL.isDisplayed() && AddGAAccheadingIcon.isDisplayed())
		{
		System.out.println("Add HolidayIQ Account Window UI Components are displayed");
		}
		else {
		System.out.println("Add HolidayIQ Account Window UI Components are not displayed");
		}
		
	    WebElement AddURL = driver.findElement(By.xpath("//mat-label[contains(text(),'Add URL')]"));
		Actions actions5 = new Actions(driver);
		Action action5 = actions5.sendKeys(AddURL, "https://www.holidayiq.com/Taj-Mahal-Palace-Tower-Mumbai-hotel-3317.html").build();
        action5.perform();
		Thread.sleep(3000);
		...
		Action action6 = actions6.sendKeys(AddURL2, "https://www.holidayiq.com/ibis-Mumbai-Airport-Hotel-Mumbai-hotel-413754.html").build();
        action6.perform();
		Thread.sleep(3000);
