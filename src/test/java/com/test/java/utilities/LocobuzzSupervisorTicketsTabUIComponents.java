...
public class LocobuzzSupervisorTicketsTabUIComponents {
...
//awaiting button
			WebElement awaitingButton=driver.findElement(By.xpath("(//a[contains(text(),'Awaiting ')])[1]"));
...
//sortbutton
			WebElement sortButton=driver.findElement(By.xpath("(//mat-icon[contains(text(),'sort')])[1]"));
...
//ticketrenderingbutton
			WebElement ticketRenderingButton=driver.findElement(By.xpath("(//mat-icon[contains(text(),'more_vert')])[1]"));
...
//brands
			WebElement brands=driver.findElement(By.xpath("(//span[contains(text(),' Brands')])[1]"));
...
//duration
			WebElement duration=driver.findElement(By.xpath("(//span[contains(text(),' Duration')])[1]"));
...
//Addsymbol
			...
			CommonFunctions.writeUIComponentsToExcel(componentsInformation,"SupervisorTicketsTabUIComponent");
