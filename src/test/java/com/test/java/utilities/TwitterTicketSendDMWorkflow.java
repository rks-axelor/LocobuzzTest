...
public class TwitterTicketSendDMWorkflow {
...
// Reply type
			...
			WebElement replyTypeSelector = driver.findElement(
					By.xpath("(//span[contains(@class,'ng-star-inserted') and contains(text(),'Reply &')])[3]"));
...
//tags users
			WebElement taguser=driver.findElement(By.xpath("//span[@class='text__regular--sm' and text()='Komal25169281']"));
			js.executeScript("arguments[0].click()", taguser);
			Thread.sleep(3000);
			
//send dm
			WebElement sendDm=driver.findElement(By.xpath("(//span[contains(text(),'Send as DM')])[1]"));
			js.executeScript("arguments[0].click()", sendDm);
			Thread.sleep(3000);
