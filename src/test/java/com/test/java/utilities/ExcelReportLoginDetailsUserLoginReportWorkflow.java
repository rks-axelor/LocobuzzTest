...
public class ExcelReportLoginDetailsUserLoginReportWorkflow {
	
	public static List<String> componentsInformation = new ArrayList<String>();
	
	public static void excelReportLoginDetailsUserLoginReportTemplateWorkflow(WebDriver driver) throws Exception {
		try {
...
//section name
			WebElement sectionName = driver.findElement(By.xpath("//a[contains(text(),'LoginDetails')]"));
			js.executeScript("arguments[0].click()", sectionName);
			Thread.sleep(3000);
			
			WebElement template = driver.findElement(By.xpath("//h3[contains(text(),'UserLogin_Summary')]"));
