...
public class ExcelReportMentionEmailForwardSummaryWorkflow {
	
	public static List<String> componentsInformation = new ArrayList<String>();
	
	public static void excelReportMentionEmailForwardSummaryTemplateWorkflow(WebDriver driver) throws Exception {
		try {
...
//section names
			...
			WebElement template = driver
					.findElement(By.xpath("//h3[contains(text(),'Email Forward Summary - Mention')]"));
