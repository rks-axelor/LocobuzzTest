...
public class AllMentionGooglePlayStoreWorkflowProcess {
	...
	public static void allMentionsWorkFlow(WebDriver driver, String channel) throws Exception {
		try {
			...
			ticketInformation.add(0, "AllMentions Google Play Store WorkFlow");
...
//googleplaystore logo
			WebElement imageIcon = driver.findElement(By.xpath(
					"((//div[@id='socialBox'])[2]//following::img[@src='assets/images/channel-logos/playstore.svg'])[1]"));
			if (imageIcon.isDisplayed()) {
				System.out.println("Google play store image is displayed");

			} else {
				System.out.println("Google play store image is not  displayed");

			}

			ticketInformation.add(1, "Google Play Store");

//imagename
			WebElement ticketName = driver.findElement(
					By.xpath("((//div[@id='socialBox'])[2]//following::span[contains(text(),'PlayStore')])[1]"));
...
//username
			WebElement userName = driver.findElement(By.xpath("((//div[@id='socialBox'])[2]//following::a)[1]"));
...
//brandname
			WebElement brandName = driver.findElement(
					By.xpath("((//div[@id='socialBox'])[2]//following::div[@class='post__pill nowrap'])[1]"));
...
//time
			WebElement timeScheduleIcon = driver.findElement(
					By.xpath("((//div[@id='socialBox'])[2]//following::mat-icon[contains(text(),'schedule')])[1]"));
			WebElement dateTime = driver.findElement(By.xpath(
					"((//div[@id='socialBox'])[2]//following::span[@class='post__head--label text-nowrap'])[1]"));
...
//totalmentions
			WebElement totalMentionsIcon = driver.findElement(By.xpath(
					"((//div[@id='socialBox'])[2]//following::mat-icon[contains(text(),'question_answer')])[1]"));
			WebElement totalMentions = driver.findElement(
					By.xpath("((//div[@id='socialBox'])[2]//following::span[@class='post__foot--label'])[3]"));
...
//mentioncategory
			WebElement symbol = driver.findElement(By.xpath(
					"((//div[@id='socialBox'])[2]//following::mat-icon[contains(text(),'alternate_email')])[1]"));
			WebElement device = driver.findElement(
					By.xpath("((//div[@id='socialBox'])[2]//following::span[@class='post__foot--value'])[1]"));
	...
	public static void timeInformation(WebDriver driver) throws Exception {
		try {
			...
			WebElement dateTime = driver
					.findElement(By.xpath("((//div[@id='socialBox'])[2]//following::span[@class='post__head--label text-nowrap'])[1]"));
...
//Mentioned Time
			WebElement mentionedOnTime = driver.findElement(By.xpath(
					"((//div[@id='socialBox'])[2]//following::span[@class='custom__tooltip--label' and contains(text(),'Mentioned on:')]//following::span)[1]"));
