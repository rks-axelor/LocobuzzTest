...
//description
			...
			WebElement image5 = driver
					.findElement(By.xpath("(//span[contains(@class,'media-gallery__card--check')])[26]"));
			js.executeScript("arguments[0].click()", image5);
			Thread.sleep(2000);
			WebElement image6 = driver
					.findElement(By.xpath("(//span[contains(@class,'media-gallery__card--check')])[27]"));
			js.executeScript("arguments[0].click()", image6);
			Thread.sleep(2000);
			WebElement image7 = driver
					.findElement(By.xpath("(//span[contains(@class,'media-gallery__card--check')])[28]"));
			js.executeScript("arguments[0].click()", image7);
			Thread.sleep(2000);
			WebElement image8 = driver
					.findElement(By.xpath("(//span[contains(@class,'media-gallery__card--check')])[29]"));
			js.executeScript("arguments[0].click()", image8);
			Thread.sleep(2000);
			WebElement image9 = driver
					.findElement(By.xpath("(//span[contains(@class,'media-gallery__card--check')])[30]"));
			...
			WebElement images1 = driver
					.findElement(By.xpath("(//span[contains(@class,'media-gallery__card--check')])[32]"));
...
//add location
		/*	WebElement locationButton = driver.findElement(By.xpath("//mat-icon[contains(text(),' location_on')]"));
			...
			Thread.sleep(5000);
			WebElement selectLocation = driver.findElement(By.xpath("//p[contains(text(),'ACE Engineering Academy')]"));
