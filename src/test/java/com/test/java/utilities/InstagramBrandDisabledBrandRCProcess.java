...
public class InstagramBrandDisabledBrandRCProcess {
...
//ticket information
	public static void ticketTabVerification(WebDriver driver, String channel) throws Exception {
		try {
			...
			ticketInformation.add(0, "Instagram Ticket Brand Disabled  WorkFlow For Brand");
...
// instagramlogo
			WebElement imageIcon = driver.findElement(By.xpath("//img[@src='/assets/images/channel-logos/insta_dm.svg']"));
			if (imageIcon.isDisplayed()) {
				System.out.println("Instagram Image displayed successfully");
			} else {
				System.out.println("Instagram Image not displayed");
...
//ReplyType 
			...
			if(replyCloseButton.isDisplayed() && replyOnHoldButton.isDisplayed()) {
				System.out.println("All reply types are displayed");
			}
			else {
				System.out.println("All reply types are not displayed");
