...
public class LocobuzzAWALinkedinPPTDownloadWorkflow {

	public static List<String> componentsInformation = new ArrayList<String>();

	public static void pptDownloadNativeForLinkedin(WebDriver driver) throws Exception {
		try {

			Thread.sleep(3000);
			JavascriptExecutor js = (JavascriptExecutor) driver;

			WebElement linkedin = driver.findElement(By.xpath("//span[@class='pl-7' and text()='Linkedin']"));
...
//search the element
			...
			Thread.sleep(5000);
			WebElement searchpost1=driver.findElement(By.xpath("//input[@placeholder='Search Keywords']"));
			searchpost.sendKeys("escalated");
			Thread.sleep(3000);
...
//ppt
			...
			pptDownloadImageForLinkedin(driver);
	...
	public static void pptDownloadImageForLinkedin(WebDriver driver) throws Exception {
		try {
