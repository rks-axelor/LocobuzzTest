...
public class ExcelReportMentionMentionsTemplateWorkflow {

	public static List<String> componentsInformation = new ArrayList<String>();

	public static void excelReportMentionMentionsTemplateWorkflow(WebDriver driver) throws Exception {
		try {
...
//section names
			...
			WebElement mentions = driver.findElement(By.xpath("(//h3[contains(text(),'Mentions')])[1]"));
			js.executeScript("arguments[0].click()", mentions);
			Thread.sleep(3000);

//select the brand
			WebElement selectBrand = driver.findElement(By.xpath("(//span[@class='brandselect__image--circle'])[1]"));
			js.executeScript("arguments[0].click()", selectBrand);
			Thread.sleep(3000);
			WebElement selectBrand1 = driver.findElement(By.xpath("(//span[@class='brandselect__image--circle'])[2]"));
...
//search
			...
			WebElement column=driver.findElement(By.xpath("(//span[contains(text(),'Location')])[1]"));
...
//save
			...
			templateName.sendKeys("template51");
	...
	public static void scheduleProcess(WebDriver driver) throws Exception {
		try {
			...
			WebElement selectOption = driver
					.findElement(By.xpath("//span[@class='mat-option-text' and text()=' Daily']"));
			...
			WebElement selectDuration = driver
					.findElement(By.xpath("//span[@class='mat-option-text' and text()='Today']"));
			js.executeScript("arguments[0].click()", selectDuration);
			Thread.sleep(3000);
			WebElement scheduleDay = driver
					.findElement(By.xpath("//input[@formcontrolname='scheduleDateTimeControl']"));
			js.executeScript("arguments[0].click()", scheduleDay);
			Thread.sleep(3000);
			WebElement date=driver.findElement(By.xpath("((//div[@class='calendar-table'])[1]//following::span[contains(text(),'6')])[1]"));
			...
			Thread.sleep(3000);
			WebElement timeZone=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-arrow-wrapper')])[4]"));
			...
			search.sendKeys("colombo");
			WebElement selectTimeZone=driver.findElement(By.xpath("//span[@class='mat-option-text' and text()='(GMT+05:30:00) Asia/Colombo']"));
...
//tickets and mentions
			...
			Thread.sleep(3000);
			WebElement selectStatus=driver.findElement(By.xpath("//span[@class='mat-option-text' and text()=' Open Tickets ']"));
