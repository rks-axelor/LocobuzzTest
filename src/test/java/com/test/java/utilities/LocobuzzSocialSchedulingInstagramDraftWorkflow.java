...
public class LocobuzzSocialSchedulingInstagramDraftWorkflow {
	
	public static List<String> componentsInformation = new ArrayList<String>();
	
	public static void socialSchedulingInstagramWorkflow(WebDriver driver) throws Exception {
		try {
...
//verifying the right side
			WebElement channelName=driver.findElement(By.xpath("//div[@class='mat-tab-label-content' and text()=' Instagram(1) ']"));
...
//description
			...
			WebElement image1 = driver
					.findElement(By.xpath("(//span[contains(@class,'media-gallery__card--check')])[5]"));
...
//attach button
			...
			Thread.sleep(2000);
			System.out.println("Instagram  images are uploaded");
...
//save draft
			...
			search1.sendKeys("It is a long established fact that a reader will be distracted by the readable content");
...
//relative fields
			...
			//WebElement data = driver.findElement(By.xpath("(//div[contains(@class,'chartcomponent')])[2]"));
...
//postlabel
			...
			js.executeScript("arguments[0].click()", searchButton1);
			Thread.sleep(3000);
			WebElement selectLabel=driver.findElement(By.xpath("//span[@class='mat-checkbox-label' and text()=' insta ']"));
