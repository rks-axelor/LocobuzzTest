...
public class AllMentionLinkedinWorkflowProcess {
	...
	public static void allMentionsWorkFlow(WebDriver driver, String channel) throws Exception {
		try {
			...
			ticketInformation.add(0, "AllMentions LinkedIn WorkFlow");
...
//Linkedinlogo
			WebElement imageIcon = driver
					.findElement(By.xpath("(//img[@src='/assets/images/channel-logos/linkedin.svg'])"));
			...
			ticketInformation.add(1, "LinkedIn");
...
//brandname
			WebElement brandName = driver.findElement(By.xpath("(//div[@id='socialBox'])[2]//following::div[@class='post__pill nowrap']"));
...
//time
			WebElement timeScheduleIcon = driver.findElement(By.xpath("(//div[@id='socialBox'])[2]//following::mat-icon[@aria-label='schedule icon']"));
			WebElement dateTime = driver
					.findElement(By.xpath("(//div[@id='socialBox'])[2]//following::mat-icon[@aria-label='schedule icon']//following::span[1]"));
...
//ticketid
			...
			WebElement ticketId = driver
					.findElement(By.xpath("(//mat-icon[contains(text(),'local_activity')])[4]//following::span[1]"));
