...
public class OpenDetailsInstagramTicketWorkflowProcess {
...
// priority
			...
			WebElement priority = driver.findElement(By.xpath("(//span[@class='post__foot--label colored__main-text'])[1]"));
...
//ticket Status
				...
				WebElement ticketStatus1 = driver.findElement(By.xpath("(//span[contains(@class,'post__foot--label')])[3]"));
