...
public class WhatsAppChatbotCannedResponse {
...
//tickets tab
			...
			WebElement ticketsTab = driver
					.findElement(By.xpath("//span[@class='header__tabs--label' and text()='Tickets'][1]"));
			...
			Thread.sleep(2000);
			WebElement assignUser = driver.findElement(By.xpath("//span[@class='autocomplete-option__item--label' and text()='Sharwin Kailashi']"));
			...
			WebElement SearchButton =driver.findElement(By.xpath("(//mat-icon[contains(text(),'search')])[1]"));
			js.executeScript("arguments[0].click()",SearchButton );
			//driver.findElement(By.xpath("//input[@id='post-search-input']")).sendKeys("Komal");
			Thread.sleep(2000);
			//js.executeScript("arguments[0].click()",SearchButton );
			...
			// WhatsApp messenger logo
						WebElement WebsiteLogo = driver.findElement(By.xpath("//img[contains(@class,'chatbot__head--icon') and@src='/assets/images/channelicons/WebsiteChatBot.svg']"));
						//js.executeScript("arguments[0].click()",WebsiteLogo );
						
						if (WebsiteLogo.isDisplayed()) {
							System.out.println("WebsiteLogo Messenger logo is displayed");
						} else {
							System.out.println("WebsiteLogo Messenger logo is not displayed");
						}
						js.executeScript("arguments[0].click()",WebsiteLogo);
						Thread.sleep(2000);
						...
						// username
						WebElement username = driver.findElement(By.xpath("(//span[contains(text(),'Komal')])"));
			...
			//canned responses
						...
						WebElement selectResponseCategory = driver.findElement(By.xpath("(//span[@class='mat-option-text'])[2]"));
			...
			//close button
						...
						WebElement moreButton1 = driver.findElement(By.xpath("//a[contains(text(),'More')]"));
						js.executeScript("arguments[0].click()", moreButton1);
						Thread.sleep(2000);
			...
			public static void ticketTabVerification(WebDriver driver, String channel) throws Exception {
				try {
					...
					ticketInformation.add(0, "WhatsApp Ticket Chatbot");

		// WhatsApp logo
					
					WebElement imageIcon = driver
							.findElement(By.xpath("//img[@src='/assets/images/channelicons/WebsiteChatBot.svg']"));
					if (imageIcon.isDisplayed()) {
						System.out.println("WhatsApp Image displayed successfully");
					} else {
						System.out.println("WhatsApp Image not displayed");
					}

					ticketInformation.add(1, "WhatsApp");
		...
		//close button
			...
			public static void verifyClosedTicket(WebDriver driver, String ticketIDValue) throws Exception {
				try {
					...
					WebElement closedTickets = driver.findElement(By.xpath("//a[contains(text(),'Closed Tickets ')]"));
					closedTickets.click();
					Thread.sleep(2000);
		//search for ticket			
					WebDriverWait wait = new WebDriverWait(driver, 10);
		...
		// ticketclosed status
					WebElement ticketStatusIcon = driver.findElement(By.xpath("(//mat-icon[contains(text(),'folder')and@class='mat-icon notranslate material-icons-outlined post__foot--icon colored__red mat-icon-no-color'])[1]"));
					WebElement ticketStatus = driver.findElement(By.xpath("(//span[@class='post__foot--label'])[3]"));
					...
					//driver.get("https://locobuzzng-atest.locobuzz.com/");
