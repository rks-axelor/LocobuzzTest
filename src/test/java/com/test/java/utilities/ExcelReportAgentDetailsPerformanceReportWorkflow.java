...
public class ExcelReportAgentDetailsPerformanceReportWorkflow {
	
	public static List<String> componentsInformation = new ArrayList<String>();
	
	public static void excelReportAgentDetailsPerformanceReportTemplateWorkflow(WebDriver driver) throws Exception {
		try {
...
//section name
			...
			WebElement template = driver.findElement(By.xpath("//h3[contains(text(),'Agent Performance Report')]"));
...
//save
			...
			templateName.sendKeys("template47");
	...
	public static void scheduleProcess(WebDriver driver) throws Exception {
		try {
			...
			Thread.sleep(3000);
			WebElement dayList=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-arrow-wrapper')])[4]"));
			js.executeScript("arguments[0].click()", dayList);
			Thread.sleep(3000);
			WebElement selectDays=driver.findElement(By.xpath("//span[@class='mat-option-text' and text()=' Last 2 days']"));
			...
			WebElement selectDate = driver.findElement(
					By.xpath("((//div[@class='calendar-table'])[1]//following::span[contains(text(),'12')])[1]"));
...
//tickets and mentions
			...
			Thread.sleep(3000);
			WebElement ticketStatus=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-value')])[2]"));
			...
			WebElement priority=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-value')])[9]"));
