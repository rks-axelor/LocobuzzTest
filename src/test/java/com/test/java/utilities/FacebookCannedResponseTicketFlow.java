...
public class FacebookCannedResponseTicketFlow {
...
//ticket information
	public static void ticketTabVerification(WebDriver driver, String channel) throws Exception {
		try {
			...
			ticketInformation.add(0, "Facebook Ticket Canned Response");
...
//canned response process
			...
			WebElement selectResponseCategory = driver.findElement(By.xpath("(//span[contains(text(),'Test6')])"));
