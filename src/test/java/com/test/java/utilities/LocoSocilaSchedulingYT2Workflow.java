...
public class LocoSocilaSchedulingYT2Workflow {
...
//Select social profile(s) to post	
    ...
    Thread.sleep(3000);
	WebElement selecttwhandle1=driver.findElement(By.xpath("(//span[contains(text(),'@Kalyan Chinni')])[2]"));
...
//Description For
	...
	System.out.println("Description For Your Post is displayed");
	else 
	System.out.println("Description For Your Post is not displayed");
	Thread.sleep(3000);
...
//Draft Workflow
    ...
    Action actionb = actionsb.sendKeys(searchbyPC, "YouTube allows users to upload videos, view them, rate them with likes and dislikes").build();
    actionb.perform();
	Thread.sleep(3000);
