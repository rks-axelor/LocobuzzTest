...
public class LocobuzzKeywordConfigRealTimeNewsBlogsAdvanceWorkflow {
...
//account session Button
	...
	public static void keywordConfigurationNewsBlogsProcess(WebDriver driver) throws Exception {
		try {
...
//group name
			...
			groupName.sendKeys("NewsBlog");
			Thread.sleep(2000);

//select channel
			WebElement selectChannel = driver
					.findElement(By.xpath("(//span[contains(@class,'mat-checkbox-inner-container')])[7]"));
...
//query builder
			WebElement queryBuilder = driver.findElement(By.xpath("//span[contains(text(),'Advance Query Builder')]"));
			js.executeScript("arguments[0].click()", queryBuilder);
			Thread.sleep(3000);
			
//outside toggles
			WebElement outsideTogglesButton = driver
					.findElement(By.xpath("(//span[@class='mat-button-toggle-label-content' and text()='AND'])[1]"));
			js.executeScript("arguments[0].click()", outsideTogglesButton);
			Thread.sleep(3000);

//inside toggles
			WebElement insideTogglesButton = driver
					.findElement(By.xpath("(//span[@class='mat-button-toggle-label-content' and text()='OR'])[2]"));
			js.executeScript("arguments[0].click()", insideTogglesButton);
			Thread.sleep(3000);
			
//select attribute
			WebElement arrow1=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-arrow-wrapper')])[5]"));
			js.executeScript("arguments[0].click()", arrow1);
			Thread.sleep(3000);
			WebElement selectAttribute=driver.findElement(By.xpath("(//span[contains(text(),' Keywords ')])[2]"));
			...
			Thread.sleep(3000);
			WebElement selectOperator=driver.findElement(By.xpath("//span[contains(text(),' Should Contain ')]"));
			js.executeScript("arguments[0].click()", selectOperator);
			Thread.sleep(3000);
			
//keywords
			WebElement keywords=driver.findElement(By.xpath("//input[@placeholder='Enter keywords']"));
			keywords.sendKeys("readers");
			keywords.sendKeys(Keys.ENTER);
			keywords.sendKeys("how many blogs");
			keywords.sendKeys(Keys.ENTER);
			
//select other attribute
			WebElement attibuteButton=driver.findElement(By.xpath("//a[contains(text(),'+ Add Attribute')]"));
			js.executeScript("arguments[0].click()", attibuteButton);
			Thread.sleep(3000);
			
			WebElement arrow3=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-arrow-wrapper')])[7]"));
			js.executeScript("arguments[0].click()", arrow3);
			Thread.sleep(3000);
			WebElement selectAttribute1=driver.findElement(By.xpath("(//span[contains(text(),' Keywords ')])[2]"));
			js.executeScript("arguments[0].click()", selectAttribute1);
			Thread.sleep(3000);
			WebElement arrow4=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-arrow-wrapper')])[8]"));
			js.executeScript("arguments[0].click()", arrow4);
			Thread.sleep(3000);
			WebElement selectOperator1=driver.findElement(By.xpath("//span[contains(text(),' Should Contain ')]"));
			js.executeScript("arguments[0].click()", selectOperator1);
			Thread.sleep(3000);
			
//keywords
			WebElement keywords1=driver.findElement(By.xpath("(//input[@placeholder='Enter keywords'])[2]"));
			keywords1.sendKeys("headline");
			keywords1.sendKeys(Keys.ENTER);
			keywords1.sendKeys("news");
			keywords1.sendKeys(Keys.ENTER);
...
//search group name
			...
			searchGroupName.sendKeys("NewsBlog");
