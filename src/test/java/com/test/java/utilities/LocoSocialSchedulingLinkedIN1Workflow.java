...
public class LocoSocialSchedulingLinkedIN1Workflow {
...
//Select social profile(s) to post	
	...
	WebElement selecttwhandle=driver.findElement(By.xpath("(//span[contains(text(),'@komal mali')])"));
...
//Select 4 Images
	...
	Thread.sleep(1000);
	WebElement addimages3=driver.findElement(By.xpath("(//span[contains(@class,'media-gallery')])[7]"));
    js.executeScript("arguments[0].click()", addimages3);
	Thread.sleep(1000);
	WebElement addimages4=driver.findElement(By.xpath("(//span[contains(@class,'media-gallery')])[8]"));
    js.executeScript("arguments[0].click()", addimages4);
	Thread.sleep(1000);
	WebElement addimages5=driver.findElement(By.xpath("(//span[contains(@class,'media-gallery')])[1]"));
...
//Checking Draft Workflow
    ...
    Action actionb = actionsb.sendKeys(searchbyPC, "LinkedIn (/lɪŋktˈɪn/) is an American business").build();
    actionb.perform();
	Thread.sleep(1000);
...
//LinkedIN logo1
  /*  Thread.sleep(10000);
  	WebElement youtube = driver.findElement(By.xpath("//img[@src='/assets/images/channel-logos/linkedin.svg']"));		
...
//Delete Post
     ...
     Thread.sleep(3000);
     WebElement deletefrmLB=driver.findElement(By.xpath("//span[contains(text(),'Delete from Locobuzz')] "));
...
WebElement Logo1 = wait.until(ExpectedConditions
		.visibilityOfElementLocated(By.xpath("//img[@src='/assets/images/channel-logos/linkedin.svg']")));
//LinkedIN logo1
	WebElement imageIcon = driver.findElement(By.xpath("//img[@src='/assets/images/channel-logos/linkedin.svg']"));		
	if (imageIcon.isDisplayed()) {
	System.out.println("LinkedIN Image displayed successfully");
