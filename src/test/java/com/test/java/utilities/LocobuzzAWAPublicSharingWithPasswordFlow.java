...
public class LocobuzzAWAPublicSharingWithPasswordFlow {
	...
	public static void publicLinkSharing(WebDriver driver) throws Exception {
		try {
			...
			dashboardName.sendKeys("testing3");
			Thread.sleep(3000);

			WebElement dashboardDescription = driver
					.findElement(By.xpath("(//input[@class='ant-input border-radius-4'])[2]"));
			dashboardDescription.sendKeys("Testing for public link with password");
			Thread.sleep(3000);
...
//open link generator
			...
			WebElement passwdProtected = driver.findElement(By.xpath("(//input[@class='ant-radio-input'])[2]"));
			js.executeScript("arguments[0].click()", passwdProtected);
			Thread.sleep(5000);

			WebElement passwd = driver.findElement(By.xpath("(//input[@id='CreatePassword'])"));
			...
			WebElement shareid = driver.findElement(By.xpath("//input[@id='SharedWith']"));
			...
			WebElement passwd1 = driver.findElement(By.xpath("//input[@placeholder='Password']"));
			passwd1.sendKeys("Test@123");
			Thread.sleep(5000);
