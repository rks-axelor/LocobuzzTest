...
public class OpenDetailsTwitterBrandEnabledBrandRejectProcess {
...
//rejecting the ticket
			...
			WebElement rejectTicket=driver.findElement(By.xpath("(//mat-icon[contains(text(),'highlight_off')])[2]"));
			js.executeScript("arguments[0].click()", rejectTicket);
			Thread.sleep(2000);
...
//ReplyType 
			...
			replyFlow(driver, replyRejectButtonValue, channel);
