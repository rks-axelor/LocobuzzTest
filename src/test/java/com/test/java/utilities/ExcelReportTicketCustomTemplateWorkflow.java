...
public class ExcelReportTicketCustomTemplateWorkflow {

	public static List<String> componentsInformation = new ArrayList<String>();

	public static void excelReportTicketCustomeTemplateWorkflow(WebDriver driver) throws Exception {
		try {
...
//Add Columns
			WebElement addColumn1 = driver.findElement(By.xpath(
					"//span[@class='mat-tooltip-trigger list__label text-overflow' and text()='Upper Category']"));
			js.executeScript("arguments[0].click()", addColumn1);
			Thread.sleep(2000);
			WebElement addColumn2 = driver.findElement(
					By.xpath("//span[@class='mat-tooltip-trigger list__label text-overflow' and text()='Author']"));
			js.executeScript("arguments[0].click()", addColumn2);
			Thread.sleep(2000);
			WebElement addColumn3 = driver.findElement(
					By.xpath("//span[@class='mat-tooltip-trigger list__label text-overflow' and text()='Country']"));
...
//search
			...
			search1.sendKeys("author");
			WebElement searchButton1=driver.findElement(By.xpath("(//mat-icon[contains(text(),'search')])[4]"));
...
//template name
			...
			templateName.sendKeys("template27");
...
//change name
		/*	WebElement changeName = driver.findElement(By.xpath("(//span[contains(text(),'Name')])[2]"));
			Actions action = new Actions(driver);
			action.moveToElement(changeName).perform();
			WebElement edit = driver.findElement(By.xpath("(//mat-icon[contains(text(),'edit')])[4]"));
			action.moveToElement(edit);
			action.click().build().perform();
			WebElement nameBox = driver.findElement(By.xpath("//input[contains(@class,'d-inline-block p-0')]"));
			//nameBox.clear();
			//Thread.sleep(2000);
			//WebElement nameBox1 = driver.findElement(By.xpath("//input[contains(@class,'d-inline-block p-0')]"));
			nameBox.sendKeys(":kalyan");
			//nameBox.sendKeys(Keys.ENTER);
			Thread.sleep(1000);
			WebElement space=driver.findElement(By.xpath("(//div[@class='columns-drag'])[2]"));
			action.moveToElement(space);
			action.click().build().perform();
			//action.space.contextClick().build().perform();*/
			
//Add Columns
			WebElement addColumn1 = driver.findElement(By.xpath(
					"//span[@class='mat-tooltip-trigger list__label text-overflow' and text()='Phone Number']"));
			js.executeScript("arguments[0].click()", addColumn1);
			Thread.sleep(2000);
...
//tickets and mentions
			...
			Thread.sleep(3000);
			WebElement sla=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-value')])[4]"));
			js.executeScript("arguments[0].click()", sla);
			Thread.sleep(3000);
			WebElement selectSla=driver.findElement(By.xpath("//span[@class='mat-option-text' and text()=' SLA Already Breached ']"));
			...
			Thread.sleep(3000);
			WebElement selectPriority=driver.findElement(By.xpath("(//span[@class='mat-option-text'])//div[contains(text(),'Urgent')]"));
