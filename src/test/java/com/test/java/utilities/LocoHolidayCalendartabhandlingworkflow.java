...
public class LocoHolidayCalendartabhandlingworkflow {
...
//Connect Via Google Calendar Field	
			//WebElement UserroAgent1 = driver.findElement(By.xpath("//div[contains(text(),'Agent')]"));
			...
			if(!windowHandle.equals(parentWindowHandle)) {
				...
				//driver.findElement(By.xpath("//div[contains(text(),'Email or phone')]")).sendKeys("komal.mali@locobuzz.com");
							...
							Action action = actions.sendKeys(password, "loco@123").build();
					        action.perform();
					        Thread.sleep(5000);
			...
			js.executeScript("arguments[0].click()",selectacc );
			Thread.sleep(5000);
			WebElement password = driver.findElement(By.xpath("//div[contains(text(),'Enter your password')]"));
			js.executeScript("arguments[0].click()",password );
			Thread.sleep(5000);
