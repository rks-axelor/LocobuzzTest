...
public class LocoSocialSchedulingLinkedIN4Workflow {
...
// Brandlogin
    BrandgoingSocialSchedulingSection(driver);
 	Thread.sleep(5000);
...
//Search By Post Content	
    ...
    Action actionc = actionsc.sendKeys(searchbyPC1, "LinkedIn allows members (both workers and employers) to create profiles").build();
    actionc.perform();
 	Thread.sleep(3000);
 	WebElement search2=driver.findElement(By.xpath("//mat-icon[contains(text(),'search')]"));
    js.executeScript("arguments[0].click()", search2);
 	Thread.sleep(3000);
//Going in Rejected tab from Awaiting 	
//Verify in Rejected Tab 
    WebElement Rejectedtab=driver.findElement(By.xpath("(//div[contains(@class,'mat-tab-label-content')])[4]"));
    Thread.sleep(3000);
  	js.executeScript("arguments[0].click()", Rejectedtab);
    Thread.sleep(5000);
    RejectedPostTabVerification(driver);
    Thread.sleep(3000);
...
//Approve and Reject Button
	...
	Thread.sleep(3000);
	WebElement rejectconfirm = driver.findElement(By.xpath("(//span[contains(text(),'Reject')])[2]"));
	js.executeScript("arguments[0].click()", rejectconfirm);
	Thread.sleep(5000);
...
public static void RejectedPostTabVerification(WebDriver driver) throws Exception {
try {
Thread.sleep(3000);
JavascriptExecutor js = (JavascriptExecutor) driver;
//LinkedIN logo
	...
	Thread.sleep(3000);			
//Post Status
   WebElement ticketName1 = driver.findElement(By.xpath("(//p[contains(text(),'Rejected')])[1]"));
...
//Tag Field	
	...
	System.out.println("Tag field is displayed"+labelnames.getText());
	} else {
...
//Delete post
	...
	Thread.sleep(1000);
	WebElement Deleteconfirm = driver.findElement(By.xpath("( //span[contains(text(),'Delete')])[2]"));	
...
public static void BrandgoingSocialSchedulingSection(WebDriver driver) throws Exception {
try {
...
//social Scheduling 
    ...
    js.executeScript("arguments[0].scrollIntoView()", socialSchedulingLogo);
    WebElement socialSchedulingLabel=driver.findElement(By.xpath("//span[contains(text(),' Social Scheduling')]"));
    WebElement pushpin=driver.findElement(By.xpath("(//mat-icon[contains(text(),'push_pin')])[5]"));
    if(socialSchedulingLogo.isDisplayed()&&socialSchedulingLabel.isDisplayed()&&pushpin.isDisplayed()) {
    System.out.println("Social Scheduling logo and label are displayed");
    componentsInformation.add(0, "Present");
    }
