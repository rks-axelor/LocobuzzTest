...
public class InstagramOldTicketWorkflowProcess {

	public static String ticketIDValue, idValue;
	public static List<String> ticketInformation = new ArrayList<String>();

	public static void makeProcess(WebDriver driver, String channel) throws Exception {
		try {
...
// apply brand
			WebElement brandTab = driver.findElement(By.xpath("(//span[contains(text(),' All ')])[2]"));
			...
			searchBrand.sendKeys("medlife test");
			WebElement brandName = driver
					.findElement(By.xpath("//span[@class='mat-checkbox-label' and text()=' Medlife test ']"));
...
// duration
			WebElement durationTab = driver.findElement(By.xpath("(//input[@data-placeholder='Select Duration'])[2]"));
			js.executeScript("arguments[0].click()", durationTab);
			Thread.sleep(3000);
			WebElement selectDate = driver
					.findElement(By.xpath("(//button[@type='button' and text()='Last 30 Days'])[2]"));
			js.executeScript("arguments[0].click()", selectDate);
			Thread.sleep(3000);
			WebElement doneButton = driver.findElement(By.xpath("(//button[@type='button' and text()='Done'])[2]"));
			js.executeScript("arguments[0].click()", doneButton);
			Thread.sleep(3000);

			CommonFunctions.filter(driver, channel);
...
// sort
			...
			WebElement button = driver
					.findElement(By.xpath("//span[@class='mat-radio-label-content' and text()='Ascending']"));
...
//select id
			WebElement selectingId = driver.findElement(By.xpath(
					"((//div[@id='socialBox'])[1]//mat-icon[contains(text(),'local_activity')])[1]//following::span[1]"));
			idValue = selectingId.getText();
			System.out.println("Ticket ID: " + idValue);
...
// imagename
			...
			WebElement ticketName = driver
					.findElement(By.xpath("//span[contains(@class,'mat-tooltip-trigger channel__label')]"));
...
// username
			...
			WebElement username = driver.findElement(
					By.xpath("//span[contains(@class,'mat-tooltip-trigger channel__label')]//following::a[1]"));
...
// priority
			...
			WebElement priority = driver
					.findElement(By.xpath("(//span[@class='post__foot--label colored__main-text'])[1]"));
...
//Awaiting for customer
			 ...
			 * )) { WebElement autoClosure = driver .findElement(By.
			 * xpath("//span[@class='mat-button-wrapper' and contains(text(),'No')]"));
			...
			if (replyType.trim().equalsIgnoreCase("Reply & Awaiting response from Customer")) {
				WebElement autoClosure = driver
						.findElement(By.xpath("//span[@class='mat-button-wrapper' and contains(text(),' Yes ')]"));
				js.executeScript("arguments[0].click()", autoClosure);
...
//ticket Status
				...
				WebElement ticketStatus1 = driver
						.findElement(By.xpath("(//span[contains(@class,'post__foot--label')])[3]"));
