...
public class LocobuzzManageUserWorkflowForTeamLeader {
...
//camera
			...
			Robot rb=new Robot();
			rb.delay(2000);
			StringSelection ss=new StringSelection("C:\\Users\\admin\\Downloads\\image.png");
...
//role
			...
			Thread.sleep(3000);
			WebElement selectRole = driver.findElement(By.xpath("(//span[contains(text(),'Team Leader')])[2]"));
...
//select team name
			...
			Thread.sleep(3000);
			WebElement searchTeamName = driver.findElement(By.xpath("//input[@placeholder='Search team name']"));
			searchTeamName.sendKeys("kalyanteam");
			WebElement selectTeamName = driver.findElement(By.xpath("//span[contains(text(),'KalyanTeam')]"));
			js.executeScript("arguments[0].click()", selectTeamName);
			Thread.sleep(3000);

//select skills
			WebElement searchSkills = driver.findElement(By.xpath("//input[@placeholder='Search skills']"));
			searchSkills.click();
			//js.executeScript("arguments[0].click()", searchSkills);
			Thread.sleep(3000);
			WebElement skill = driver.findElement(By.xpath("//span[contains(text(),'psychiatrist')]"));
			js.executeScript("arguments[0].click()", skill);
			Thread.sleep(3000);
			WebElement skill1 = driver.findElement(By.xpath("//span[contains(text(),'physician')]"));
			js.executeScript("arguments[0].click()", skill1);
			Thread.sleep(3000);
			WebElement skill2 = driver.findElement(By.xpath("//span[contains(text(),'Test skill')]"));
			js.executeScript("arguments[0].click()", skill2);
			Thread.sleep(3000);
			WebElement skill3 = driver.findElement(By.xpath("//span[contains(text(),'Network Outage')]"));
			js.executeScript("arguments[0].click()", skill3);
			Thread.sleep(3000);
			WebElement skill4 = driver.findElement(By.xpath("//span[contains(text(),'tagged via category')]"));
			js.executeScript("arguments[0].click()", skill4);
			Thread.sleep(3000);
...
//channels and sub-channels
			WebElement searchChannels = driver.findElement(By.xpath("//input[@placeholder='Select Channels']"));
			js.executeScript("arguments[0].click()", searchChannels);
			Thread.sleep(3000);
			WebElement channel = driver
					.findElement(By.xpath("//span[@class='treeItem']//following::span[contains(text(),'App Store')]"));
			js.executeScript("arguments[0].click()", channel);
			Thread.sleep(3000);
			WebElement channel1 = driver
					.findElement(By.xpath("//span[@class='treeItem']//following::span[contains(text(),'ChatBot')]"));
			js.executeScript("arguments[0].click()", channel1);
			Thread.sleep(3000);
			WebElement channel2 = driver
					.findElement(By.xpath("//span[@class='treeItem']//following::span[contains(text(),'Facebook')]"));
			js.executeScript("arguments[0].click()", channel2);
			Thread.sleep(3000);
			WebElement channel3 = driver
					.findElement(By.xpath("//span[@class='treeItem']//following::span[contains(text(),'Instagram')]"));
			js.executeScript("arguments[0].click()", channel3);
			Thread.sleep(3000);
			WebElement channel4 = driver
					.findElement(By.xpath("//span[@class='treeItem']//following::span[contains(text(),'Twitter')]"));
			js.executeScript("arguments[0].click()", channel4);
			Thread.sleep(3000);
...
//platform access
			...
			WebElement platformInfo = driver
					.findElement(By.xpath("(//p[@class='text__light text__sm line-height-1.50 mb-10'])[7]"));
...
//platform properties
			...
			WebElement platformPropertiesSearchField = driver
					.findElement(By.xpath("(//div[contains(@class,'mat-form-field-wrapper')])[17]"));
...
//account settings options
			...
			if (accountSettingsHeading.isDisplayed() && accountSettingsOption1.isDisplayed()
					&& accountSettingsOption2.isDisplayed()) {
...
//search platform properties
			...
			searchProperties.sendKeys("share");
...
//contact number
			...
			contactNumber.clear();
			Thread.sleep(1000);
			contactNumber.sendKeys("9751867138");
			Thread.sleep(1000);
...
//select team
			...
			js.executeScript("arguments[0].click()", arrow);
			Thread.sleep(3000);
			WebElement selectTeam=driver.findElement(By.xpath("//span[contains(text(),'KalyanTeam')]"));
...
//select role
			WebElement arrow2 = driver.findElement(By.xpath("(//div[contains(@class,'mat-select-arrow-wrapper')])[6]"));
			js.executeScript("arguments[0].click()", arrow2);
			Thread.sleep(3000);

			WebElement selectRole = driver.findElement(
					By.xpath("(//span[@class='mat-option-text']//span[contains(text(),'Team Leader')])"));
			js.executeScript("arguments[0].click()", selectRole);
			Thread.sleep(3000);
