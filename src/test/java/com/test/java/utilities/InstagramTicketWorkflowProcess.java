...
public class InstagramTicketWorkflowProcess {
...
//tickets tab
			...
			// WebElement search=driver.findElement(By.xpath("(//mat-icon[contains(text(),'
			// search')])[1]"));
...
// imagename
			...
			WebElement ticketName = driver.findElement(By.xpath("(//span[contains(text(),'Instagram Messages')])[1]"));
...
// username 
			...
			WebElement username = driver
					.findElement(By.xpath("(//span[contains(text(),'Instagram Messages')])[1]//following::a[1]"));
