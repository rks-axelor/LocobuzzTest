...
public class OpenDetailsTwitterTicketWorkFlowProcess {
...
//Assigning
			...
			WebElement assignPerson = driver.findElement(By.xpath(
					"//mat-icon[contains(text(),'person')]//following::span[contains(text(),'Kalyanlive chinni')]"));
...
//Awaiting for customer
			 ...
			 * xpath("(//span[@class='mat-button-wrapper' and contains(text(),'No')])[3]"));
...
//ticket Status
				...
				WebElement ticketStatus1 = driver.findElement(By.xpath("(//span[contains(@class,'post__foot--label')])[5]"));
...
//Status Change
			...
			if (replyType.equalsIgnoreCase("Reply & Close")) {
				...
				ticketStatusAwaitFromCustomer.click();
			}
...
//verify Ticket status 
			WebElement openticketStatus = driver.findElement(By.xpath("(//span[contains(@class,'post__foot--label')])[5]"));
...
//priority			
			WebElement priorityIcon = driver.findElement(By.xpath("(//mat-icon[contains(text(),'low_priority')])[1]"));
			WebElement priority = driver.findElement(By.xpath("(//span[@class='post__foot--label colored__red--dark'])"));
