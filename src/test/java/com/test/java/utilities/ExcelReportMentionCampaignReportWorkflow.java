...
public class ExcelReportMentionCampaignReportWorkflow {
	
	public static List<String> componentsInformation = new ArrayList<String>();
	
	public static void excelReportMentionCampaignReportTemplateWorkflow(WebDriver driver) throws Exception {
		try {
...
//section names
			...
			WebElement template=driver.findElement(By.xpath("//h3[contains(text(),'Campaign Report')]"));
...
//select campaign
			WebElement campaign=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-arrow-wrapper')])[2]"));
			js.executeScript("arguments[0].click()", campaign);
			Thread.sleep(3000);
			WebElement selectCampaign=driver.findElement(By.xpath("//span[@class='mat-option-text' and text()='gun1']"));
...
//search
			...
			search1.sendKeys("Campaign Report");
