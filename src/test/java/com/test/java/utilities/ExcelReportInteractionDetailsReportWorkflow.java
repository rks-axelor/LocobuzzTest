...
public class ExcelReportInteractionDetailsReportWorkflow {

	public static List<String> componentsInformation = new ArrayList<String>();

	public static void excelReportInteractiondDetailsReportWorkflow(WebDriver driver) throws Exception {
		try {
...
//section names
			...
			WebElement interactionDetailReport = driver
					.findElement(By.xpath("//h3[contains(text(),'Interaction Detail Report')]"));
			js.executeScript("arguments[0].click()", interactionDetailReport);
			Thread.sleep(3000);
...
//search the brand
			...
			Thread.sleep(3000);
			WebElement selectDay = driver
					.findElement(By.xpath("(//button[@type='button' and text()='Last 7 Days'])[1]"));
...
//save
			...
			templateName.sendKeys("template092");
