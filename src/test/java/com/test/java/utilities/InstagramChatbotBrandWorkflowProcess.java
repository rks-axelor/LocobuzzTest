...
public class InstagramChatbotBrandWorkflowProcess {
...
// escalate
			...
			WebElement customerName = driver.findElement(
					By.xpath("//span[@class='autocomplete-option__item--label' and contains(text(),'kalyan brand')]"));
...
// rejecting the ticket
			...
			WebElement rejectingTicket = driver.findElement(By.xpath("//span[contains(text(),'Reject')]"));
			js.executeScript("arguments[0].click()", rejectingTicket);
			Thread.sleep(1000);
