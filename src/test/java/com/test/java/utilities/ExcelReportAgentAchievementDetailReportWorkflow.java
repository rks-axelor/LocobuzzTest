...
public class ExcelReportAgentAchievementDetailReportWorkflow {
	
	public static List<String> componentsInformation = new ArrayList<String>();
	
	public static void excelReportAgentAchievementDetailReportTemplateWorkflow(WebDriver driver) throws Exception {
		try {
...
//section name
			...
			WebElement template = driver.findElement(By.xpath("//h3[contains(text(),'Agent Achievement Detail Report ')]"));
...
//search
			...
			search1.sendKeys("Agent Achievement Detail Report");
