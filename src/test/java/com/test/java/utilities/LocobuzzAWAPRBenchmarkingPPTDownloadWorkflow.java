...
public class LocobuzzAWAPRBenchmarkingPPTDownloadWorkflow {

	public static List<String> componentsInformation = new ArrayList<String>();

	public static void pptDownloadNativeForPRBenchmarking(WebDriver driver) throws Exception {
		try {

			Thread.sleep(3000);
			JavascriptExecutor js = (JavascriptExecutor) driver;

			WebElement prBenchmark = driver.findElement(By.xpath("//span[@class='pl-7' and text()='PR Benchmarking']"));
			js.executeScript("arguments[0].scrollIntoView();", prBenchmark);
			js.executeScript("arguments[0].click()", prBenchmark);
			Thread.sleep(7000);
...
//ppt
			...
			pptDownloadImageForPRBenchmarking(driver);
	...
	public static void pptDownloadImageForPRBenchmarking(WebDriver driver) throws Exception {
		try {
