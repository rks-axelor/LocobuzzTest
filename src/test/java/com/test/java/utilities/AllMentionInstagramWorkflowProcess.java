...
public class AllMentionInstagramWorkflowProcess {
	...
	public static void allMentionsWorkFlow(WebDriver driver, String channel) throws Exception {
		...
		try {
			...
			ticketInformation.add(0, "AllMentions Instagram WorkFlow");
...
// imagename
			...
			WebElement ticketName = driver
					.findElement(By.xpath("(//span[contains(text(),'Instagram Messages')])"));
...
// username 
			...
			WebElement username = driver.findElement(By.xpath("(//span[contains(text(),'Instagram Messages')])//following::a[1]"));
...
// brandname
			...
			WebElement brandname = driver.findElement(By.xpath("(//div[@id='socialBox']//following::div[@class='post__pill nowrap'])[2]"));
...
//time
			...
			WebElement timeScheduleIcon = driver.findElement(By.xpath("//div[@id='socialBox']//following::mat-icon[@aria-label='schedule icon']"));
			WebElement dateTime = driver.findElement(By.xpath("//div[@id='socialBox']//following::mat-icon[@aria-label='schedule icon']//following::span[1]"));
...
//mention id
			...
			WebElement mentionID = driver.findElement(By.xpath(
					"(//mat-icon[contains(text(),'message')])[4]//following::span[1]"));
...
//total mentions
			WebElement totalMentions = driver
					.findElement(By.xpath("//div[@id='socialBox']//following::mat-icon[@aria-label='question answer']"));
			WebElement mentions = driver.findElement(By.xpath("//div[@id='socialBox']//following::mat-icon[@aria-label='question answer']//following::span[1]"));
...
//ticket id
			...
			WebElement ticketIcon = driver.findElement(By.xpath(
					"(//div[@id='socialBox']//following::mat-icon[contains(text(),'local_activity')])[1]"));
			WebElement ticketID = driver.findElement(By.xpath(
					"(//div[@id='socialBox']//following::mat-icon[contains(text(),'local_activity')])[1]//following::span[1]"));
...
//ticketstatus
			...
			WebElement ticketStatusIcon = driver.findElement(By.xpath("(//div[@id='socialBox']//following::mat-icon[contains(text(),'folder')])[1]"));
			WebElement ticketStatus = driver.findElement(By.xpath("(//div[@id='socialBox']//following::mat-icon[contains(text(),'folder')])[1]//following::span[1]"));
...
// priority
			WebElement priorityIcon = driver.findElement(By.xpath("(//div[@id='socialBox']//following::mat-icon[contains(text(),'low_priority')])[1]"));
			WebElement priority = driver.findElement(By.xpath("(//div[@id='socialBox']//following::mat-icon[contains(text(),'low_priority')])[1]//following::span[1]"));
...
// translate
			...
			WebElement languageName = driver.findElement(By.xpath("(//mat-icon[contains(text(),'translate')])[1]//following::span[1]"));
...
// mention category
			...
			WebElement symbol = driver.findElement(By.xpath("(//div[@id='socialBox']//following::mat-icon[contains(text(),'alternate_email')])"));
			WebElement device = driver.findElement(By.xpath("(//div[@id='socialBox']//following::mat-icon[contains(text(),'alternate_email')])//following::span[1]"));
