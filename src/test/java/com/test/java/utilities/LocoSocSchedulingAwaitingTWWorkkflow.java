...
//Select social profile(s) to post	
	...
	Thread.sleep(3000);
//	WebElement selecttwhandle2=driver.findElement(By.xpath("(//span[contains(text(),'Komal25169281')])[1]"));
	//js.executeScript("arguments[0].click()", selecttwhandle2);
	//Thread.sleep(3000);
	WebElement selecttwhandle3=driver.findElement(By.xpath("(//span[contains(text(),'@komal mali')])[1]"));
...
//Select 4 Images	
	...
	Thread.sleep(1000);
	/*WebElement addimages6=driver.findElement(By.xpath("(//span[contains(@class,'media-gallery')])[2]"));
