...
public class LocobuzzAdAccountsUIaccountVerification {
...
public static void verifyingChannelConfigAdaccountsUIComponents(WebDriver driver) throws Exception {
		try {
...
//Twitter Buissness Accounts
			...
			Thread.sleep(3000);
			WebElement closewindow1=driver.findElement(By.xpath("(//mat-icon[contains(text(),'close')])[1]"));
			js.executeScript("arguments[0].click()", closewindow1);
			Thread.sleep(3000);
