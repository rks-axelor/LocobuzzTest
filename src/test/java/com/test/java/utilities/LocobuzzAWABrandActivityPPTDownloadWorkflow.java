...
public class LocobuzzAWABrandActivityPPTDownloadWorkflow {

	public static List<String> componentsInformation = new ArrayList<String>();

	public static void pptDownloadNativeForBrandActivity(WebDriver driver) throws Exception {
		try {

			Thread.sleep(3000);
			JavascriptExecutor js = (JavascriptExecutor) driver;

			WebElement brandActivity = driver
					.findElement(By.xpath("//span[@class='pl-7' and text()='Brand Activity']"));
			js.executeScript("arguments[0].scrollIntoView();", brandActivity);
			js.executeScript("arguments[0].click()", brandActivity);
			Thread.sleep(7000);
...
//search the element
			...
			searchElement2.sendKeys("keyword");
			Thread.sleep(2000);
			WebElement keyword=driver.findElement(By.xpath("(//div[@class='ant-collapse-header']//div)[2]"));
			js.executeScript("arguments[0].click()", keyword);
			Thread.sleep(4000);
			WebElement searchkeyword=driver.findElement(By.xpath("//input[@placeholder='Search Keywords']"));
			searchkeyword.sendKeys("comment");
			Thread.sleep(3000);
...
//ppt
			...
			pptDownloadImageForBrandActivity(driver);
	...
	public static void pptDownloadImageForBrandActivity(WebDriver driver) throws Exception {
		try {
