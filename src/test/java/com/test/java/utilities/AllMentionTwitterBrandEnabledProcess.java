...
public class AllMentionTwitterBrandEnabledProcess {
...
// imagename
			...
			WebElement ticketName = driver
					.findElement(By.xpath("(//div[@id='socialBox'])[2]//span[contains(text(),'Found')]//following::span[1]"));
...
// username & userID
			...
			WebElement username = driver.findElement(By.xpath("(//div[@id='socialBox'])[2]//span[contains(text(),'Found')]//following::a[1]"));
...
// brandname
			...
			WebElement brandname = driver.findElement(By.xpath("((//div[@id='socialBox'])[2]//div[@class='post__pill nowrap'])[1]"));
...
// time
			...
			WebElement timeScheduleIcon = driver.findElement(By.xpath("((//div[@id='socialBox'])[2]//mat-icon[contains(text(),'schedule')])[1]"));
...
// mentionid
			...
			WebElement mentionIcon = driver.findElement(By.xpath("((//div[@id='socialBox'])[2]//mat-icon[contains(text(),'message')])[1]"));
			WebElement mentionID = driver.findElement(By.xpath("((//div[@id='socialBox'])[2]//span[@class='post__foot--label'])[1]"));
...
// ticket id
			WebElement ticketIcon = driver.findElement(By.xpath(
					"((//div[@id='socialBox'])[2]//following::mat-icon[contains(text(),'local_activity')])[1]"));
			WebElement ticketID = driver.findElement(By.xpath(
					"((//div[@id='socialBox'])[2]//following::span[@class='post__foot--label'])[2]"));
...
// ticketstatus
			...
			WebElement ticketStatus = driver.findElement(By.xpath("((//div[@id='socialBox'])[2]//span[@class='post__foot--label'])[4]"));
...
// priority
			...
			WebElement priority = driver.findElement(By.xpath("((//div[@id='socialBox'])[2]//span[@class='post__foot--label'])[5]"));
...
// translate
			...
			WebElement languageName = driver.findElement(By.xpath("((//div[@id='socialBox'])[2]//span[@class='post__foot--label'])[6]"));
...
// mention category
			...
			WebElement symbol = driver.findElement(By.xpath("((//div[@id='socialBox'])[2]//mat-icon[contains(text(),'alternate')])[1]"));
			WebElement device = driver.findElement(By.xpath("((//div[@id='socialBox'])[2]//span[@class='post__foot--value'])[1]"));
