...
public class ExcelReportPostPerformanceReportWorkflow {
	
	public static List<String> componentsInformation = new ArrayList<String>();
	
	public static void excelReportPostPerformanceReportTemplateWorkflow(WebDriver driver) throws Exception {
		try {
...
//section name
			WebElement sectionName = driver.findElement(By.xpath("//a[contains(text(),'Post Performance')]"));
			js.executeScript("arguments[0].click()", sectionName);
			Thread.sleep(3000);
			
			WebElement template = driver.findElement(By.xpath("//h3[contains(text(),'Post Performance')]"));
...
//others
			...
			Action action4 = actions2.sendKeys(Keys.ESCAPE).build();
			action4.perform();
