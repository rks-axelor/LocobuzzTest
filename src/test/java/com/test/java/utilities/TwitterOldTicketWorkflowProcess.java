...
public class TwitterOldTicketWorkflowProcess {
...
//apply brand
			...
			WebElement brandName = driver
					.findElement(By.xpath("//span[@class='mat-checkbox-label' and text()=' AJIO ']"));
...
//duration
			...
			WebElement selectDate = driver
					.findElement(By.xpath("(//button[@type='button' and text()='Last 7 Days'])[2]"));
...
//select id
			...
			// js.executeScript("arguments[0].click()", selectingId);
			// Thread.sleep(3000);
...
// mention category
			...
			WebElement device = driver.findElement(By.xpath("(//span[@class='post__foot--label'])[5]"));
...
// ticket Status
				...
				WebElement ticketStatus1 = driver
						.findElement(By.xpath("(//span[contains(@class,'post__foot--label')])[5]"));
...
//verify Ticket status 
			WebElement openticketStatus = driver.findElement(
					By.xpath("(//span[@class='post__foot--label ticketstatus__blue colored__locobuzz'])[1]"));
