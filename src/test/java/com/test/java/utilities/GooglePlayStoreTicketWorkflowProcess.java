...
public class GooglePlayStoreTicketWorkflowProcess {
...
//ticket information
	public static void ticketTabVerification(WebDriver driver, String channel) throws Exception {
		try {
			...
			ticketInformation.add(0, "Google Play Store Ticket WorkFlow");

//googleplaystorelogo
			WebElement imageIcon = driver
					.findElement(By.xpath("(//img[@src='assets/images/channel-logos/playstore.svg'])[1]"));
...
//imagename
			WebElement ticketName = driver.findElement(By.xpath("//span[contains(text(),'PlayStore')]"));
...
//username
			WebElement userName = driver.findElement(By.xpath("//span[contains(text(),'PlayStore')]//following::a[1]"));
...
//googleplaystore logo
			WebElement imageIcon = driver
					.findElement(By.xpath("//img[@src='assets/images/channel-logos/playstore.svg']"));
			if (imageIcon.isDisplayed()) {
				System.out.println("Google play store image is displayed");
			} else {
				System.out.println("Google play store image is not displayed");
...
//verify Ticket status 
			WebElement openticketStatus = driver.findElement(By.xpath("(//span[@class='post__foot--label'])[5]"));
