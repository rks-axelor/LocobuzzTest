...
public class TwitterBrandEnabledBrandRejectProcess {
...
// direct close
				...
				Thread.sleep(1000);
				WebElement closeWithNote = driver
						.findElement(By.xpath("//span[contains(text(),'Close With Note')]"));
...
//DateTime			
				...
				WebElement replyTextArea=driver.findElement(By.xpath("//textarea[@placeholder='Write direct close note here...']"));
				replyTextArea.sendKeys("Workflow processed" + " " + strDate);
...
// Rejecting the ticket
			...
			WebElement rejectedTicket = driver.findElement(By.xpath("(//span[contains(text(),'Reject')])[3]"));
