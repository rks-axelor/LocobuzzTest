...
public class LocoSchedulingFailedTwitterWorkflow {
...
//Compose Your Post	
    ...
    Action actiona = actionsa.sendKeys(addtext, "Demo Post on Tool and Social Media ").build();
    actiona.perform();
	Thread.sleep(1000);
    ...
    Thread.sleep(3000);
    WebElement history=driver.findElement(By.xpath("//li[contains(text(),'PhoneNumber')]"));
    ...
    Thread.sleep(3000);
    WebElement phno=driver.findElement(By.xpath("//li[contains(text(),' Automation Demo Field')]"));
    ...
    Thread.sleep(3000);
    WebElement website=driver.findElement(By.xpath("//li[contains(text(),' EmailAddress')]"));
...
//Select 4 Images	
	WebElement addimages1=driver.findElement(By.xpath("(//span[contains(@class,'media-gallery')])[6]"));
	...
	Thread.sleep(1000);
	System.out.println("Added images successfully");
	Thread.sleep(2000);
...
//Add Labels To Post
    ...
    Action action = actions.sendKeys(addnewlabel, "Scheduling Testing Category").sendKeys(Keys.ENTER).build();
    action.perform();
    Thread.sleep(5000);
...
//Verify in Published Tab
    Thread.sleep(5000);
    WebElement Publishedtab=driver.findElement(By.xpath("(//div[contains(@class,'mat-tab-label-content')])[6]"));
	...
	SamepostcreationFunction(driver);
}
catch(Exception e) {
e.printStackTrace();
throw e;
...
public static void SamepostcreationFunction(WebDriver driver) throws Exception {
try {
...
//Verify in Published Tab
  Thread.sleep(5000);
  WebElement Failedtab=driver.findElement(By.xpath("(//div[contains(@class,'mat-tab-label-content')])[8]"));
...
//Edit Functionality
  ...
  Thread.sleep(5000);
  WebElement addnewprofile = driver.findElement(By.xpath("(//span[contains(text(),'@komal mali')])[1]"));
  js.executeScript("arguments[0].click()", addnewprofile);
  Thread.sleep(5000);
  WebElement next1 = driver.findElement(By.xpath("(//span[contains(text(),'Next')])[1]"));
  ...
  WebElement nextclick1=driver.findElement(By.xpath("//span[contains(text(),'Next')]"));
	...
	Thread.sleep(1000);	
	WebElement number3=driver.findElement(By.xpath("//div[contains(text(),'Compose post')]"));
	if(number3.isDisplayed()) 
	System.out.println("Compose Post successfully done");
	else 
	System.out.println("Compose Post successfully is not done");
	Thread.sleep(2000);
...
//Add Labels To Post
  WebElement next4=driver.findElement(By.xpath("//span[contains(text(),'Next')]"));
  js.executeScript("arguments[0].click()", next4);
	Thread.sleep(1000);
	WebElement publish1=driver.findElement(By.xpath("(//span[contains(text(),'Publish')])[3]"));
	js.executeScript("arguments[0].click()", publish1);
  Thread.sleep(1000);
//Verify in Scheduled Tab 
  WebElement scheduledtab1=driver.findElement(By.xpath("(//div[contains(@class,'mat-tab-label-content')])[5]"));
  Thread.sleep(3000);
  js.executeScript("arguments[0].click()", scheduledtab1);
  Thread.sleep(15000);
  WebElement partialtab=driver.findElement(By.xpath("(//div[contains(@class,'mat-tab-label-content')])[7]"));
  Thread.sleep(3000);
  js.executeScript("arguments[0].click()", partialtab);
