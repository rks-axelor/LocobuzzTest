...
public class OpenDetailsTwitterBrandEnabledBrandOnHoldProcess {
...
//ticket information
	public static void ticketTabVerification(WebDriver driver, String channel) throws Exception {
		try {
			...
			ticketInformation.add(0, "Twitter Ticket Brand Enabled  WorkFlow For Brand");
...
// ticket Status
				...
				ticketInformation.add(20, ticketStatus1.getText());
				...
				ticketInformation.add(21, approvedTime.getText());
...
// assign
			...
			String assignNameValue = assignName.getText();
			ticketInformation.add(12, assignNameValue);
...
// ticketStatus
			...
			ticketInformation.add(13, ticketStatus.getText());
...
// mention category
			...
			ticketInformation.add(14, escalatedTimeValue);
...
// more
			WebElement moreButton = driver.findElement(By.xpath("(//mat-icon[contains(text(),'more_vert')])[2]"));
			js.executeScript("arguments[0].click()", moreButton);
			Thread.sleep(2000);
			WebElement escalateButton = driver.findElement(By.xpath("(//span[contains(text(),'Escalate')])[5]"));
...
// assign
			...
			String assignNameValue = assignName.getText();
			ticketInformation.add(15, assignNameValue);
...
// ticketstatus
			...
			ticketInformation.add(16, ticketStatus.getText());
...
// mention category
			...
			ticketInformation.add(17, escalatedTimeValue);
...
// reply post
			WebElement replyPostButton = driver.findElement(By.xpath("(//mat-icon[contains(text(),'reply ')])[2]"));
			js.executeScript("arguments[0].click()", replyPostButton);
			Thread.sleep(3000);
			replyType(driver, channel);
...
// logout
	...
	public static void replyType(WebDriver driver, String channel) throws Exception {
		try {
...
//ReplyType 
			...
			String replyOnHoldButtonValue = replyOnHoldButton.getText();
			System.out.println("Reply Type: " + replyOnHoldButtonValue);
			WebElement replyRejectButton = driver
					.findElement(By.xpath("//span[@class = 'mat-option-text' and contains(text(),'Reply & Reject ')]"));
			String replyRejectButtonValue = replyRejectButton.getText();
			System.out.println("Reply Type: " + replyRejectButtonValue);

			if (replyCloseButton.isDisplayed() && replyOnHoldButton.isDisplayed() && replyRejectButton.isDisplayed()) {
				System.out.println("All reply types are displayed");
			} else {
				System.out.println("All reply types are not displayed");
			}

			replyFlow(driver, replyOnHoldButtonValue, channel);
	...
	public static void replyFlow(WebDriver driver, String replyType, String channel) throws Exception {
		try {
...
//DateTime			
			...
			WebElement onholdTicketsButton = driver.findElement(By.xpath("//a[contains(text(),'On Hold ')]"));
			js.executeScript("arguments[0].click()", onholdTicketsButton);
			Thread.sleep(2000);
...
// check ticket status
			...
			System.out.println("Ticket Status: " + ticketStatusValue);
			if (ticketStatusIcon.isDisplayed() && ticketStatus.getText() != "") {
				System.out.println("TicketStatus is displayed");
			...
			ticketInformation.add(18, ticketStatus.getText());
			...
			String onHoldTimeValue = onHoldTime.getText();
			ticketInformation.add(19, onHoldTimeValue);
...
//open details
			...
			WebElement newTicketFilter1 = driver.findElement(By.xpath("(//span[contains(text(),'New Ticket Filter')])"));
			if (newTicketFilter1.isDisplayed()) {
				System.out.println("New Ticket Filter is displayed");
			} else {
				System.out.println("New Ticket Filter is not displayed");
			}
...
//approve process
			WebElement approveTicket=driver.findElement(By.xpath("(//mat-icon[contains(text(),'check_circle_outline')])[2]"));
			js.executeScript("arguments[0].click()", approveTicket);
			Thread.sleep(2000);
			WebElement textarea = driver.findElement(By.xpath("//textarea[contains(@class,'mat-input-element mat-form-field-autofill-control')]"));
			...
			js.executeScript("arguments[0].click()", newTicketFilter1);
...
// ticketclosed status
            ...
            ticketInformation.add(22, ticketStatus.getText());
			...
			ticketInformation.add(23, modifiedOnTime.getText());
			System.out.println("Modified On: " + modifiedOnTime.getText());
			
			Thread.sleep(2000);
			Action action1 = actions.sendKeys(Keys.ESCAPE).build();
			action.perform();
			CommonFunctions.writeUIComponentsToExcel(ticketInformation,"BrandEnabledStatusInformation");
