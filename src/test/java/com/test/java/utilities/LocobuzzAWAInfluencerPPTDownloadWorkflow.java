...
public class LocobuzzAWAInfluencerPPTDownloadWorkflow {
	
	public static List<String> componentsInformation = new ArrayList<String>();
	
	public static void pptDownloadNativeForInfluencer(WebDriver driver) throws Exception {
		try {
			
			Thread.sleep(3000);
			JavascriptExecutor js = (JavascriptExecutor) driver;
			
			WebElement influencer=driver.findElement(By.xpath("//span[@class='pl-7' and text()='Influencer']"));
...
//ppt
			...
			WebElement previewButton = driver.findElement(By.xpath("(//span[contains(text(),'Preview')])[3]"));
			...
			pptDownloadImageForInfluencer(driver);
	...
	public static void pptDownloadImageForInfluencer(WebDriver driver) throws Exception {
		try {
