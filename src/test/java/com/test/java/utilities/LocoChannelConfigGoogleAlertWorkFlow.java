...
public class LocoChannelConfigGoogleAlertWorkFlow {
...
public static void ChannelConfigurationGoogleAlertsWorkFlow(WebDriver driver) throws Exception {
		try {
...
//Google Alert Channel Configuration			
			WebElement GAconfi=driver.findElement(By.xpath("//img[@src='assets/images/account/google_alert.svg']"));
			js.executeScript("arguments[0].click()", GAconfi);
			Thread.sleep(5000);
//Add Google Alert Account Window UI Components
			WebElement AddGAaccheading=driver.findElement(By.xpath("//h3[contains(text(),'Add Google Alerts URL')]"));
			WebElement AddGAAccheadingIcon=driver.findElement(By.xpath("//img[@src='assets/images/account/google_alert.svg']"));
			...
			WebElement Monitorlabel=driver.findElement(By.xpath(" //span[contains(text(),'Monitor the web for interesting new content.')]"));
			...
			&& AddMoreField.isDisplayed() && Monitorlabel.isDisplayed() && Cancel.isDisplayed() && SaveURL.isDisplayed() && AddGAAccheadingIcon.isDisplayed())
			{
			System.out.println("Add Google Alert Account Window UI Components are displayed");
			}
			else {
			System.out.println("Add Google Alert Account Window UI Components are not displayed");
			}
			
		   WebElement AddURL = driver.findElement(By.xpath("//mat-label[contains(text(),'Add URL')]"));
			Actions actions5 = new Actions(driver);
			Action action5 = actions5.sendKeys(AddURL, "https://www.google.com/alerts#1:4").build();
	        action5.perform();
			Thread.sleep(3000);
			...
			Action action6 = actions6.sendKeys(AddURL2, "https://www.google.com/alerts#2:2").build();
	        action6.perform();
			Thread.sleep(3000);
			...
			System.out.println("Google Alert Profile Added Successfully");
...
//Click on Google Alert Account		
			WebElement GAprofile = driver.findElement(By.xpath("(//a[contains(text(),'Google Alerts')])"));
			GAprofile.click();
			Thread.sleep(5000);		
//Verify All Google Alert Label Details
			WebElement logo = driver.findElement(By.xpath("(//img[@src='assets/images/account/google_alert.svg'])[1]"));
			WebElement label = driver.findElement(By.xpath("(//span[contains(text(),'Google Alerts (2)')])"));
			System.out.println("All Google Alert Heading Details:"+label.getText());
			Thread.sleep(3000);
...
//Verify Newly added Google Alert Account Configuration Details			
			...
			System.out.println("Name of Google Alert profile Configuration is:"+AccountLabel1.getText());
			WebElement AccConfTime1 = driver.findElement(By.xpath("(//div[contains(@class,'channelConfiguration__booking--body')])[1]"));
			System.out.println("Time of Google Alert profile Configuration is:"+AccConfTime1.getText());
			WebElement Link1 = driver.findElement(By.xpath("(//p[contains(@class,'body-scroll mt-')])[1]"));
			System.out.println("Link of Google Alert profile Configuration is:"+Link1.getText());
			...
			{
			System.out.println("Verify Google Alert Account Configuration Details are  displayed");
			}
			else {
			System.out.println("Verify Google Alert Account Configuration Details are not displayed");
			}
//Verify Newly added Google Alert Account Configuration Details			
			...
			System.out.println("Name of Google Alert profile Configuration is:"+AccountLabel.getText());
			WebElement AccConfTime = driver.findElement(By.xpath("(//div[contains(@class,'channelConfiguration__booking--body')])[2]"));
			System.out.println("Time of Google Alert profile Configuration is:"+AccConfTime.getText());
			WebElement Link = driver.findElement(By.xpath("(//p[contains(@class,'body-scroll mt-')])[2]"));
			System.out.println("Link of Google Alert profile Configuration is:"+Link.getText());
			//WebElement ConfStatus = driver.findElement(By.xpath("(//span[contains(text(),'Owned')])[3]"));
			//System.out.println("Time of twitter profile Configuration is:"+ConfStatus.getText());
...
//Stop Fetchiong Mensions
			...
			Thread.sleep(3000);
			WebElement GAprofile2 = driver.findElement(By.xpath("(//a[contains(text(),'Google Alerts')])"));
			GAprofile2.click();
//Delete Google Alert Configured Account			
