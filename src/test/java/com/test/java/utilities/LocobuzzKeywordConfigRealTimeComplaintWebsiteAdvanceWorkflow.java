...
public class LocobuzzKeywordConfigRealTimeComplaintWebsiteAdvanceWorkflow {
...
//group name
			...
			groupName.sendKeys("ComplaintSiteReviews");
			Thread.sleep(2000);
...
//inside toggles
			WebElement insideTogglesButton = driver
					.findElement(By.xpath("(//span[@class='mat-button-toggle-label-content' and text()='AND'])[2]"));
...
//keywords
			...
			keywords.sendKeys("site information");
			keywords.sendKeys(Keys.ENTER);
			keywords.sendKeys("how manys complaints");
			keywords.sendKeys(Keys.ENTER);
...
//search group name
			...
			searchGroupName.sendKeys("ComplaintSiteReviews");
