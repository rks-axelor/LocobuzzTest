...
public class ExcelReportGMBLocationDataReportWorkflow {
	
	public static List<String> componentsInformation = new ArrayList<String>();
	
	public static void excelReportGMBLocationDataReportTemplateWorkflow(WebDriver driver) throws Exception {
		try {
...
//section name
			WebElement sectionName = driver.findElement(By.xpath("//a[contains(text(),'GMB Location')]"));
			js.executeScript("arguments[0].click()", sectionName);
			Thread.sleep(3000);

			WebElement template = driver.findElement(By.xpath("//h3[contains(text(),'GMB Locationwise Data')]"));
...
//save
			...
			templateName.sendKeys("temps462");
	...
	public static void scheduleProcess(WebDriver driver) throws Exception {
		try {
			...
			Thread.sleep(3000);
			WebElement day=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-arrow-wrapper')])[4]"));
			js.executeScript("arguments[0].click()", day);
			Thread.sleep(3000);
			WebElement selectDay=driver.findElement(By.xpath("//span[@class='mat-option-text' and text()=' Wednesday']"));
			js.executeScript("arguments[0].click()", selectDay);
			Thread.sleep(3000);
			WebElement time=driver.findElement(By.xpath("(//mat-icon[contains(text(),'schedule')])[3]"));
			js.executeScript("arguments[0].click()", time);
			Thread.sleep(3000);
			WebElement selectTime=driver.findElement(By.xpath("//span[@class='mat-option-text' and text()='05:30 PM']"));
