...
public class LocobuzzAgentQueueManagementTLWorkflow {
...
//1.Username
			...
			WebElement TLUser = driver.findElement(By.xpath("(//span[contains(text(),'komal_TL')])"));
			System.out.println("Selected user:" +TLUser.getText());
...
//Role Coloumn
			...
			WebElement Userrole = driver.findElement(By.xpath("(//span[contains(text(),'Team Leader')])"));
...
// To handle parent window
 ...
 //Child window Handle
	...
	CommonFunctions.login(driver, "TeamLeader");
	Thread.sleep(5000);
...
//Back to parent tab and verifying details
	  ...
	  Thread.sleep(3000);
	  WebElement TLRoleSelect = driver.findElement(By.xpath("(//span[contains(text(),'Team Leader')])[2]"));
      js.executeScript("arguments[0].click()",TLRoleSelect );
	  Thread.sleep(3000);
...
//get count of assigned tickets
	WebElement getcount = driver.findElement(By.xpath("//span[contains(text(),'NA')]"));
	System.out.println("No.of Assigned Tickets:" + getcount.getText());
	Thread.sleep(1000);
