...
public class AllMentionEmailWorkflowProcess {
	...
	public static void allMentionsWorkFlow(WebDriver driver, String channel) throws Exception {
		try {
			...
			ticketInformation.add(0, "AllMentions Email Configuration WorkFlow");
...
//email logo
			...
			WebElement imageIcon = driver
					.findElement(By.xpath("(//div[@id='socialBox'])[2]//following::img[@src='assets/images/channel-logos/email.svg']"));
...
//imagename
			WebElement ticketName = driver
					.findElement(By.xpath("(//div[@id='socialBox'])[2]//following::span[contains(text(),'Email')]"));
...
//mention category
			...
			WebElement device = driver
					.findElement(By.xpath("(//div[@id='socialBox'])[2]//following::span[@class='post__foot--value']"));
