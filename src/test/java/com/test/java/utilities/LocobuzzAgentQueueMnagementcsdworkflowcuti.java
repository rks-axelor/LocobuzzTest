...
public class LocobuzzAgentQueueMnagementcsdworkflowcuti {
...
//1.Username
			...
			WebElement CSDUser = driver.findElement(By.xpath("(//span[contains(text(),'komal_csd')])"));
			System.out.println("Selected user:" +CSDUser.getText());
...
//Role Coloumn
			...
			WebElement Userrole = driver.findElement(By.xpath("(//span[contains(text(),'CSD (L1)')])"));
...
//Back to parent tab and verifying details
	  ...
	  Thread.sleep(3000);
	  WebElement CSDRoleSelect = driver.findElement(By.xpath("(//span[contains(text(),'CSD (L1)')])[2]"));
      js.executeScript("arguments[0].click()",CSDRoleSelect );
	  Thread.sleep(3000);
