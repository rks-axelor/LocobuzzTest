...
public class TicketSectionSendEmailsByCSD {
...
//ticket infromation
	public static void ticketTabVerification(WebDriver driver, String channel) throws Exception {
		try {
			...
			ticketInformation.add(0, "Ticket Session Send Emails By CSD");
...
//send email
			WebElement emailButton = driver.findElement(By.xpath("(//span[contains(text(),'Send Email')])"));
