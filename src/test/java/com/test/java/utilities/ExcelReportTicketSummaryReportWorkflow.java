...
public class ExcelReportTicketSummaryReportWorkflow {

	public static List<String> componentsInformation = new ArrayList<String>();

	public static void excelReportTicketSummaryReportWorkflow(WebDriver driver) throws Exception {
		try {
...
//section names
			...
			WebElement ticketSummaryReport = driver
					.findElement(By.xpath("//h3[contains(text(),'Ticket Summary Report')]"));
			js.executeScript("arguments[0].click()", ticketSummaryReport);
			Thread.sleep(3000);
...
//save
			...
			templateName.sendKeys("template760");
	...
	public static void scheduleProcess(WebDriver driver) throws Exception {
		try {
			...
			Thread.sleep(3000);
			WebElement selectDuration=driver.findElement(By.xpath("//span[@class='mat-option-text' and text()='Last week']"));
			js.executeScript("arguments[0].click()", selectDuration);
			Thread.sleep(3000);
			WebElement schedule=driver.findElement(By.xpath("//mat-select[@formcontrolname='scheduleDayCtrl']"));
			js.executeScript("arguments[0].click()", schedule);
			Thread.sleep(3000);
			WebElement selectSchedule=driver.findElement(By.xpath("//span[@class='mat-option-text' and text()=' Thursday']"));
			js.executeScript("arguments[0].click()", selectSchedule);
			Thread.sleep(3000);
			WebElement timeDate=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-value')])[5]"));
			js.executeScript("arguments[0].click()", timeDate);
			Thread.sleep(3000);
			WebElement selectTime=driver.findElement(By.xpath("//span[@class='mat-option-text' and text()='05:00 AM']"));
			js.executeScript("arguments[0].scrollIntoView()", selectTime);
			js.executeScript("arguments[0].click()", selectTime);
			Thread.sleep(3000);
			
			WebElement ticketBasedOn=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-arrow-wrapper')])[6]"));
			js.executeScript("arguments[0].click()", ticketBasedOn);
			Thread.sleep(3000);
			WebElement selectTicketBased=driver.findElement(By.xpath("//span[@class='mat-option-text' and text()='Modified Date']"));
