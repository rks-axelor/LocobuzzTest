...
public class LocobuzzSocialSchedulingGMBApprovalWorkflow {

	public static List<String> componentsInformation = new ArrayList<String>();

	public static void socialSchedulingGMBApprovalWorkflow(WebDriver driver) throws Exception {
		try {
...
//searching content
			...
			search1.sendKeys("GMB image later");
...
//awaiting approval
			...
			if (postCreatedBy.isDisplayed() && deleteButton.isDisplayed() && scheduling.isDisplayed()
				...
				System.out.println("Post createdby,delete,scheduling,chat,preview buttons,label are displayed");
			} else {
				System.out.println("Post createdby,delete,scheduling,chat,preview buttons,label are not displayed");
			}
