...
public class LocobuzzAWAYoutubePPTDownloadWorkflow {

	public static List<String> componentsInformation = new ArrayList<String>();

	public static void pptDownloadNativeForYoutube(WebDriver driver) throws Exception {
		try {

			Thread.sleep(3000);
			JavascriptExecutor js = (JavascriptExecutor) driver;

			WebElement youtube = driver.findElement(By.xpath("//span[@class='pl-7' and text()='Youtube']"));
...
//ppt
			...
			pptDownloadImageForYoutube(driver);
	...
	public static void pptDownloadImageForYoutube(WebDriver driver) throws Exception {
		try {
