...
public class LocoChannelConfigECommerceWorkflow {
...
public static void ChannelConfigurationECommerceWorkFlow(WebDriver driver) throws Exception {
	try {
...
//Google Alert Channel Configuration			
		WebElement EcommerceConfig=driver.findElement(By.xpath("(//img[@src='assets/images/account/e-commerce.svg'])[1]"));
		js.executeScript("arguments[0].click()", EcommerceConfig);
		Thread.sleep(5000);
//Add E-Commerce Account Window UI Components
		WebElement AddGAaccheading=driver.findElement(By.xpath("//h3[contains(text(),'Add E-Commerce Websites URL')]"));
		WebElement note=driver.findElement(By.xpath("//span[contains(text(),' Note: Please make sure that you are adding product listing page not product detail page.')]"));
		WebElement AddGAAccheadingIcon=driver.findElement(By.xpath("(//img[@src='assets/images/account/e-commerce.svg'])[1]"));
		...
		&& AddMoreField.isDisplayed() && Cancel.isDisplayed() && SaveURL.isDisplayed() && AddGAAccheadingIcon.isDisplayed() && note.isDisplayed())
		{
		System.out.println("Add E-Commerce Account Window UI Components are displayed");
		}
		else {
		System.out.println("Add E-Commerce Account Window UI Components are not displayed");
		}
		
	    WebElement AddURL = driver.findElement(By.xpath("//mat-label[contains(text(),'Add URL')]"));
		Actions actions5 = new Actions(driver);
		Action action5 = actions5.sendKeys(AddURL, "https://www.amazon.in/Home-Kitchen/b/?ie=UTF8&node=976442031&ref_=nav_cs_home").build();
        action5.perform();
		Thread.sleep(3000);
		...
		Action action6 = actions6.sendKeys(AddURL2, "https://www.amazon.in/gp/browse.html?node=6648217031&ref_=nav_cs_fashion").build();
        action6.perform();
		Thread.sleep(6000);
...
//Click on E-Commerce Account		
		WebElement TripAdvisorprofile = driver.findElement(By.xpath("(//a[contains(text(),'E-Commerce Website')])"));
		TripAdvisorprofile.click();
		Thread.sleep(5000);		
//Verify All E-Commerce Label Details
		WebElement logo = driver.findElement(By.xpath("(//img[@src='assets/images/account/e-commerce.svg'])[1]"));
		WebElement label = driver.findElement(By.xpath("(//span[contains(text(),'E-Commerce Website (2)')])"));
		System.out.println("All E-Commerce Heading Details:"+label.getText());
		Thread.sleep(3000);
		WebElement Pause1 = driver.findElement(By.xpath("(//span[contains(@class,'mat-button-wrapper')])[7]"));
		js.executeScript("arguments[0].click()", Pause1);
		Thread.sleep(8000);
		WebElement Pause1confirm = driver.findElement(By.xpath("(//span[contains(text(),'Yes')])[1]"));
		js.executeScript("arguments[0].click()", Pause1confirm);
		Thread.sleep(8000);
		WebElement pause2 = driver.findElement(By.xpath("(//span[contains(@class,'mat-button-wrapper')])[9]"));
		js.executeScript("arguments[0].click()", pause2);
		Thread.sleep(8000);
		WebElement Pause2confirm = driver.findElement(By.xpath("(//span[contains(text(),'Yes')])[1]"));
		js.executeScript("arguments[0].click()", Pause2confirm);
		Thread.sleep(8000);
		
//Verify  added E-Commerce  Account Configuration Details			
		...
		WebElement AccountLabeltime1 = driver.findElement(By.xpath("(//div[contains(@class,'channelConfiguration__booking--body p-')])[1]"));
		System.out.println("Name of TripAdvisor profile Configuration is:"+AccountLabeltime1.getText());
		...
		{
		System.out.println("Verify E-Commerce Account Configuration Details are  displayed");
		}
		else {
		System.out.println("Verify E-Commerce Account Configuration Details are not displayed");
		}
//Verify Newly added Google Alert Account Configuration Details			
		...
		WebElement AccountLabeltime2 = driver.findElement(By.xpath("(//div[contains(@class,'channelConfiguration__booking--body p-')])[3]"));
		System.out.println("Name of TripAdvisor profile Configuration is:"+AccountLabeltime2.getText());
