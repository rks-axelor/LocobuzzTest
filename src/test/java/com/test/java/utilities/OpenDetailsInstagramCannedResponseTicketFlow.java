...
public class OpenDetailsInstagramCannedResponseTicketFlow {
...
//canned response process
			...
			WebElement selectResponseName = driver.findElement(By.xpath("(//span[@class='mat-option-text'])[2]"));
...
//reject the ticket
			WebElement rejectButton = driver.findElement(By.xpath("(//mat-icon[contains(text(),'highlight_off')])[2]"));
			js.executeScript("arguments[0].click()", rejectButton);
			Thread.sleep(2000);
			WebElement textArea = driver.findElement(By.xpath("//textarea[contains(@class,'custom__input')]"));
