...
public class LocobuzzKeywordConfigRealTimeTwitterWorkflow {
...
//query builder
			...
			WebElement radioButton = driver.findElement(By.xpath("(//span[contains(text(),' AND ')])[2]"));

//adding keywords
			WebElement queryKeyword = driver.findElement(By.xpath("(//input[@placeholder='Add new keyword'])[1]"));
			Actions actions = new Actions(driver);
			Action action = actions.sendKeys(queryKeyword, "priceless").sendKeys(Keys.ENTER)
...
//search group name
			...
			searchGroupName.sendKeys("TCKey");
