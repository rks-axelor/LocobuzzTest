...
public class LocoChannelConfigGlassdoorWorkflow {
...
public static void ChannelConfigurationGlassdoorWorkFlow(WebDriver driver) throws Exception {
	try {
...
//select Brand
		...
		Thread.sleep(3000);
	    WebElement selectbrand = driver.findElement(By.xpath("(//span[contains(text(),'Komal Brand')])"));
...
//Other Channels
		...
		((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView(true);", glassdoor1);
	    ...
	    && voice.isDisplayed() && voice.isDisplayed() && ecommerce.isDisplayed() && glassdoor1.isDisplayed()){
...
//Glassdoor Channel Configuration			
		WebElement TripAdvconfi=driver.findElement(By.xpath("(//img[@src='assets/images/account/glassdoor.svg'])[1]"));
		js.executeScript("arguments[0].click()", TripAdvconfi);
		Thread.sleep(5000);
//Add Glassdoor Account Window UI Components
		WebElement AddGAaccheading=driver.findElement(By.xpath("//h3[contains(text(),'Glassdoor')]"));
		WebElement info=driver.findElement(By.xpath("//span[contains(text(),' To get the inside scoop on companies with employee reviews, please copy paste glassdoor reviews link. ')]"));
		WebElement AddGAAccheadingIcon=driver.findElement(By.xpath("(//img[@src='assets/images/account/glassdoor.svg'])[1]"));
		...
		{
		System.out.println("Add Glassdoor Account Window UI Components are displayed");
		}
		else {
		System.out.println("Add Glassdoor Account Window UI Components are not displayed");
		}
		
	    WebElement AddURL = driver.findElement(By.xpath("//mat-label[contains(text(),'Add URL')]"));
		Actions actions5 = new Actions(driver);
		Action action5 = actions5.sendKeys(AddURL, "https://www.glassdoor.co.in/Reviews/Sample-Supports-Reviews-E1147784.htm").build();
        action5.perform();
		Thread.sleep(3000);
		...
		Action action6 = actions6.sendKeys(AddURL2, "https://www.glassdoor.co.in/Reviews/Best-Companies-Reviews-E872638.htm").build();
        action6.perform();
		Thread.sleep(3000);
		...
		System.out.println("Glassdoor Profile Added Successfully");
...
//Click on Glassdoor Account		
		WebElement TripAdvisorprofile = driver.findElement(By.xpath("(//a[contains(text(),'Glassdoor')])"));
		TripAdvisorprofile.click();
		Thread.sleep(5000);		
//Verify All Glassdoor Label Details
		WebElement logo = driver.findElement(By.xpath("(//img[@src='assets/images/account/glassdoor.svg'])[1]"));
		WebElement label = driver.findElement(By.xpath("(//span[contains(text(),'Glassdoor (2)')])"));
		System.out.println("All GTripadvisor Heading Details:"+label.getText());
		Thread.sleep(3000);
		
//Verify  added Glassdoor  Account Configuration Details			
		...
		System.out.println("Name of Glassdoor profile Configuration is:"+AccountLabel1.getText());
		WebElement AccConfTime1 = driver.findElement(By.xpath("(//div[contains(@class,'channelConfiguration__booking--body p-')])[1]"));
		System.out.println("Time of Glassdoor profile Configuration is:"+AccConfTime1.getText());
		WebElement Link1 = driver.findElement(By.xpath("(//div[contains(@class,'channelConfiguration__booking--body url-body p-')])[1]"));
		System.out.println("Link of Glassdoor  profile Configuration is:"+Link1.getText());
		WebElement Delete1 = driver.findElement(By.xpath("(//span[contains(@class,'mat-button-wrapper')])[9]"));
		Thread.sleep(3000);
...
//Verify Newly added Google Alert Account Configuration Details			
		...
		WebElement AccConfTime = driver.findElement(By.xpath("(//div[contains(@class,'channelConfiguration__booking--body')])[2]"));
		System.out.println("Time of Tripadvisor profile Configuration is:"+AccConfTime.getText());
		WebElement Link = driver.findElement(By.xpath("(//div[contains(@class,'channelConfiguration__booking--body url-body p-')])[2]"));
		System.out.println("Link of Tripadvisor profile Configuration is:"+Link.getText());
		WebElement Delete = driver.findElement(By.xpath("(//span[contains(@class,'mat-button-wrapper')])[10]"));
		Thread.sleep(3000);
...
//Delete Glassdoor Configured Account			
		WebElement AddedAccountDelete = driver.findElement(By.xpath("(//mat-icon[contains(text(),'delete')])[4]"));
		...
		Thread.sleep(5000);
		WebElement delete = driver.findElement(By.xpath("(//mat-icon[contains(text(),'delete')])[3]"));
