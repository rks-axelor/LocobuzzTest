...
public class ExcelReportMentionTATReportWorkflow {
	
	public static List<String> componentsInformation = new ArrayList<String>();
	
	public static void excelReportMentionTATReportTemplateWorkflow(WebDriver driver) throws Exception {
		try {
...
//section names
			...
			WebElement template=driver.findElement(By.xpath("//h3[contains(text(),'Mention TAT Report')]"));
	...
	public static void scheduleProcess(WebDriver driver) throws Exception {
		try {
			...
			WebElement selectDuration = driver
					.findElement(By.xpath("//span[@class='mat-option-text' and text()='Yesterday']"));
			...
			Thread.sleep(3000);
			WebElement date=driver.findElement(By.xpath("((//div[@class='calendar-table'])[1]//following::span[contains(text(),'7')])[2]"));
...
//tickets and mentions
			...
			Thread.sleep(3000);
			WebElement selectMediaType=driver.findElement(By.xpath("//span[@class='mat-option-text']//div[contains(text(),'Text')]"));
...
//user characteristics
			...
			WebElement verified=driver.findElement(By.xpath("(//div[contains(@class,'mat-select-value')])[17]"));
