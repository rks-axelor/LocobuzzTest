...
public class AgentSignatureReplyandCloseFacebookprocess {
...
//ticket information
	public static void ticketTabVerification(WebDriver driver, String channel) throws Exception {
		try {
			...
			ticketInformation.add(0, " Agent Signature Facebook Ticket Reply and Close");
...
//ReplyType 
	...
	public static void replyWorkFlow(WebDriver driver, String replyType, String channel) throws Exception {
		try {
			...
			WebElement send = driver.findElement(By.xpath("(//span[contains(text(),'Send')])[4]"));
...
// ticketclosed status
			WebElement ticketStatusIcon = driver.findElement(By.xpath("(//mat-icon[contains(text(),'folder')])[5]"));
			WebElement ticketStatus = driver.findElement(By.xpath("(//span[@class='post__foot--label ticketstatus__blue colored__red'])[1]"));
