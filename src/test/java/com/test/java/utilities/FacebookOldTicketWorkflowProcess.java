...
public class FacebookOldTicketWorkflowProcess {
...
//apply brand
			...
			WebElement brandName = driver
					.findElement(By.xpath("//span[@class='mat-checkbox-label' and text()=' Medlife Bot ']"));
...
//duration
			...
			WebElement selectDate = driver
					.findElement(By.xpath("(//button[@type='button' and text()='Last 14 Days'])[2]"));
...
//ticketStatus
			...
			WebElement ticketStatus = driver
					.findElement(By.xpath("(//span[@class='post__foot--label ticketstatus__blue colored__locobuzz'])"));
...
// ticket Status
				...
				WebElement ticketStatus1 = driver
						.findElement(By.xpath("(//span[@class='post__foot--label ticketstatus__blue'])"));
...
// reject the ticket
			...
			WebElement rejectTicket = driver.findElement(By.xpath("//span[contains(text(),'Reject')]"));
...
// ticketclosed status
			WebElement ticketStatusIcon = driver.findElement(By.xpath("(//mat-icon[contains(text(),'folder')])[5]"));
			WebElement ticketStatus = driver
					.findElement(By.xpath("(//span[@class='post__foot--label ticketstatus__blue colored__red'])"));
