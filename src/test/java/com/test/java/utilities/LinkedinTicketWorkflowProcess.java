...
public class LinkedinTicketWorkflowProcess {
...
//ticket information
	public static void ticketTabVerification(WebDriver driver, String channel) throws Exception {
		...
		try {
			...
			ticketInformation.add(0, "Linkedin Ticket Workflow");
...
//open post
			...
			WebElement openPostButton = driver
					.findElement(By.xpath("(//mat-icon[contains(text(),'open_in_new')])//following::span[1]"));
...
//direct close
			...
			WebElement directCloseButton = driver
					.findElement(By.xpath("(//mat-icon[contains(text(),'cancel')])//following::span[1]"));
...
//send email
			...
			WebElement sendEmailButton = driver
					.findElement(By.xpath("(//mat-icon[contains(text(),'mail_outline')])//following::span[1]"));
...
//ticket status
			WebElement ticketStatusIcon = driver.findElement(By.xpath("(//mat-icon[contains(text(),'folder')])[5]"));
			WebElement ticketStatus = driver.findElement(By.xpath("(//span[contains(text(),'Escalated to CSD ')])[1]"));
			if (ticketStatusIcon.isDisplayed() && ticketStatus.getText() != "") {
				System.out.println("TicketStatus is displayed");
