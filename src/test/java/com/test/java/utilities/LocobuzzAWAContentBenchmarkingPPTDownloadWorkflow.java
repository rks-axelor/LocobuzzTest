...
public class LocobuzzAWAContentBenchmarkingPPTDownloadWorkflow {

	public static List<String> componentsInformation = new ArrayList<String>();

	public static void pptDownloadNativeForContentBenchmarking(WebDriver driver) throws Exception {
		try {

			Thread.sleep(3000);
			JavascriptExecutor js = (JavascriptExecutor) driver;

			WebElement contentBenchmark = driver
					.findElement(By.xpath("//span[@class='pl-7' and text()='Content Benchmarking']"));
			js.executeScript("arguments[0].scrollIntoView();", contentBenchmark);
			js.executeScript("arguments[0].click()", contentBenchmark);
			Thread.sleep(7000);
...
//search the element
			...
			Thread.sleep(4000);
			WebElement searchposttype=driver.findElement(By.xpath("//input[@placeholder='Search Post Type']"));
			searchposttype.sendKeys("brand post");
			Thread.sleep(3000);
...
//ppt
			...
			pptDownloadImageForContentBenchmarking(driver);
	...
	public static void pptDownloadImageForContentBenchmarking(WebDriver driver) throws Exception {
		try {
