...
public class LocobuzzAWAInstagramPPTDownloadWorkflow {
	
	public static List<String> componentsInformation = new ArrayList<String>();
	
	public static void pptDownloadNativeForInstagram(WebDriver driver) throws Exception {
		try {
			
			Thread.sleep(3000);
			JavascriptExecutor js = (JavascriptExecutor) driver;

			WebElement instagram = driver.findElement(By.xpath("//span[@class='pl-7' and text()='Instagram']"));
...
//search the element
			...
			searchElement.sendKeys("instagram post type");
			Thread.sleep(2000);
			...
			Thread.sleep(4000);
			WebElement searchpost=driver.findElement(By.xpath("//input[@placeholder='Search Instagram Post Type']"));
			searchpost.sendKeys("stories");
			Thread.sleep(3000);
...
//search the element
			...
			searchElement2.sendKeys("sentiment");
			Thread.sleep(2000);
...
//ppt
			...
			pptDownloadImageForInstagram(driver);
	...
	public static void pptDownloadImageForInstagram(WebDriver driver) throws Exception {
		try {
