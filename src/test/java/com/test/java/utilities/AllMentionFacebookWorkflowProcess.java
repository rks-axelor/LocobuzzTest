...
public class AllMentionFacebookWorkflowProcess {
	...
	public static void allMentionsWorkFlow(WebDriver driver, String channel) throws Exception {
		...
		try {
			...
			ticketInformation.add(0, "AllMentions Facebook WorkFlow");
...
//total mentions
			...
			WebElement mentions = driver.findElement(By.xpath("(//span[@class='post__foot--label'])[3]"));
...
// translate
			...
			WebElement languageName = driver.findElement(By.xpath("(//span[@class='post__foot--label'])[6]"));
