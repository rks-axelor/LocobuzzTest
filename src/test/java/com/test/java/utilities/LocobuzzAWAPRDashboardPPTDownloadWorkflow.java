...
public class LocobuzzAWAPRDashboardPPTDownloadWorkflow {

	public static List<String> componentsInformation = new ArrayList<String>();

	public static void pptDownloadNativeForPRDashboard(WebDriver driver) throws Exception {
		try {

			Thread.sleep(3000);
			JavascriptExecutor js = (JavascriptExecutor) driver;

			WebElement overview = driver.findElement(By.xpath("//span[@class='pl-7' and text()='PR Dashboard']"));
...
//duration
			...
			Thread.sleep(5000);
			WebElement selectDuration=driver.findElement(By.xpath("//table[@class='table table-borderless mb-0']//tr[4]//td[3]"));
...
//search the element
			...
			Thread.sleep(4000);
			WebElement positiveexcludeButton=driver.findElement(By.xpath("(//span[@class='ant-checkbox'])[7]"));
			js.executeScript("arguments[0].click()", positiveexcludeButton);
			Thread.sleep(4000);
...
//search the element
			...
			searchElement2.sendKeys("domain name");
			Thread.sleep(2000);
			WebElement domain=driver.findElement(By.xpath("(//div[@class='ant-collapse-header']//div)[1]"));
			js.executeScript("arguments[0].click()", domain);
			Thread.sleep(4000);
			WebElement searchdomain=driver.findElement(By.xpath("//input[@placeholder='Search Domain Name']"));
			searchdomain.sendKeys("dailyhunt");
			Thread.sleep(3000);
...
//ppt
			...
			WebElement selectPreview = driver.findElement(By
					.xpath("(//div[contains(@class,'border mb-15 cursor-pointer overflow-hidden border_width2')])[4]"));
			...
			pptDownloadImageForPRDashboard(driver);
	...
	public static void pptDownloadImageForPRDashboard(WebDriver driver) throws Exception {
		try {
