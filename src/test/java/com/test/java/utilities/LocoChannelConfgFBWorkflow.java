...
public class LocoChannelConfgFBWorkflow {
...
public static void ChannelConfigurationFacebookWorkFlow(WebDriver driver) throws Exception {
		try {
...
//Facebook Channel Configuration			
			WebElement FBconfi=driver.findElement(By.xpath("(//img[@src='assets/images/account/facebook.svg'])[2]"));
			((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView(true);", FBconfi);
			js.executeScript("arguments[0].click()", FBconfi);
			Thread.sleep(5000);
...
//Log in With Facebook	and Insta		
			...
			Thread.sleep(3000);
			WebElement Continue = driver.findElement(By.xpath("//span[contains(text(),'Continue as Komal Mali')]"));
...
//Add Public Facebook Account
			...
			Thread.sleep(3000);
			WebElement PublicFBConfiguration=driver.findElement(By.xpath("(//img[@src='assets/images/account/facebook.svg'])[2]"));
			js.executeScript("arguments[0].click()", PublicFBConfiguration);
			Thread.sleep(3000);
			WebElement PublicTwitterHandletxbx=driver.findElement(By.xpath("(//input[@type='text'])[2]"));
			Actions actions = new Actions(driver);
			Action action = actions.sendKeys(PublicTwitterHandletxbx, "https://www.facebook.com/locobuzz/ ").sendKeys(Keys.ENTER).build();
	        action.perform();
	        Thread.sleep(5000);
			
//Click on Facebook Account		
			WebElement Twitterprofile = driver.findElement(By.xpath("(//a[contains(text(),'Facebook/Instagram')])"));
			js.executeScript("arguments[0].click()", Twitterprofile);
			Thread.sleep(3000);
			Thread.sleep(5000);		
//Verify All Facebook Label Details
			WebElement logo = driver.findElement(By.xpath("//img[@src='assets/images/account/facebook.svg']"));
			WebElement label = driver.findElement(By.xpath("//span[contains(text(),'Facebook & Instagram Profiles (4)')]"));
			System.out.println("All Facebook Heading Details:"+label.getText());
			Thread.sleep(3000);
//Verify Owned Facebook Account Configuration			
			WebElement AccountPage = driver.findElement(By.xpath("(//div[contains(text(),'Testing Demo')])"));
...
//Verify Public Facebook Account Configuration			
			WebElement PAccountHandle = driver.findElement(By.xpath("(//div[contains(text(),'Komal')])[1]"));
			((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView(true);", PAccountHandle);
			...
			WebElement PConfStatus = driver.findElement(By.xpath("(//span[contains(text(),'Owned')])[2]"));
...
//Delete Owned and Public Configured Account
			WebElement P1delete = driver.findElement(By.xpath("(//button[contains(@class,'mat-focus-indicator btnDelete')])[4]"));
			js.executeScript("arguments[0].click()", P1delete);
			Thread.sleep(3000);	
			WebElement P1deleteConfirm = driver.findElement(By.xpath("(//span[contains(text(),'Yes')])[1]"));
			js.executeScript("arguments[0].click()", P1deleteConfirm);
			Thread.sleep(5000);
			WebElement Odelete = driver.findElement(By.xpath("(//button[contains(@class,'mat-focus-indicator btnDelete')])[3]"));
