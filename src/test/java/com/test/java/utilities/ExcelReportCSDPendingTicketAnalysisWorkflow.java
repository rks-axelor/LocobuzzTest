...
public class ExcelReportCSDPendingTicketAnalysisWorkflow {
	
	public static List<String> componentsInformation = new ArrayList<String>();
	
	public static void excelReportCSDPendingTicketAnalysisReportTemplateWorkflow(WebDriver driver) throws Exception {
		try {
...
//section name
			WebElement sectionName = driver.findElement(By.xpath("//a[contains(text(),'CSD Pending Details')]"));
			js.executeScript("arguments[0].click()", sectionName);
			Thread.sleep(3000);

			WebElement template = driver.findElement(By.xpath("//h3[contains(text(),'Pending Ticket Analysis')]"));
