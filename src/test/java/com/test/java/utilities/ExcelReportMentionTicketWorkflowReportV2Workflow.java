...
public class ExcelReportMentionTicketWorkflowReportV2Workflow {
	
	public static List<String> componentsInformation = new ArrayList<String>();
	
	public static void excelReportMentionTicketWorkflowReportV2TemplateWorkflow(WebDriver driver) throws Exception {
		try {
...
//section names
			...
			WebElement template=driver.findElement(By.xpath("//h3[contains(text(),'Ticket Workflow Report V2')]"));
...
//search
			...
			search1.sendKeys("Ticket Workflow Report V2");
