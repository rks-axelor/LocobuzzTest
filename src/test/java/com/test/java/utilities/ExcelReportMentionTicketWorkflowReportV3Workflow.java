...
public class ExcelReportMentionTicketWorkflowReportV3Workflow {
	
	public static List<String> componentsInformation = new ArrayList<String>();
	
	public static void excelReportMentionTicketWorkflowReportV3TemplateWorkflow(WebDriver driver) throws Exception {
		try {
...
//section names
			...
			WebElement template=driver.findElement(By.xpath("//h3[contains(text(),'Ticket Workflow Report V3')]"));
...
//search
			...
			search1.sendKeys("Ticket Workflow Report V3");
...
//download report
			...
			WebElement continueTemplateButton=driver.findElement(By.xpath("//span[contains(text(),'Continue with this template')]"));
			js.executeScript("arguments[0].click()", continueTemplateButton);
			Thread.sleep(2000);
	...
	public static void scheduleProcess(WebDriver driver) throws Exception {
		try {
			...
			Thread.sleep(3000);
			WebElement selectDay=driver.findElement(By.xpath("//span[@class='mat-option-text' and text()=' 6th of every month']"));
			...
			Thread.sleep(3000);
			WebElement selectTime=driver.findElement(By.xpath("//span[@class='mat-option-text' and text()='12:30 AM']"));
...
//tickets and mentions
			...
			Thread.sleep(3000);
			WebElement selectStatus=driver.findElement(By.xpath("//span[@class='mat-option-text' and text()=' Pending ']"));
			...
			Thread.sleep(3000);
			WebElement selectPriority=driver.findElement(By.xpath("(//span[@class='mat-option-text'])//div[contains(text(),'Low')]"));
